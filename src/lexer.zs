...
const TOKEN_LEFT_BRACKET = 18;
const TOKEN_LEFT_PARENTHESIS = 19;
const TOKEN_LESS_THAN = 20;
const TOKEN_LESS_THAN_EQUAL = 21;
const TOKEN_LOGICAL_AND = 22;
const TOKEN_LOGICAL_OR = 23;
const TOKEN_MINUS = 24;
const TOKEN_MINUS_MINUS = 25;
const TOKEN_MULTIPLY = 26;
const TOKEN_NOT = 27;
const TOKEN_NOT_EQUAL = 28;
const TOKEN_PLUS = 29;
const TOKEN_PLUS_PLUS = 30;
const TOKEN_QUESTION_MARK = 31;
const TOKEN_REMAINDER = 32;
const TOKEN_RIGHT_BRACE = 33;
const TOKEN_RIGHT_BRACKET = 34;
const TOKEN_RIGHT_PARENTHESIS = 35;
const TOKEN_SEMICOLON = 36;
const TOKEN_SHIFT_LEFT = 37;
const TOKEN_SHIFT_RIGHT = 38;

// Keywords
const TOKEN_BREAK = 39;
const TOKEN_CLASS = 40;
const TOKEN_CONST = 41;
const TOKEN_CONTINUE = 42;
const TOKEN_ELSE = 43;
const TOKEN_EXPORT = 44;
const TOKEN_EXTENDS = 45;
const TOKEN_EXTERN = 46;
const TOKEN_FALSE = 47;
const TOKEN_FUNCTION = 48;
const TOKEN_IF = 49;
const TOKEN_IMPLEMENTS = 50;
const TOKEN_IMPORT = 51;
const TOKEN_INTERFACE = 52;
const TOKEN_NEW = 53;
const TOKEN_NULL = 54;
const TOKEN_RETURN = 55;
const TOKEN_THIS = 56;
const TOKEN_TRUE = 57;
const TOKEN_VAR = 58;
const TOKEN_WHILE = 59;
...
function tokenToString(token: int): string {
  ...
  if (token == TOKEN_LEFT_BRACKET) return "LEFT_BRACKET";
  ...
  if (token == TOKEN_RIGHT_BRACKET) return "RIGHT_BRACKET";
...
function tokenize(source: Source, log: Log): Token {
  ...
  while (i < limit) {
    ...
    else if (c == '[') kind = TOKEN_LEFT_BRACKET;
    else if (c == ']') kind = TOKEN_RIGHT_BRACKET;
