...
static const uint32_t __string_13[] = {2, S(',', ' ')};
static const uint32_t __string_14_0[] = {4, S(',', ' '), S('0', ')')};
static const uint32_t __string_15[] = {3, S('}', ';'), S('\n', 0)};
static const uint32_t __string_16_const_uint16_t[] = {18, S('(', 'c'), S('o', 'n'), S('s', 't'), S(' ', 'u'), S('i', 'n'), S('t', '1'), S('6', '_'), S('t', ' '), S('*', ')')};
static const uint32_t __string_17[] = {2, S('-', '>')};
static const uint32_t __string_18[] = {1, S('.', 0)};
static const uint32_t __string_19[] = {3, S(' ', '?'), S(' ', 0)};
static const uint32_t __string_20[] = {3, S(' ', ':'), S(' ', 0)};
static const uint32_t __string_21[] = {2, S(',', ' ')};
static const uint32_t __string_22_calloc_1_sizeof[] = {17, S('c', 'a'), S('l', 'l'), S('o', 'c'), S('(', '1'), S(',', ' '), S('s', 'i'), S('z', 'e'), S('o', 'f'), S('(', 0)};
static const uint32_t __string_23[] = {2, S(')', ')')};
static const uint32_t __string_24[] = {1, S('~', 0)};
...
static const uint32_t __string_39[] = {4, S(' ', '='), S('=', ' ')};
static const uint32_t __string_40[] = {3, S(' ', '>'), S(' ', 0)};
static const uint32_t __string_41[] = {4, S(' ', '>'), S('=', ' ')};
...
static const uint32_t __string_48[] = {3, S(' ', '%'), S(' ', 0)};
static const uint32_t __string_49[] = {4, S(' ', '<'), S('<', ' ')};
static const uint32_t __string_50[] = {4, S(' ', '>'), S('>', ' ')};
static const uint32_t __string_51[] = {3, S(' ', '-'), S(' ', 0)};
static const uint32_t __string_52_struct[] = {7, S('s', 't'), S('r', 'u'), S('c', 't'), S(' ', 0)};
static const uint32_t __string_53_uint8_t[] = {7, S('u', 'i'), S('n', 't'), S('8', '_'), S('t', 0)};
static const uint32_t __string_54_int8_t[] = {6, S('i', 'n'), S('t', '8'), S('_', 't')};
static const uint32_t __string_55_int32_t[] = {7, S('i', 'n'), S('t', '3'), S('2', '_'), S('t', 0)};
static const uint32_t __string_56_int16_t[] = {7, S('i', 'n'), S('t', '1'), S('6', '_'), S('t', 0)};
static const uint32_t __string_57_const_uint16_t[] = {14, S('c', 'o'), S('n', 's'), S('t', ' '), S('u', 'i'), S('n', 't'), S('1', '6'), S('_', 't')};
static const uint32_t __string_58_uint32_t[] = {8, S('u', 'i'), S('n', 't'), S('3', '2'), S('_', 't')};
static const uint32_t __string_59_uint16_t[] = {8, S('u', 'i'), S('n', 't'), S('1', '6'), S('_', 't')};
static const uint32_t __string_60[] = {2, S(' ', '*')};
static const uint32_t __string_61_if[] = {4, S('i', 'f'), S(' ', '(')};
static const uint32_t __string_62[] = {2, S(')', ' ')};
static const uint32_t __string_63[] = {2, S('\n', '\n')};
static const uint32_t __string_64_else[] = {5, S('e', 'l'), S('s', 'e'), S(' ', 0)};
static const uint32_t __string_65_while[] = {7, S('w', 'h'), S('i', 'l'), S('e', ' '), S('(', 0)};
static const uint32_t __string_66[] = {2, S(')', ' ')};
static const uint32_t __string_67_break[] = {7, S('b', 'r'), S('e', 'a'), S('k', ';'), S('\n', 0)};
static const uint32_t __string_68_continue[] = {10, S('c', 'o'), S('n', 't'), S('i', 'n'), S('u', 'e'), S(';', '\n')};
static const uint32_t __string_69[] = {2, S(';', '\n')};
static const uint32_t __string_70_return[] = {7, S('r', 'e'), S('t', 'u'), S('r', 'n'), S(' ', 0)};
static const uint32_t __string_71[] = {2, S(';', '\n')};
static const uint32_t __string_72_return[] = {8, S('r', 'e'), S('t', 'u'), S('r', 'n'), S(';', '\n')};
static const uint32_t __string_73[] = {3, S(' ', '='), S(' ', 0)};
static const uint32_t __string_74[] = {2, S(';', '\n')};
static const uint32_t __string_75_include_stdint_h[] = {20, S('#', 'i'), S('n', 'c'), S('l', 'u'), S('d', 'e'), S(' ', '<'), S('s', 't'), S('d', 'i'), S('n', 't'), S('.', 'h'), S('>', '\n')};
static const uint32_t __string_76_include[] = {10, S('#', 'i'), S('n', 'c'), S('l', 'u'), S('d', 'e'), S(' ', '"')};
static const uint32_t __string_77[] = {2, S('"', '\n')};
static const uint32_t __string_78_include_stdlib_h[] = {20, S('#', 'i'), S('n', 'c'), S('l', 'u'), S('d', 'e'), S(' ', '<'), S('s', 't'), S('d', 'l'), S('i', 'b'), S('.', 'h'), S('>', '\n')};
static const uint32_t __string_79_include_string_h[] = {20, S('#', 'i'), S('n', 'c'), S('l', 'u'), S('d', 'e'), S(' ', '<'), S('s', 't'), S('r', 'i'), S('n', 'g'), S('.', 'h'), S('>', '\n')};
static const uint32_t __string_80_struct[] = {7, S('s', 't'), S('r', 'u'), S('c', 't'), S(' ', 0)};
static const uint32_t __string_81[] = {2, S(';', '\n')};
static const uint32_t __string_82_struct[] = {7, S('s', 't'), S('r', 'u'), S('c', 't'), S(' ', 0)};
static const uint32_t __string_83[] = {3, S(' ', '{'), S('\n', 0)};
static const uint32_t __string_84[] = {2, S(';', '\n')};
static const uint32_t __string_85[] = {3, S('}', ';'), S('\n', 0)};
static const uint32_t __string_86_enum[] = {7, S('e', 'n'), S('u', 'm'), S(' ', '{'), S('\n', 0)};
static const uint32_t __string_87__[] = {1, S('_', 0)};
static const uint32_t __string_88[] = {3, S(' ', '='), S(' ', 0)};
static const uint32_t __string_89[] = {2, S(',', '\n')};
static const uint32_t __string_90[] = {1, S('\n', 0)};
static const uint32_t __string_91[] = {3, S('}', ';'), S('\n', 0)};
static const uint32_t __string_92_malloc[] = {6, S('m', 'a'), S('l', 'l'), S('o', 'c')};
static const uint32_t __string_93_memcpy[] = {6, S('m', 'e'), S('m', 'c'), S('p', 'y')};
static const uint32_t __string_94_memcmp[] = {6, S('m', 'e'), S('m', 'c'), S('m', 'p')};
static const uint32_t __string_95_static[] = {7, S('s', 't'), S('a', 't'), S('i', 'c'), S(' ', 0)};
static const uint32_t __string_96___this[] = {6, S('_', '_'), S('t', 'h'), S('i', 's')};
static const uint32_t __string_97[] = {2, S(',', ' ')};
static const uint32_t __string_98[] = {3, S(')', ';'), S('\n', 0)};
static const uint32_t __string_99_static[] = {7, S('s', 't'), S('a', 't'), S('i', 'c'), S(' ', 0)};
static const uint32_t __string_100[] = {3, S(' ', '='), S(' ', 0)};
static const uint32_t __string_101[] = {2, S(';', '\n')};
static const uint32_t __string_102_static[] = {7, S('s', 't'), S('a', 't'), S('i', 'c'), S(' ', 0)};
static const uint32_t __string_103[] = {2, S(',', ' ')};
static const uint32_t __string_104[] = {2, S(')', ' ')};
static const uint32_t __string_105_undef_S[] = {10, S('\n', '#'), S('u', 'n'), S('d', 'e'), S('f', ' '), S('S', '\n')};
static const uint32_t __string_106_0[] = {4, S('\'', '\\'), S('0', '\'')};
static const uint32_t __string_107_r[] = {4, S('\'', '\\'), S('r', '\'')};
static const uint32_t __string_108_n[] = {4, S('\'', '\\'), S('n', '\'')};
static const uint32_t __string_109_t[] = {4, S('\'', '\\'), S('t', '\'')};
static const uint32_t __string_110_h[] = {2, S('.', 'h')};
static const uint32_t __string_111_This_statement_is_not_allowed_he[] = {34, S('T', 'h'), S('i', 's'), S(' ', 's'), S('t', 'a'), S('t', 'e'), S('m', 'e'), S('n', 't'), S(' ', 'i'), S('s', ' '), S('n', 'o'), S('t', ' '), S('a', 'l'), S('l', 'o'), S('w', 'e'), S('d', ' '), S('h', 'e'), S('r', 'e')};
static const uint32_t __string_112[] = {1, S('+', 0)};
static const uint32_t __string_113[] = {1, S('-', 0)};
static const uint32_t __string_114[] = {1, S('+', 0)};
static const uint32_t __string_115_op_positive[] = {11, S('o', 'p'), S('_', 'p'), S('o', 's'), S('i', 't'), S('i', 'v'), S('e', 0)};
static const uint32_t __string_116_op_negative[] = {11, S('o', 'p'), S('_', 'n'), S('e', 'g'), S('a', 't'), S('i', 'v'), S('e', 0)};
static const uint32_t __string_117[] = {1, S('+', 0)};
static const uint32_t __string_118_op_add[] = {6, S('o', 'p'), S('_', 'a'), S('d', 'd')};
static const uint32_t __string_119_op_subtract[] = {11, S('o', 'p'), S('_', 's'), S('u', 'b'), S('t', 'r'), S('a', 'c'), S('t', 0)};
static const uint32_t __string_120[] = {1, S('%', 0)};
static const uint32_t __string_121_op_remainder[] = {12, S('o', 'p'), S('_', 'r'), S('e', 'm'), S('a', 'i'), S('n', 'd'), S('e', 'r')};
static const uint32_t __string_122[] = {1, S('&', 0)};
static const uint32_t __string_123_op_and[] = {6, S('o', 'p'), S('_', 'a'), S('n', 'd')};
static const uint32_t __string_124[] = {1, S('*', 0)};
static const uint32_t __string_125_op_multiply[] = {11, S('o', 'p'), S('_', 'm'), S('u', 'l'), S('t', 'i'), S('p', 'l'), S('y', 0)};
static const uint32_t __string_126[] = {2, S('*', '*')};
static const uint32_t __string_127_op_exponent[] = {11, S('o', 'p'), S('_', 'e'), S('x', 'p'), S('o', 'n'), S('e', 'n'), S('t', 0)};
static const uint32_t __string_128[] = {2, S('+', '+')};
static const uint32_t __string_129_op_increment[] = {12, S('o', 'p'), S('_', 'i'), S('n', 'c'), S('r', 'e'), S('m', 'e'), S('n', 't')};
static const uint32_t __string_130[] = {2, S('-', '-')};
static const uint32_t __string_131_op_decrement[] = {12, S('o', 'p'), S('_', 'd'), S('e', 'c'), S('r', 'e'), S('m', 'e'), S('n', 't')};
static const uint32_t __string_132[] = {1, S('/', 0)};
static const uint32_t __string_133_op_divide[] = {9, S('o', 'p'), S('_', 'd'), S('i', 'v'), S('i', 'd'), S('e', 0)};
static const uint32_t __string_134[] = {1, S('<', 0)};
static const uint32_t __string_135_op_lessThan[] = {11, S('o', 'p'), S('_', 'l'), S('e', 's'), S('s', 'T'), S('h', 'a'), S('n', 0)};
static const uint32_t __string_136[] = {2, S('<', '<')};
static const uint32_t __string_137_op_shiftLeft[] = {12, S('o', 'p'), S('_', 's'), S('h', 'i'), S('f', 't'), S('L', 'e'), S('f', 't')};
static const uint32_t __string_138[] = {2, S('=', '=')};
static const uint32_t __string_139_op_equals[] = {9, S('o', 'p'), S('_', 'e'), S('q', 'u'), S('a', 'l'), S('s', 0)};
static const uint32_t __string_140[] = {1, S('>', 0)};
static const uint32_t __string_141_op_greaterThan[] = {14, S('o', 'p'), S('_', 'g'), S('r', 'e'), S('a', 't'), S('e', 'r'), S('T', 'h'), S('a', 'n')};
static const uint32_t __string_142[] = {2, S('>', '>')};
static const uint32_t __string_143_op_shiftRight[] = {13, S('o', 'p'), S('_', 's'), S('h', 'i'), S('f', 't'), S('R', 'i'), S('g', 'h'), S('t', 0)};
static const uint32_t __string_144[] = {2, S('[', ']')};
static const uint32_t __string_145_op_get[] = {6, S('o', 'p'), S('_', 'g'), S('e', 't')};
static const uint32_t __string_146[] = {3, S('[', ']'), S('=', 0)};
static const uint32_t __string_147_op_set[] = {6, S('o', 'p'), S('_', 's'), S('e', 't')};
static const uint32_t __string_148[] = {1, S('^', 0)};
static const uint32_t __string_149_op_xor[] = {6, S('o', 'p'), S('_', 'x'), S('o', 'r')};
static const uint32_t __string_150[] = {1, S('|', 0)};
static const uint32_t __string_151_op_or[] = {5, S('o', 'p'), S('_', 'o'), S('r', 0)};
static const uint32_t __string_152[] = {1, S('~', 0)};
static const uint32_t __string_153_op_complement[] = {13, S('o', 'p'), S('_', 'c'), S('o', 'm'), S('p', 'l'), S('e', 'm'), S('e', 'n'), S('t', 0)};
static const uint32_t __string_154_this[] = {4, S('t', 'h'), S('i', 's')};
static const uint32_t __string_155_bool[] = {4, S('b', 'o'), S('o', 'l')};
static const uint32_t __string_156_byte[] = {4, S('b', 'y'), S('t', 'e')};
static const uint32_t __string_157_int[] = {3, S('i', 'n'), S('t', 0)};
static const uint32_t __string_158_sbyte[] = {5, S('s', 'b'), S('y', 't'), S('e', 0)};
static const uint32_t __string_159_short[] = {5, S('s', 'h'), S('o', 'r'), S('t', 0)};
static const uint32_t __string_160_string[] = {6, S('s', 't'), S('r', 'i'), S('n', 'g')};
static const uint32_t __string_161_uint[] = {4, S('u', 'i'), S('n', 't')};
static const uint32_t __string_162_ushort[] = {6, S('u', 's'), S('h', 'o'), S('r', 't')};
static const uint32_t __string_163_Unsupported_flag_export[] = {25, S('U', 'n'), S('s', 'u'), S('p', 'p'), S('o', 'r'), S('t', 'e'), S('d', ' '), S('f', 'l'), S('a', 'g'), S(' ', '\''), S('e', 'x'), S('p', 'o'), S('r', 't'), S('\'', 0)};
static const uint32_t __string_164_Unsupported_flag_protected[] = {28, S('U', 'n'), S('s', 'u'), S('p', 'p'), S('o', 'r'), S('t', 'e'), S('d', ' '), S('f', 'l'), S('a', 'g'), S(' ', '\''), S('p', 'r'), S('o', 't'), S('e', 'c'), S('t', 'e'), S('d', '\'')};
static const uint32_t __string_165_Unsupported_flag_static[] = {25, S('U', 'n'), S('s', 'u'), S('p', 'p'), S('o', 'r'), S('t', 'e'), S('d', ' '), S('f', 'l'), S('a', 'g'), S(' ', '\''), S('s', 't'), S('a', 't'), S('i', 'c'), S('\'', 0)};
static const uint32_t __string_166_Cannot_use_get_on_a_class[] = {27, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'u'), S('s', 'e'), S(' ', '\''), S('g', 'e'), S('t', '\''), S(' ', 'o'), S('n', ' '), S('a', ' '), S('c', 'l'), S('a', 's'), S('s', 0)};
static const uint32_t __string_167_Cannot_use_set_on_a_class[] = {27, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'u'), S('s', 'e'), S(' ', '\''), S('s', 'e'), S('t', '\''), S(' ', 'o'), S('n', ' '), S('a', ' '), S('c', 'l'), S('a', 's'), S('s', 0)};
static const uint32_t __string_168_Cannot_use_public_on_a_class[] = {30, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'u'), S('s', 'e'), S(' ', '\''), S('p', 'u'), S('b', 'l'), S('i', 'c'), S('\'', ' '), S('o', 'n'), S(' ', 'a'), S(' ', 'c'), S('l', 'a'), S('s', 's')};
static const uint32_t __string_169_Cannot_use_private_on_a_class[] = {31, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'u'), S('s', 'e'), S(' ', '\''), S('p', 'r'), S('i', 'v'), S('a', 't'), S('e', '\''), S(' ', 'o'), S('n', ' '), S('a', ' '), S('c', 'l'), S('a', 's'), S('s', 0)};
static const uint32_t __string_170_Cannot_use_get_on_an_enum[] = {27, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'u'), S('s', 'e'), S(' ', '\''), S('g', 'e'), S('t', '\''), S(' ', 'o'), S('n', ' '), S('a', 'n'), S(' ', 'e'), S('n', 'u'), S('m', 0)};
static const uint32_t __string_171_Cannot_use_set_on_an_enum[] = {27, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'u'), S('s', 'e'), S(' ', '\''), S('s', 'e'), S('t', '\''), S(' ', 'o'), S('n', ' '), S('a', 'n'), S(' ', 'e'), S('n', 'u'), S('m', 0)};
static const uint32_t __string_172_Cannot_use_public_on_an_enum[] = {30, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'u'), S('s', 'e'), S(' ', '\''), S('p', 'u'), S('b', 'l'), S('i', 'c'), S('\'', ' '), S('o', 'n'), S(' ', 'a'), S('n', ' '), S('e', 'n'), S('u', 'm')};
static const uint32_t __string_173_Cannot_use_private_on_an_enum[] = {31, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'u'), S('s', 'e'), S(' ', '\''), S('p', 'r'), S('i', 'v'), S('a', 't'), S('e', '\''), S(' ', 'o'), S('n', ' '), S('a', 'n'), S(' ', 'e'), S('n', 'u'), S('m', 0)};
static const uint32_t __string_174_Cannot_use_get_here[] = {21, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'u'), S('s', 'e'), S(' ', '\''), S('g', 'e'), S('t', '\''), S(' ', 'h'), S('e', 'r'), S('e', 0)};
static const uint32_t __string_175_Cannot_use_set_here[] = {21, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'u'), S('s', 'e'), S(' ', '\''), S('s', 'e'), S('t', '\''), S(' ', 'h'), S('e', 'r'), S('e', 0)};
static const uint32_t __string_176_Cannot_use_public_here[] = {24, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'u'), S('s', 'e'), S(' ', '\''), S('p', 'u'), S('b', 'l'), S('i', 'c'), S('\'', ' '), S('h', 'e'), S('r', 'e')};
static const uint32_t __string_177_Cannot_use_private_here[] = {25, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'u'), S('s', 'e'), S(' ', '\''), S('p', 'r'), S('i', 'v'), S('a', 't'), S('e', '\''), S(' ', 'h'), S('e', 'r'), S('e', 0)};
static const uint32_t __string_178_Cannot_use_both_get_and_set[] = {31, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'u'), S('s', 'e'), S(' ', 'b'), S('o', 't'), S('h', ' '), S('\'', 'g'), S('e', 't'), S('\'', ' '), S('a', 'n'), S('d', ' '), S('\'', 's'), S('e', 't'), S('\'', 0)};
static const uint32_t __string_179_Getters_must_not_have_any_argume[] = {35, S('G', 'e'), S('t', 't'), S('e', 'r'), S('s', ' '), S('m', 'u'), S('s', 't'), S(' ', 'n'), S('o', 't'), S(' ', 'h'), S('a', 'v'), S('e', ' '), S('a', 'n'), S('y', ' '), S('a', 'r'), S('g', 'u'), S('m', 'e'), S('n', 't'), S('s', 0)};
static const uint32_t __string_180_set_[] = {4, S('s', 'e'), S('t', '_')};
static const uint32_t __string_181_Setters_must_have_exactly_one_ar[] = {38, S('S', 'e'), S('t', 't'), S('e', 'r'), S('s', ' '), S('m', 'u'), S('s', 't'), S(' ', 'h'), S('a', 'v'), S('e', ' '), S('e', 'x'), S('a', 'c'), S('t', 'l'), S('y', ' '), S('o', 'n'), S('e', ' '), S('a', 'r'), S('g', 'u'), S('m', 'e'), S('n', 't')};
static const uint32_t __string_182[] = {1, S('~', 0)};
static const uint32_t __string_183[] = {2, S('+', '+')};
static const uint32_t __string_184[] = {2, S('-', '-')};
static const uint32_t __string_185_Operator[] = {10, S('O', 'p'), S('e', 'r'), S('a', 't'), S('o', 'r'), S(' ', '\'')};
static const uint32_t __string_186_must_not_have_any_arguments[] = {29, S('\'', ' '), S('m', 'u'), S('s', 't'), S(' ', 'n'), S('o', 't'), S(' ', 'h'), S('a', 'v'), S('e', ' '), S('a', 'n'), S('y', ' '), S('a', 'r'), S('g', 'u'), S('m', 'e'), S('n', 't'), S('s', 0)};
static const uint32_t __string_187[] = {1, S('+', 0)};
static const uint32_t __string_188[] = {1, S('-', 0)};
static const uint32_t __string_189_Operator[] = {10, S('O', 'p'), S('e', 'r'), S('a', 't'), S('o', 'r'), S(' ', '\'')};
static const uint32_t __string_190_must_have_at_most_one_argument[] = {32, S('\'', ' '), S('m', 'u'), S('s', 't'), S(' ', 'h'), S('a', 'v'), S('e', ' '), S('a', 't'), S(' ', 'm'), S('o', 's'), S('t', ' '), S('o', 'n'), S('e', ' '), S('a', 'r'), S('g', 'u'), S('m', 'e'), S('n', 't')};
static const uint32_t __string_191[] = {3, S('[', ']'), S('=', 0)};
static const uint32_t __string_192_Operator_must_have_at_leas[] = {46, S('O', 'p'), S('e', 'r'), S('a', 't'), S('o', 'r'), S(' ', '\''), S('[', ']'), S('=', '\''), S(' ', 'm'), S('u', 's'), S('t', ' '), S('h', 'a'), S('v', 'e'), S(' ', 'a'), S('t', ' '), S('l', 'e'), S('a', 's'), S('t', ' '), S('o', 'n'), S('e', ' '), S('a', 'r'), S('g', 'u'), S('m', 'e'), S('n', 't')};
static const uint32_t __string_193_Operator[] = {10, S('O', 'p'), S('e', 'r'), S('a', 't'), S('o', 'r'), S(' ', '\'')};
static const uint32_t __string_194_must_have_exactly_one_argument[] = {32, S('\'', ' '), S('m', 'u'), S('s', 't'), S(' ', 'h'), S('a', 'v'), S('e', ' '), S('e', 'x'), S('a', 'c'), S('t', 'l'), S('y', ' '), S('o', 'n'), S('e', ' '), S('a', 'r'), S('g', 'u'), S('m', 'e'), S('n', 't')};
static const uint32_t __string_195_Cannot_use_extern_on_an_instan[] = {43, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'u'), S('s', 'e'), S(' ', '\''), S('e', 'x'), S('t', 'e'), S('r', 'n'), S('\'', ' '), S('o', 'n'), S(' ', 'a'), S('n', ' '), S('i', 'n'), S('s', 't'), S('a', 'n'), S('c', 'e'), S(' ', 'f'), S('u', 'n'), S('c', 't'), S('i', 'o'), S('n', 0)};
static const uint32_t __string_196_Cannot_use_declare_on_an_insta[] = {44, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'u'), S('s', 'e'), S(' ', '\''), S('d', 'e'), S('c', 'l'), S('a', 'r'), S('e', '\''), S(' ', 'o'), S('n', ' '), S('a', 'n'), S(' ', 'i'), S('n', 's'), S('t', 'a'), S('n', 'c'), S('e', ' '), S('f', 'u'), S('n', 'c'), S('t', 'i'), S('o', 'n')};
static const uint32_t __string_197_Must_implement_this_function[] = {28, S('M', 'u'), S('s', 't'), S(' ', 'i'), S('m', 'p'), S('l', 'e'), S('m', 'e'), S('n', 't'), S(' ', 't'), S('h', 'i'), S('s', ' '), S('f', 'u'), S('n', 'c'), S('t', 'i'), S('o', 'n')};
static const uint32_t __string_198_this[] = {4, S('t', 'h'), S('i', 's')};
static const uint32_t __string_199___this[] = {6, S('_', '_'), S('t', 'h'), S('i', 's')};
static const uint32_t __string_200_Cannot_use_extern_on_an_unimpl[] = {48, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'u'), S('s', 'e'), S(' ', '\''), S('e', 'x'), S('t', 'e'), S('r', 'n'), S('\'', ' '), S('o', 'n'), S(' ', 'a'), S('n', ' '), S('u', 'n'), S('i', 'm'), S('p', 'l'), S('e', 'm'), S('e', 'n'), S('t', 'e'), S('d', ' '), S('f', 'u'), S('n', 'c'), S('t', 'i'), S('o', 'n')};
static const uint32_t __string_201_Declared_functions_must_be_prefi[] = {50, S('D', 'e'), S('c', 'l'), S('a', 'r'), S('e', 'd'), S(' ', 'f'), S('u', 'n'), S('c', 't'), S('i', 'o'), S('n', 's'), S(' ', 'm'), S('u', 's'), S('t', ' '), S('b', 'e'), S(' ', 'p'), S('r', 'e'), S('f', 'i'), S('x', 'e'), S('d', ' '), S('w', 'i'), S('t', 'h'), S(' ', '\''), S('d', 'e'), S('c', 'l'), S('a', 'r'), S('e', '\'')};
static const uint32_t __string_202_Cannot_use_declare_on_a_functi[] = {57, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'u'), S('s', 'e'), S(' ', '\''), S('d', 'e'), S('c', 'l'), S('a', 'r'), S('e', '\''), S(' ', 'o'), S('n', ' '), S('a', ' '), S('f', 'u'), S('n', 'c'), S('t', 'i'), S('o', 'n'), S(' ', 'w'), S('i', 't'), S('h', ' '), S('a', 'n'), S(' ', 'i'), S('m', 'p'), S('l', 'e'), S('m', 'e'), S('n', 't'), S('a', 't'), S('i', 'o'), S('n', 0)};
static const uint32_t __string_203_Cannot_use_get_on_a_variable[] = {30, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'u'), S('s', 'e'), S(' ', '\''), S('g', 'e'), S('t', '\''), S(' ', 'o'), S('n', ' '), S('a', ' '), S('v', 'a'), S('r', 'i'), S('a', 'b'), S('l', 'e')};
static const uint32_t __string_204_Cannot_use_set_on_a_variable[] = {30, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'u'), S('s', 'e'), S(' ', '\''), S('s', 'e'), S('t', '\''), S(' ', 'o'), S('n', ' '), S('a', ' '), S('v', 'a'), S('r', 'i'), S('a', 'b'), S('l', 'e')};
static const uint32_t __string_205_Cannot_use_public_here[] = {24, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'u'), S('s', 'e'), S(' ', '\''), S('p', 'u'), S('b', 'l'), S('i', 'c'), S('\'', ' '), S('h', 'e'), S('r', 'e')};
static const uint32_t __string_206_Cannot_use_private_here[] = {25, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'u'), S('s', 'e'), S(' ', '\''), S('p', 'r'), S('i', 'v'), S('a', 't'), S('e', '\''), S(' ', 'h'), S('e', 'r'), S('e', 0)};
static const uint32_t __string_207_Cannot_create_untyped_variables[] = {31, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'c'), S('r', 'e'), S('a', 't'), S('e', ' '), S('u', 'n'), S('t', 'y'), S('p', 'e'), S('d', ' '), S('v', 'a'), S('r', 'i'), S('a', 'b'), S('l', 'e'), S('s', 0)};
static const uint32_t __string_208_Cannot_create_a_variable_with_ty[] = {36, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'c'), S('r', 'e'), S('a', 't'), S('e', ' '), S('a', ' '), S('v', 'a'), S('r', 'i'), S('a', 'b'), S('l', 'e'), S(' ', 'w'), S('i', 't'), S('h', ' '), S('t', 'y'), S('p', 'e'), S(' ', '\'')};
static const uint32_t __string_209_Invalid_constant_initializer[] = {28, S('I', 'n'), S('v', 'a'), S('l', 'i'), S('d', ' '), S('c', 'o'), S('n', 's'), S('t', 'a'), S('n', 't'), S(' ', 'i'), S('n', 'i'), S('t', 'i'), S('a', 'l'), S('i', 'z'), S('e', 'r')};
static const uint32_t __string_210_Constants_must_be_initialized[] = {29, S('C', 'o'), S('n', 's'), S('t', 'a'), S('n', 't'), S('s', ' '), S('m', 'u'), S('s', 't'), S(' ', 'b'), S('e', ' '), S('i', 'n'), S('i', 't'), S('i', 'a'), S('l', 'i'), S('z', 'e'), S('d', 0)};
static const uint32_t __string_211_The_symbol[] = {12, S('T', 'h'), S('e', ' '), S('s', 'y'), S('m', 'b'), S('o', 'l'), S(' ', '\'')};
static const uint32_t __string_212_shadows_another_symbol_with_th[] = {61, S('\'', ' '), S('s', 'h'), S('a', 'd'), S('o', 'w'), S('s', ' '), S('a', 'n'), S('o', 't'), S('h', 'e'), S('r', ' '), S('s', 'y'), S('m', 'b'), S('o', 'l'), S(' ', 'w'), S('i', 't'), S('h', ' '), S('t', 'h'), S('e', ' '), S('s', 'a'), S('m', 'e'), S(' ', 'n'), S('a', 'm'), S('e', ' '), S('i', 'n'), S(' ', 'a'), S(' ', 'p'), S('a', 'r'), S('e', 'n'), S('t', ' '), S('s', 'c'), S('o', 'p'), S('e', 0)};
static const uint32_t __string_213_Expected_expression_but_found_ty[] = {34, S('E', 'x'), S('p', 'e'), S('c', 't'), S('e', 'd'), S(' ', 'e'), S('x', 'p'), S('r', 'e'), S('s', 's'), S('i', 'o'), S('n', ' '), S('b', 'u'), S('t', ' '), S('f', 'o'), S('u', 'n'), S('d', ' '), S('t', 'y'), S('p', 'e')};
static const uint32_t __string_214_This_expression_does_not_return[] = {39, S('T', 'h'), S('i', 's'), S(' ', 'e'), S('x', 'p'), S('r', 'e'), S('s', 's'), S('i', 'o'), S('n', ' '), S('d', 'o'), S('e', 's'), S(' ', 'n'), S('o', 't'), S(' ', 'r'), S('e', 't'), S('u', 'r'), S('n', ' '), S('a', ' '), S('v', 'a'), S('l', 'u'), S('e', 0)};
static const uint32_t __string_215_Expected_type_but_found_expressi[] = {34, S('E', 'x'), S('p', 'e'), S('c', 't'), S('e', 'd'), S(' ', 't'), S('y', 'p'), S('e', ' '), S('b', 'u'), S('t', ' '), S('f', 'o'), S('u', 'n'), S('d', ' '), S('e', 'x'), S('p', 'r'), S('e', 's'), S('s', 'i'), S('o', 'n')};
static const uint32_t __string_216_Cannot_convert_from_type[] = {26, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'c'), S('o', 'n'), S('v', 'e'), S('r', 't'), S(' ', 'f'), S('r', 'o'), S('m', ' '), S('t', 'y'), S('p', 'e'), S(' ', '\'')};
static const uint32_t __string_217_to_type[] = {11, S('\'', ' '), S('t', 'o'), S(' ', 't'), S('y', 'p'), S('e', ' '), S('\'', 0)};
static const uint32_t __string_218_without_a_cast[] = {16, S('\'', ' '), S('w', 'i'), S('t', 'h'), S('o', 'u'), S('t', ' '), S('a', ' '), S('c', 'a'), S('s', 't')};
static const uint32_t __string_219[] = {1, S('\'', 0)};
static const uint32_t __string_220_Cannot_store_to_this_location[] = {29, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 's'), S('t', 'o'), S('r', 'e'), S(' ', 't'), S('o', ' '), S('t', 'h'), S('i', 's'), S(' ', 'l'), S('o', 'c'), S('a', 't'), S('i', 'o'), S('n', 0)};
static const uint32_t __string_221_Cannot_use_symbol[] = {19, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'u'), S('s', 'e'), S(' ', 's'), S('y', 'm'), S('b', 'o'), S('l', ' '), S('\'', 0)};
static const uint32_t __string_222_outside_an_unsafe_block[] = {27, S('\'', ' '), S('o', 'u'), S('t', 's'), S('i', 'd'), S('e', ' '), S('a', 'n'), S(' ', '\''), S('u', 'n'), S('s', 'a'), S('f', 'e'), S('\'', ' '), S('b', 'l'), S('o', 'c'), S('k', 0)};
static const uint32_t __string_223_Cannot_access_private_symbol[] = {30, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'a'), S('c', 'c'), S('e', 's'), S('s', ' '), S('p', 'r'), S('i', 'v'), S('a', 't'), S('e', ' '), S('s', 'y'), S('m', 'b'), S('o', 'l'), S(' ', '\'')};
static const uint32_t __string_224_here[] = {6, S('\'', ' '), S('h', 'e'), S('r', 'e')};
static const uint32_t __string_225_Cannot_use_setter[] = {19, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'u'), S('s', 'e'), S(' ', 's'), S('e', 't'), S('t', 'e'), S('r', ' '), S('\'', 0)};
static const uint32_t __string_226_here[] = {6, S('\'', ' '), S('h', 'e'), S('r', 'e')};
static const uint32_t __string_227_Must_call_function[] = {20, S('M', 'u'), S('s', 't'), S(' ', 'c'), S('a', 'l'), S('l', ' '), S('f', 'u'), S('n', 'c'), S('t', 'i'), S('o', 'n'), S(' ', '\'')};
static const uint32_t __string_228_Global_initializers_must_be_comp[] = {50, S('G', 'l'), S('o', 'b'), S('a', 'l'), S(' ', 'i'), S('n', 'i'), S('t', 'i'), S('a', 'l'), S('i', 'z'), S('e', 'r'), S('s', ' '), S('m', 'u'), S('s', 't'), S(' ', 'b'), S('e', ' '), S('c', 'o'), S('m', 'p'), S('i', 'l'), S('e', '-'), S('t', 'i'), S('m', 'e'), S(' ', 'c'), S('o', 'n'), S('s', 't'), S('a', 'n'), S('t', 's')};
static const uint32_t __string_229_Cannot_use_this_statement_outsid[] = {43, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'u'), S('s', 'e'), S(' ', 't'), S('h', 'i'), S('s', ' '), S('s', 't'), S('a', 't'), S('e', 'm'), S('e', 'n'), S('t', ' '), S('o', 'u'), S('t', 's'), S('i', 'd'), S('e', ' '), S('o', 'f'), S(' ', 'a'), S(' ', 'l'), S('o', 'o'), S('p', 0)};
static const uint32_t __string_230[] = {2, S('[', ']')};
static const uint32_t __string_231_Cannot_index_into_type[] = {24, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'i'), S('n', 'd'), S('e', 'x'), S(' ', 'i'), S('n', 't'), S('o', ' '), S('t', 'y'), S('p', 'e'), S(' ', '\'')};
static const uint32_t __string_232_this[] = {4, S('t', 'h'), S('i', 's')};
static const uint32_t __string_233_Cannot_use_this_here[] = {22, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'u'), S('s', 'e'), S(' ', '\''), S('t', 'h'), S('i', 's'), S('\'', ' '), S('h', 'e'), S('r', 'e')};
static const uint32_t __string_234_No_symbol_named[] = {17, S('N', 'o'), S(' ', 's'), S('y', 'm'), S('b', 'o'), S('l', ' '), S('n', 'a'), S('m', 'e'), S('d', ' '), S('\'', 0)};
static const uint32_t __string_235_here[] = {6, S('\'', ' '), S('h', 'e'), S('r', 'e')};
static const uint32_t __string_236_did_you_mean_this[] = {21, S(',', ' '), S('d', 'i'), S('d', ' '), S('y', 'o'), S('u', ' '), S('m', 'e'), S('a', 'n'), S(' ', '\''), S('t', 'h'), S('i', 's'), S('.', 0)};
static const uint32_t __string_237[] = {2, S('\'', '?')};
static const uint32_t __string_238_number[] = {6, S('n', 'u'), S('m', 'b'), S('e', 'r')};
static const uint32_t __string_239_did_you_mean_int[] = {21, S(',', ' '), S('d', 'i'), S('d', ' '), S('y', 'o'), S('u', ' '), S('m', 'e'), S('a', 'n'), S(' ', '\''), S('i', 'n'), S('t', '\''), S('?', 0)};
static const uint32_t __string_240_boolean[] = {7, S('b', 'o'), S('o', 'l'), S('e', 'a'), S('n', 0)};
static const uint32_t __string_241_did_you_mean_bool[] = {22, S(',', ' '), S('d', 'i'), S('d', ' '), S('y', 'o'), S('u', ' '), S('m', 'e'), S('a', 'n'), S(' ', '\''), S('b', 'o'), S('o', 'l'), S('\'', '?')};
static const uint32_t __string_242_Cyclic_reference_to_symbol[] = {28, S('C', 'y'), S('c', 'l'), S('i', 'c'), S(' ', 'r'), S('e', 'f'), S('e', 'r'), S('e', 'n'), S('c', 'e'), S(' ', 't'), S('o', ' '), S('s', 'y'), S('m', 'b'), S('o', 'l'), S(' ', '\'')};
static const uint32_t __string_243_here[] = {6, S('\'', ' '), S('h', 'e'), S('r', 'e')};
static const uint32_t __string_244_No_member_named[] = {17, S('N', 'o'), S(' ', 'm'), S('e', 'm'), S('b', 'e'), S('r', ' '), S('n', 'a'), S('m', 'e'), S('d', ' '), S('\'', 0)};
static const uint32_t __string_245_on_type[] = {11, S('\'', ' '), S('o', 'n'), S(' ', 't'), S('y', 'p'), S('e', ' '), S('\'', 0)};
static const uint32_t __string_246_The_type[] = {10, S('T', 'h'), S('e', ' '), S('t', 'y'), S('p', 'e'), S(' ', '\'')};
static const uint32_t __string_247_has_no_members[] = {16, S('\'', ' '), S('h', 'a'), S('s', ' '), S('n', 'o'), S(' ', 'm'), S('e', 'm'), S('b', 'e'), S('r', 's')};
static const uint32_t __string_248_Cannot_call_value_of_type[] = {27, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'c'), S('a', 'l'), S('l', ' '), S('v', 'a'), S('l', 'u'), S('e', ' '), S('o', 'f'), S(' ', 't'), S('y', 'p'), S('e', ' '), S('\'', 0)};
static const uint32_t __string_249_Not_enough_arguments_for_functio[] = {35, S('N', 'o'), S('t', ' '), S('e', 'n'), S('o', 'u'), S('g', 'h'), S(' ', 'a'), S('r', 'g'), S('u', 'm'), S('e', 'n'), S('t', 's'), S(' ', 'f'), S('o', 'r'), S(' ', 'f'), S('u', 'n'), S('c', 't'), S('i', 'o'), S('n', ' '), S('\'', 0)};
static const uint32_t __string_250_Too_many_arguments_for_function[] = {33, S('T', 'o'), S('o', ' '), S('m', 'a'), S('n', 'y'), S(' ', 'a'), S('r', 'g'), S('u', 'm'), S('e', 'n'), S('t', 's'), S(' ', 'f'), S('o', 'r'), S(' ', 'f'), S('u', 'n'), S('c', 't'), S('i', 'o'), S('n', ' '), S('\'', 0)};
static const uint32_t __string_251_Unexpected_return_value_in_funct[] = {52, S('U', 'n'), S('e', 'x'), S('p', 'e'), S('c', 't'), S('e', 'd'), S(' ', 'r'), S('e', 't'), S('u', 'r'), S('n', ' '), S('v', 'a'), S('l', 'u'), S('e', ' '), S('i', 'n'), S(' ', 'f'), S('u', 'n'), S('c', 't'), S('i', 'o'), S('n', ' '), S('r', 'e'), S('t', 'u'), S('r', 'n'), S('i', 'n'), S('g', ' '), S('\'', 'v'), S('o', 'i'), S('d', '\'')};
static const uint32_t __string_252_Expected_return_value_in_functio[] = {45, S('E', 'x'), S('p', 'e'), S('c', 't'), S('e', 'd'), S(' ', 'r'), S('e', 't'), S('u', 'r'), S('n', ' '), S('v', 'a'), S('l', 'u'), S('e', ' '), S('i', 'n'), S(' ', 'f'), S('u', 'n'), S('c', 't'), S('i', 'o'), S('n', ' '), S('r', 'e'), S('t', 'u'), S('r', 'n'), S('i', 'n'), S('g', ' '), S('\'', 0)};
static const uint32_t __string_253_Type[] = {6, S('T', 'y'), S('p', 'e'), S(' ', '\'')};
static const uint32_t __string_254_is_not_the_same_as_type[] = {27, S('\'', ' '), S('i', 's'), S(' ', 'n'), S('o', 't'), S(' ', 't'), S('h', 'e'), S(' ', 's'), S('a', 'm'), S('e', ' '), S('a', 's'), S(' ', 't'), S('y', 'p'), S('e', ' '), S('\'', 0)};
static const uint32_t __string_255[] = {3, S('[', ']'), S('=', 0)};
static const uint32_t __string_256_Cannot_index_into_type[] = {24, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'i'), S('n', 'd'), S('e', 'x'), S(' ', 'i'), S('n', 't'), S('o', ' '), S('t', 'y'), S('p', 'e'), S(' ', '\'')};
static const uint32_t __string_257_Cannot_construct_type[] = {23, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'c'), S('o', 'n'), S('s', 't'), S('r', 'u'), S('c', 't'), S(' ', 't'), S('y', 'p'), S('e', ' '), S('\'', 0)};
static const uint32_t __string_258_Constructors_with_arguments_are[] = {49, S('C', 'o'), S('n', 's'), S('t', 'r'), S('u', 'c'), S('t', 'o'), S('r', 's'), S(' ', 'w'), S('i', 't'), S('h', ' '), S('a', 'r'), S('g', 'u'), S('m', 'e'), S('n', 't'), S('s', ' '), S('a', 'r'), S('e', ' '), S('n', 'o'), S('t', ' '), S('s', 'u'), S('p', 'p'), S('o', 'r'), S('t', 'e'), S('d', ' '), S('y', 'e'), S('t', 0)};
static const uint32_t __string_259_Cannot_use_pointers_when_compili[] = {48, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'u'), S('s', 'e'), S(' ', 'p'), S('o', 'i'), S('n', 't'), S('e', 'r'), S('s', ' '), S('w', 'h'), S('e', 'n'), S(' ', 'c'), S('o', 'm'), S('p', 'i'), S('l', 'i'), S('n', 'g'), S(' ', 't'), S('o', ' '), S('J', 'a'), S('v', 'a'), S('S', 'c'), S('r', 'i'), S('p', 't')};
static const uint32_t __string_260_Cannot_use_pointers_outside_an[] = {45, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'u'), S('s', 'e'), S(' ', 'p'), S('o', 'i'), S('n', 't'), S('e', 'r'), S('s', ' '), S('o', 'u'), S('t', 's'), S('i', 'd'), S('e', ' '), S('a', 'n'), S(' ', '\''), S('u', 'n'), S('s', 'a'), S('f', 'e'), S('\'', ' '), S('b', 'l'), S('o', 'c'), S('k', 0)};
static const uint32_t __string_261_Cannot_create_a_pointer_to_non_i[] = {45, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'c'), S('r', 'e'), S('a', 't'), S('e', ' '), S('a', ' '), S('p', 'o'), S('i', 'n'), S('t', 'e'), S('r', ' '), S('t', 'o'), S(' ', 'n'), S('o', 'n'), S('-', 'i'), S('n', 't'), S('e', 'g'), S('e', 'r'), S(' ', 't'), S('y', 'p'), S('e', ' '), S('\'', 0)};
static const uint32_t __string_262_Cannot_dereference_type[] = {25, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'd'), S('e', 'r'), S('e', 'f'), S('e', 'r'), S('e', 'n'), S('c', 'e'), S(' ', 't'), S('y', 'p'), S('e', ' '), S('\'', 0)};
static const uint32_t __string_263_The_address_of_operator_is_not_s[] = {40, S('T', 'h'), S('e', ' '), S('a', 'd'), S('d', 'r'), S('e', 's'), S('s', '-'), S('o', 'f'), S(' ', 'o'), S('p', 'e'), S('r', 'a'), S('t', 'o'), S('r', ' '), S('i', 's'), S(' ', 'n'), S('o', 't'), S(' ', 's'), S('u', 'p'), S('p', 'o'), S('r', 't'), S('e', 'd')};
static const uint32_t __string_264_Cannot_use_unary_operator[] = {27, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'u'), S('s', 'e'), S(' ', 'u'), S('n', 'a'), S('r', 'y'), S(' ', 'o'), S('p', 'e'), S('r', 'a'), S('t', 'o'), S('r', ' '), S('\'', 0)};
static const uint32_t __string_265_with_type[] = {13, S('\'', ' '), S('w', 'i'), S('t', 'h'), S(' ', 't'), S('y', 'p'), S('e', ' '), S('\'', 0)};
static const uint32_t __string_266_Cannot_compare_type[] = {21, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'c'), S('o', 'm'), S('p', 'a'), S('r', 'e'), S(' ', 't'), S('y', 'p'), S('e', ' '), S('\'', 0)};
static const uint32_t __string_267_with_type[] = {13, S('\'', ' '), S('w', 'i'), S('t', 'h'), S(' ', 't'), S('y', 'p'), S('e', ' '), S('\'', 0)};
static const uint32_t __string_268_This_operator_is_not_currently_s[] = {40, S('T', 'h'), S('i', 's'), S(' ', 'o'), S('p', 'e'), S('r', 'a'), S('t', 'o'), S('r', ' '), S('i', 's'), S(' ', 'n'), S('o', 't'), S(' ', 'c'), S('u', 'r'), S('r', 'e'), S('n', 't'), S('l', 'y'), S(' ', 's'), S('u', 'p'), S('p', 'o'), S('r', 't'), S('e', 'd')};
static const uint32_t __string_269[] = {2, S('=', '=')};
static const uint32_t __string_270[] = {1, S('>', 0)};
static const uint32_t __string_271[] = {1, S('<', 0)};
static const uint32_t __string_272_Cannot_compare_type[] = {21, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'c'), S('o', 'm'), S('p', 'a'), S('r', 'e'), S(' ', 't'), S('y', 'p'), S('e', ' '), S('\'', 0)};
static const uint32_t __string_273_with_type[] = {13, S('\'', ' '), S('w', 'i'), S('t', 'h'), S(' ', 't'), S('y', 'p'), S('e', ' '), S('\'', 0)};
static const uint32_t __string_274_Cannot_use_binary_operator[] = {28, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'u'), S('s', 'e'), S(' ', 'b'), S('i', 'n'), S('a', 'r'), S('y', ' '), S('o', 'p'), S('e', 'r'), S('a', 't'), S('o', 'r'), S(' ', '\'')};
static const uint32_t __string_275_with_type[] = {13, S('\'', ' '), S('w', 'i'), S('t', 'h'), S(' ', 't'), S('y', 'p'), S('e', ' '), S('\'', 0)};
static const uint32_t __string_276_native[] = {8, S('<', 'n'), S('a', 't'), S('i', 'v'), S('e', '>')};
static const uint32_t __string_277_C[] = {1, S('C', 0)};
static const uint32_t __string_278_JS[] = {2, S('J', 'S')};
static const uint32_t __string_279_WASM[] = {4, S('W', 'A'), S('S', 'M')};
static const uint32_t __string_280_error[] = {7, S('<', 'e'), S('r', 'r'), S('o', 'r'), S('>', 0)};
static const uint32_t __string_281_null[] = {4, S('n', 'u'), S('l', 'l')};
static const uint32_t __string_282_void[] = {4, S('v', 'o'), S('i', 'd')};
static const uint32_t __string_283_lexing[] = {6, S('l', 'e'), S('x', 'i'), S('n', 'g')};
static const uint32_t __string_284_preprocessing[] = {13, S('p', 'r'), S('e', 'p'), S('r', 'o'), S('c', 'e'), S('s', 's'), S('i', 'n'), S('g', 0)};
static const uint32_t __string_285_parsing[] = {7, S('p', 'a'), S('r', 's'), S('i', 'n'), S('g', 0)};
static const uint32_t __string_286_checking[] = {8, S('c', 'h'), S('e', 'c'), S('k', 'i'), S('n', 'g')};
static const uint32_t __string_287_shaking[] = {7, S('s', 'h'), S('a', 'k'), S('i', 'n'), S('g', 0)};
static const uint32_t __string_288_emitting[] = {8, S('e', 'm'), S('i', 't'), S('t', 'i'), S('n', 'g')};
static const uint32_t __string_289[] = {1, S('.', 0)};
static const uint32_t __string_290[] = {1, S('/', 0)};
static const uint32_t __string_291[] = {1, S('\\', 0)};
static const uint32_t __string_292[] = {2, S(' ', ' ')};
static const uint32_t __string_293[] = {2, S('{', '\n')};
static const uint32_t __string_294_0[] = {6, S(' ', '>'), S('>', '>'), S(' ', '0')};
static const uint32_t __string_295_0[] = {4, S(' ', '|'), S(' ', '0')};
static const uint32_t __string_296_0[] = {6, S(' ', '>'), S('>', '>'), S(' ', '0')};
static const uint32_t __string_297_0[] = {4, S(' ', '|'), S(' ', '0')};
static const uint32_t __string_298[] = {2, S(',', ' ')};
static const uint32_t __string_299___declare[] = {10, S('_', '_'), S('d', 'e'), S('c', 'l'), S('a', 'r'), S('e', '.')};
static const uint32_t __string_300_null[] = {4, S('n', 'u'), S('l', 'l')};
static const uint32_t __string_301_true[] = {4, S('t', 'r'), S('u', 'e')};
static const uint32_t __string_302_false[] = {5, S('f', 'a'), S('l', 's'), S('e', 0)};
static const uint32_t __string_303[] = {4, S(' ', '<'), S('<', ' ')};
static const uint32_t __string_304[] = {4, S(' ', '>'), S('>', ' ')};
static const uint32_t __string_305[] = {3, S(' ', '&'), S(' ', 0)};
static const uint32_t __string_306_0[] = {4, S(' ', '|'), S(' ', '0')};
static const uint32_t __string_307_0[] = {6, S(' ', '>'), S('>', '>'), S(' ', '0')};
static const uint32_t __string_308[] = {3, S(' ', '?'), S(' ', 0)};
static const uint32_t __string_309[] = {3, S(' ', ':'), S(' ', 0)};
static const uint32_t __string_310_new[] = {4, S('n', 'e'), S('w', ' ')};
static const uint32_t __string_311[] = {2, S('(', ')')};
static const uint32_t __string_312[] = {1, S('!', 0)};
static const uint32_t __string_313[] = {1, S('~', 0)};
static const uint32_t __string_314[] = {1, S('-', 0)};
static const uint32_t __string_315[] = {1, S('+', 0)};
static const uint32_t __string_316[] = {2, S('+', '+')};
static const uint32_t __string_317[] = {2, S('-', '-')};
static const uint32_t __string_318[] = {2, S('+', '+')};
static const uint32_t __string_319[] = {2, S('-', '-')};
static const uint32_t __string_320[] = {3, S(' ', '+'), S(' ', 0)};
static const uint32_t __string_321[] = {3, S(' ', '='), S(' ', 0)};
static const uint32_t __string_322[] = {3, S(' ', '&'), S(' ', 0)};
static const uint32_t __string_323[] = {3, S(' ', '|'), S(' ', 0)};
static const uint32_t __string_324[] = {3, S(' ', '^'), S(' ', 0)};
static const uint32_t __string_325[] = {3, S(' ', '/'), S(' ', 0)};
static const uint32_t __string_326[] = {5, S(' ', '='), S('=', '='), S(' ', 0)};
static const uint32_t __string_327[] = {3, S(' ', '>'), S(' ', 0)};
static const uint32_t __string_328[] = {4, S(' ', '>'), S('=', ' ')};
static const uint32_t __string_329[] = {3, S(' ', '<'), S(' ', 0)};
static const uint32_t __string_330[] = {4, S(' ', '<'), S('=', ' ')};
static const uint32_t __string_331[] = {4, S(' ', '&'), S('&', ' ')};
static const uint32_t __string_332[] = {4, S(' ', '|'), S('|', ' ')};
static const uint32_t __string_333[] = {5, S(' ', '!'), S('=', '='), S(' ', 0)};
static const uint32_t __string_334[] = {3, S(' ', '%'), S(' ', 0)};
static const uint32_t __string_335[] = {4, S(' ', '<'), S('<', ' ')};
static const uint32_t __string_336[] = {5, S(' ', '>'), S('>', '>'), S(' ', 0)};
static const uint32_t __string_337[] = {4, S(' ', '>'), S('>', ' ')};
static const uint32_t __string_338[] = {3, S(' ', '-'), S(' ', 0)};
static const uint32_t __string_339___imul[] = {7, S('_', '_'), S('i', 'm'), S('u', 'l'), S('(', 0)};
static const uint32_t __string_340[] = {2, S(',', ' ')};
static const uint32_t __string_341_0[] = {6, S(' ', '>'), S('>', '>'), S(' ', '0')};
static const uint32_t __string_342_prototype[] = {11, S('.', 'p'), S('r', 'o'), S('t', 'o'), S('t', 'y'), S('p', 'e'), S('.', 0)};
static const uint32_t __string_343_function[] = {11, S(' ', '='), S(' ', 'f'), S('u', 'n'), S('c', 't'), S('i', 'o'), S('n', 0)};
static const uint32_t __string_344_var[] = {4, S('v', 'a'), S('r', ' ')};
static const uint32_t __string_345___extern[] = {12, S(' ', '='), S(' ', '_'), S('_', 'e'), S('x', 't'), S('e', 'r'), S('n', '.')};
static const uint32_t __string_346_function[] = {11, S(' ', '='), S(' ', 'f'), S('u', 'n'), S('c', 't'), S('i', 'o'), S('n', 0)};
static const uint32_t __string_347_function[] = {9, S('f', 'u'), S('n', 'c'), S('t', 'i'), S('o', 'n'), S(' ', 0)};
static const uint32_t __string_348[] = {2, S(',', ' ')};
static const uint32_t __string_349[] = {2, S(')', ' ')};
static const uint32_t __string_350[] = {2, S(';', '\n')};
static const uint32_t __string_351[] = {1, S('\n', 0)};
static const uint32_t __string_352_if[] = {4, S('i', 'f'), S(' ', '(')};
static const uint32_t __string_353[] = {2, S(')', ' ')};
static const uint32_t __string_354[] = {2, S('\n', '\n')};
static const uint32_t __string_355_else[] = {5, S('e', 'l'), S('s', 'e'), S(' ', 0)};
static const uint32_t __string_356_while[] = {7, S('w', 'h'), S('i', 'l'), S('e', ' '), S('(', 0)};
static const uint32_t __string_357[] = {2, S(')', ' ')};
static const uint32_t __string_358_break[] = {7, S('b', 'r'), S('e', 'a'), S('k', ';'), S('\n', 0)};
static const uint32_t __string_359_continue[] = {10, S('c', 'o'), S('n', 't'), S('i', 'n'), S('u', 'e'), S(';', '\n')};
static const uint32_t __string_360[] = {2, S(';', '\n')};
static const uint32_t __string_361_return[] = {7, S('r', 'e'), S('t', 'u'), S('r', 'n'), S(' ', 0)};
static const uint32_t __string_362[] = {2, S(';', '\n')};
static const uint32_t __string_363_return[] = {8, S('r', 'e'), S('t', 'u'), S('r', 'n'), S(';', '\n')};
static const uint32_t __string_364_var[] = {4, S('v', 'a'), S('r', ' ')};
static const uint32_t __string_365[] = {2, S(',', ' ')};
static const uint32_t __string_366[] = {3, S(' ', '='), S(' ', 0)};
static const uint32_t __string_367[] = {2, S(';', '\n')};
static const uint32_t __string_368_function[] = {9, S('f', 'u'), S('n', 'c'), S('t', 'i'), S('o', 'n'), S(' ', 0)};
static const uint32_t __string_369[] = {5, S('(', ')'), S(' ', '{'), S('\n', 0)};
static const uint32_t __string_370_this[] = {5, S('t', 'h'), S('i', 's'), S('.', 0)};
static const uint32_t __string_371[] = {3, S(' ', '='), S(' ', 0)};
static const uint32_t __string_372[] = {2, S(';', '\n')};
static const uint32_t __string_373[] = {2, S('}', '\n')};
static const uint32_t __string_374___extern[] = {9, S('_', '_'), S('e', 'x'), S('t', 'e'), S('r', 'n'), S('.', 0)};
static const uint32_t __string_375[] = {5, S(' ', '='), S(' ', '{'), S('\n', 0)};
static const uint32_t __string_376[] = {2, S(':', ' ')};
static const uint32_t __string_377[] = {2, S(',', '\n')};
static const uint32_t __string_378[] = {1, S('\n', 0)};
static const uint32_t __string_379[] = {3, S('}', ';'), S('\n', 0)};
static const uint32_t __string_380_function___declare___extern[] = {33, S('(', 'f'), S('u', 'n'), S('c', 't'), S('i', 'o'), S('n', '('), S('_', '_'), S('d', 'e'), S('c', 'l'), S('a', 'r'), S('e', ','), S(' ', '_'), S('_', 'e'), S('x', 't'), S('e', 'r'), S('n', ')'), S(' ', '{'), S('\n', 0)};
static const uint32_t __string_381_var___imul_Math_imul_functi[] = {43, S('v', 'a'), S('r', ' '), S('_', '_'), S('i', 'm'), S('u', 'l'), S(' ', '='), S(' ', 'M'), S('a', 't'), S('h', '.'), S('i', 'm'), S('u', 'l'), S(' ', '|'), S('|', ' '), S('f', 'u'), S('n', 'c'), S('t', 'i'), S('o', 'n'), S('(', 'a'), S(',', ' '), S('b', ')'), S(' ', '{'), S('\n', 0)};
static const uint32_t __string_382_return_a_b_16_16[] = {53, S('r', 'e'), S('t', 'u'), S('r', 'n'), S(' ', '('), S('a', ' '), S('*', ' '), S('(', 'b'), S(' ', '>'), S('>', '>'), S(' ', '1'), S('6', ')'), S(' ', '<'), S('<', ' '), S('1', '6'), S(')', ' '), S('+', ' '), S('a', ' '), S('*', ' '), S('(', 'b'), S(' ', '&'), S(' ', '6'), S('5', '5'), S('3', '5'), S(')', ' '), S('|', ' '), S('0', ';'), S('\n', 0)};
static const uint32_t __string_383[] = {3, S('}', ';'), S('\n', 0)};
static const uint32_t __string_384[] = {3, S('}', '('), S('\n', 0)};
static const uint32_t __string_385_typeof_global_undefined[] = {47, S('t', 'y'), S('p', 'e'), S('o', 'f'), S(' ', 'g'), S('l', 'o'), S('b', 'a'), S('l', ' '), S('!', '='), S('=', ' '), S('\'', 'u'), S('n', 'd'), S('e', 'f'), S('i', 'n'), S('e', 'd'), S('\'', ' '), S('?', ' '), S('g', 'l'), S('o', 'b'), S('a', 'l'), S(' ', ':'), S(' ', 't'), S('h', 'i'), S('s', ','), S('\n', 0)};
static const uint32_t __string_386_typeof_exports_undefined[] = {48, S('t', 'y'), S('p', 'e'), S('o', 'f'), S(' ', 'e'), S('x', 'p'), S('o', 'r'), S('t', 's'), S(' ', '!'), S('=', '='), S(' ', '\''), S('u', 'n'), S('d', 'e'), S('f', 'i'), S('n', 'e'), S('d', '\''), S(' ', '?'), S(' ', 'e'), S('x', 'p'), S('o', 'r'), S('t', 's'), S(' ', ':'), S(' ', 't'), S('h', 'i'), S('s', '\n')};
static const uint32_t __string_387[] = {4, S(')', ')'), S(';', '\n')};
static const uint32_t __string_388_end_of_file[] = {11, S('e', 'n'), S('d', ' '), S('o', 'f'), S(' ', 'f'), S('i', 'l'), S('e', 0)};
static const uint32_t __string_389_character_literal[] = {17, S('c', 'h'), S('a', 'r'), S('a', 'c'), S('t', 'e'), S('r', ' '), S('l', 'i'), S('t', 'e'), S('r', 'a'), S('l', 0)};
static const uint32_t __string_390_identifier[] = {10, S('i', 'd'), S('e', 'n'), S('t', 'i'), S('f', 'i'), S('e', 'r')};
static const uint32_t __string_391_integer_literal[] = {15, S('i', 'n'), S('t', 'e'), S('g', 'e'), S('r', ' '), S('l', 'i'), S('t', 'e'), S('r', 'a'), S('l', 0)};
static const uint32_t __string_392_string_literal[] = {14, S('s', 't'), S('r', 'i'), S('n', 'g'), S(' ', 'l'), S('i', 't'), S('e', 'r'), S('a', 'l')};
...
static const uint32_t __string_402[] = {4, S('\'', '='), S('=', '\'')};
static const uint32_t __string_403[] = {4, S('\'', '*'), S('*', '\'')};
static const uint32_t __string_404[] = {3, S('\'', '>'), S('\'', 0)};
static const uint32_t __string_405[] = {4, S('\'', '>'), S('=', '\'')};
static const uint32_t __string_406[] = {3, S('\'', '{'), S('\'', 0)};
...
static const uint32_t __string_410[] = {4, S('\'', '<'), S('=', '\'')};
static const uint32_t __string_411[] = {4, S('\'', '&'), S('&', '\'')};
static const uint32_t __string_412[] = {4, S('\'', '|'), S('|', '\'')};
static const uint32_t __string_413[] = {3, S('\'', '-'), S('\'', 0)};
static const uint32_t __string_414[] = {4, S('\'', '-'), S('-', '\'')};
static const uint32_t __string_415[] = {3, S('\'', '*'), S('\'', 0)};
static const uint32_t __string_416[] = {3, S('\'', '!'), S('\'', 0)};
static const uint32_t __string_417[] = {4, S('\'', '!'), S('=', '\'')};
static const uint32_t __string_418[] = {3, S('\'', '+'), S('\'', 0)};
static const uint32_t __string_419[] = {4, S('\'', '+'), S('+', '\'')};
static const uint32_t __string_420[] = {3, S('\'', '?'), S('\'', 0)};
static const uint32_t __string_421[] = {3, S('\'', '%'), S('\'', 0)};
static const uint32_t __string_422[] = {3, S('\'', '}'), S('\'', 0)};
static const uint32_t __string_423[] = {3, S('\'', ']'), S('\'', 0)};
static const uint32_t __string_424[] = {3, S('\'', ')'), S('\'', 0)};
static const uint32_t __string_425[] = {3, S('\'', ';'), S('\'', 0)};
static const uint32_t __string_426[] = {4, S('\'', '<'), S('<', '\'')};
static const uint32_t __string_427[] = {4, S('\'', '>'), S('>', '\'')};
static const uint32_t __string_428_alignof[] = {9, S('\'', 'a'), S('l', 'i'), S('g', 'n'), S('o', 'f'), S('\'', 0)};
static const uint32_t __string_429_as[] = {4, S('\'', 'a'), S('s', '\'')};
static const uint32_t __string_430_break[] = {7, S('\'', 'b'), S('r', 'e'), S('a', 'k'), S('\'', 0)};
static const uint32_t __string_431_class[] = {7, S('\'', 'c'), S('l', 'a'), S('s', 's'), S('\'', 0)};
static const uint32_t __string_432_const[] = {7, S('\'', 'c'), S('o', 'n'), S('s', 't'), S('\'', 0)};
static const uint32_t __string_433_continue[] = {10, S('\'', 'c'), S('o', 'n'), S('t', 'i'), S('n', 'u'), S('e', '\'')};
static const uint32_t __string_434_declare[] = {9, S('\'', 'd'), S('e', 'c'), S('l', 'a'), S('r', 'e'), S('\'', 0)};
static const uint32_t __string_435_else[] = {6, S('\'', 'e'), S('l', 's'), S('e', '\'')};
static const uint32_t __string_436_enum[] = {6, S('\'', 'e'), S('n', 'u'), S('m', '\'')};
static const uint32_t __string_437_export[] = {8, S('\'', 'e'), S('x', 'p'), S('o', 'r'), S('t', '\'')};
static const uint32_t __string_438_extends[] = {9, S('\'', 'e'), S('x', 't'), S('e', 'n'), S('d', 's'), S('\'', 0)};
static const uint32_t __string_439_extern[] = {8, S('\'', 'e'), S('x', 't'), S('e', 'r'), S('n', '\'')};
static const uint32_t __string_440_false[] = {7, S('\'', 'f'), S('a', 'l'), S('s', 'e'), S('\'', 0)};
static const uint32_t __string_441_function[] = {10, S('\'', 'f'), S('u', 'n'), S('c', 't'), S('i', 'o'), S('n', '\'')};
static const uint32_t __string_442_if[] = {4, S('\'', 'i'), S('f', '\'')};
static const uint32_t __string_443_implements[] = {12, S('\'', 'i'), S('m', 'p'), S('l', 'e'), S('m', 'e'), S('n', 't'), S('s', '\'')};
static const uint32_t __string_444_import[] = {8, S('\'', 'i'), S('m', 'p'), S('o', 'r'), S('t', '\'')};
static const uint32_t __string_445_interface[] = {11, S('\'', 'i'), S('n', 't'), S('e', 'r'), S('f', 'a'), S('c', 'e'), S('\'', 0)};
static const uint32_t __string_446_let[] = {5, S('\'', 'l'), S('e', 't'), S('\'', 0)};
static const uint32_t __string_447_new[] = {5, S('\'', 'n'), S('e', 'w'), S('\'', 0)};
static const uint32_t __string_448_null[] = {6, S('\'', 'n'), S('u', 'l'), S('l', '\'')};
static const uint32_t __string_449_operator[] = {10, S('\'', 'o'), S('p', 'e'), S('r', 'a'), S('t', 'o'), S('r', '\'')};
static const uint32_t __string_450_private[] = {9, S('\'', 'p'), S('r', 'i'), S('v', 'a'), S('t', 'e'), S('\'', 0)};
static const uint32_t __string_451_protected[] = {11, S('\'', 'p'), S('r', 'o'), S('t', 'e'), S('c', 't'), S('e', 'd'), S('\'', 0)};
static const uint32_t __string_452_public[] = {8, S('\'', 'p'), S('u', 'b'), S('l', 'i'), S('c', '\'')};
static const uint32_t __string_453_return[] = {8, S('\'', 'r'), S('e', 't'), S('u', 'r'), S('n', '\'')};
static const uint32_t __string_454_sizeof[] = {8, S('\'', 's'), S('i', 'z'), S('e', 'o'), S('f', '\'')};
static const uint32_t __string_455_static[] = {8, S('\'', 's'), S('t', 'a'), S('t', 'i'), S('c', '\'')};
static const uint32_t __string_456_this[] = {6, S('\'', 't'), S('h', 'i'), S('s', '\'')};
static const uint32_t __string_457_true[] = {6, S('\'', 't'), S('r', 'u'), S('e', '\'')};
static const uint32_t __string_458_unsafe[] = {8, S('\'', 'u'), S('n', 's'), S('a', 'f'), S('e', '\'')};
static const uint32_t __string_459_var[] = {5, S('\'', 'v'), S('a', 'r'), S('\'', 0)};
static const uint32_t __string_460_while[] = {7, S('\'', 'w'), S('h', 'i'), S('l', 'e'), S('\'', 0)};
static const uint32_t __string_461_define[] = {9, S('\'', '#'), S('d', 'e'), S('f', 'i'), S('n', 'e'), S('\'', 0)};
static const uint32_t __string_462_elif[] = {7, S('\'', '#'), S('e', 'l'), S('i', 'f'), S('\'', 0)};
static const uint32_t __string_463_else[] = {7, S('\'', '#'), S('e', 'l'), S('s', 'e'), S('\'', 0)};
static const uint32_t __string_464_endif[] = {8, S('\'', '#'), S('e', 'n'), S('d', 'i'), S('f', '\'')};
static const uint32_t __string_465_error[] = {8, S('\'', '#'), S('e', 'r'), S('r', 'o'), S('r', '\'')};
static const uint32_t __string_466_if[] = {5, S('\'', '#'), S('i', 'f'), S('\'', 0)};
static const uint32_t __string_467_newline[] = {7, S('n', 'e'), S('w', 'l'), S('i', 'n'), S('e', 0)};
static const uint32_t __string_468_undef[] = {8, S('\'', '#'), S('u', 'n'), S('d', 'e'), S('f', '\'')};
static const uint32_t __string_469_warning[] = {10, S('\'', '#'), S('w', 'a'), S('r', 'n'), S('i', 'n'), S('g', '\'')};
static const uint32_t __string_470_as[] = {2, S('a', 's')};
static const uint32_t __string_471_if[] = {2, S('i', 'f')};
static const uint32_t __string_472_let[] = {3, S('l', 'e'), S('t', 0)};
static const uint32_t __string_473_new[] = {3, S('n', 'e'), S('w', 0)};
static const uint32_t __string_474_var[] = {3, S('v', 'a'), S('r', 0)};
static const uint32_t __string_475_else[] = {4, S('e', 'l'), S('s', 'e')};
static const uint32_t __string_476_enum[] = {4, S('e', 'n'), S('u', 'm')};
static const uint32_t __string_477_null[] = {4, S('n', 'u'), S('l', 'l')};
static const uint32_t __string_478_this[] = {4, S('t', 'h'), S('i', 's')};
static const uint32_t __string_479_true[] = {4, S('t', 'r'), S('u', 'e')};
static const uint32_t __string_480_break[] = {5, S('b', 'r'), S('e', 'a'), S('k', 0)};
static const uint32_t __string_481_class[] = {5, S('c', 'l'), S('a', 's'), S('s', 0)};
static const uint32_t __string_482_const[] = {5, S('c', 'o'), S('n', 's'), S('t', 0)};
static const uint32_t __string_483_false[] = {5, S('f', 'a'), S('l', 's'), S('e', 0)};
static const uint32_t __string_484_while[] = {5, S('w', 'h'), S('i', 'l'), S('e', 0)};
static const uint32_t __string_485_export[] = {6, S('e', 'x'), S('p', 'o'), S('r', 't')};
static const uint32_t __string_486_extern[] = {6, S('e', 'x'), S('t', 'e'), S('r', 'n')};
static const uint32_t __string_487_import[] = {6, S('i', 'm'), S('p', 'o'), S('r', 't')};
static const uint32_t __string_488_public[] = {6, S('p', 'u'), S('b', 'l'), S('i', 'c')};
static const uint32_t __string_489_return[] = {6, S('r', 'e'), S('t', 'u'), S('r', 'n')};
static const uint32_t __string_490_sizeof[] = {6, S('s', 'i'), S('z', 'e'), S('o', 'f')};
static const uint32_t __string_491_static[] = {6, S('s', 't'), S('a', 't'), S('i', 'c')};
static const uint32_t __string_492_unsafe[] = {6, S('u', 'n'), S('s', 'a'), S('f', 'e')};
static const uint32_t __string_493_alignof[] = {7, S('a', 'l'), S('i', 'g'), S('n', 'o'), S('f', 0)};
static const uint32_t __string_494_declare[] = {7, S('d', 'e'), S('c', 'l'), S('a', 'r'), S('e', 0)};
static const uint32_t __string_495_extends[] = {7, S('e', 'x'), S('t', 'e'), S('n', 'd'), S('s', 0)};
static const uint32_t __string_496_private[] = {7, S('p', 'r'), S('i', 'v'), S('a', 't'), S('e', 0)};
static const uint32_t __string_497_continue[] = {8, S('c', 'o'), S('n', 't'), S('i', 'n'), S('u', 'e')};
static const uint32_t __string_498_function[] = {8, S('f', 'u'), S('n', 'c'), S('t', 'i'), S('o', 'n')};
static const uint32_t __string_499_implements[] = {10, S('i', 'm'), S('p', 'l'), S('e', 'm'), S('e', 'n'), S('t', 's')};
static const uint32_t __string_500_interface[] = {9, S('i', 'n'), S('t', 'e'), S('r', 'f'), S('a', 'c'), S('e', 0)};
static const uint32_t __string_501_protected[] = {9, S('p', 'r'), S('o', 't'), S('e', 'c'), S('t', 'e'), S('d', 0)};
static const uint32_t __string_502_Invalid_integer_literal[] = {26, S('I', 'n'), S('v', 'a'), S('l', 'i'), S('d', ' '), S('i', 'n'), S('t', 'e'), S('g', 'e'), S('r', ' '), S('l', 'i'), S('t', 'e'), S('r', 'a'), S('l', ':'), S(' ', '\'')};
static const uint32_t __string_503_Unterminated_character_literal[] = {30, S('U', 'n'), S('t', 'e'), S('r', 'm'), S('i', 'n'), S('a', 't'), S('e', 'd'), S(' ', 'c'), S('h', 'a'), S('r', 'a'), S('c', 't'), S('e', 'r'), S(' ', 'l'), S('i', 't'), S('e', 'r'), S('a', 'l')};
static const uint32_t __string_504_Unterminated_template_literal[] = {29, S('U', 'n'), S('t', 'e'), S('r', 'm'), S('i', 'n'), S('a', 't'), S('e', 'd'), S(' ', 't'), S('e', 'm'), S('p', 'l'), S('a', 't'), S('e', ' '), S('l', 'i'), S('t', 'e'), S('r', 'a'), S('l', 0)};
static const uint32_t __string_505_Unterminated_string_literal[] = {27, S('U', 'n'), S('t', 'e'), S('r', 'm'), S('i', 'n'), S('a', 't'), S('e', 'd'), S(' ', 's'), S('t', 'r'), S('i', 'n'), S('g', ' '), S('l', 'i'), S('t', 'e'), S('r', 'a'), S('l', 0)};
static const uint32_t __string_506_Unterminated_multi_line_comment[] = {31, S('U', 'n'), S('t', 'e'), S('r', 'm'), S('i', 'n'), S('a', 't'), S('e', 'd'), S(' ', 'm'), S('u', 'l'), S('t', 'i'), S('-', 'l'), S('i', 'n'), S('e', ' '), S('c', 'o'), S('m', 'm'), S('e', 'n'), S('t', 0)};
static const uint32_t __string_507_Use_instead_of[] = {25, S('U', 's'), S('e', ' '), S('\'', '!'), S('=', '\''), S(' ', 'i'), S('n', 's'), S('t', 'e'), S('a', 'd'), S(' ', 'o'), S('f', ' '), S('\'', '!'), S('=', '='), S('\'', 0)};
static const uint32_t __string_508_Use_instead_of[] = {25, S('U', 's'), S('e', ' '), S('\'', '='), S('=', '\''), S(' ', 'i'), S('n', 's'), S('t', 'e'), S('a', 'd'), S(' ', 'o'), S('f', ' '), S('\'', '='), S('=', '='), S('\'', 0)};
static const uint32_t __string_509_define[] = {7, S('#', 'd'), S('e', 'f'), S('i', 'n'), S('e', 0)};
static const uint32_t __string_510_elif[] = {5, S('#', 'e'), S('l', 'i'), S('f', 0)};
static const uint32_t __string_511_else[] = {5, S('#', 'e'), S('l', 's'), S('e', 0)};
static const uint32_t __string_512_endif[] = {6, S('#', 'e'), S('n', 'd'), S('i', 'f')};
static const uint32_t __string_513_error[] = {6, S('#', 'e'), S('r', 'r'), S('o', 'r')};
static const uint32_t __string_514_if[] = {3, S('#', 'i'), S('f', 0)};
static const uint32_t __string_515_undef[] = {6, S('#', 'u'), S('n', 'd'), S('e', 'f')};
static const uint32_t __string_516_warning[] = {8, S('#', 'w'), S('a', 'r'), S('n', 'i'), S('n', 'g')};
static const uint32_t __string_517[] = {1, S('#', 0)};
static const uint32_t __string_518_Invalid_preprocessor_token[] = {28, S('I', 'n'), S('v', 'a'), S('l', 'i'), S('d', ' '), S('p', 'r'), S('e', 'p'), S('r', 'o'), S('c', 'e'), S('s', 's'), S('o', 'r'), S(' ', 't'), S('o', 'k'), S('e', 'n'), S(' ', '\'')};
static const uint32_t __string_519_ifdef[] = {6, S('#', 'i'), S('f', 'd'), S('e', 'f')};
static const uint32_t __string_520_did_you_mean_if[] = {21, S(',', ' '), S('d', 'i'), S('d', ' '), S('y', 'o'), S('u', ' '), S('m', 'e'), S('a', 'n'), S(' ', '\''), S('#', 'i'), S('f', '\''), S('?', 0)};
static const uint32_t __string_521_elsif[] = {6, S('#', 'e'), S('l', 's'), S('i', 'f')};
static const uint32_t __string_522_elseif[] = {7, S('#', 'e'), S('l', 's'), S('e', 'i'), S('f', 0)};
static const uint32_t __string_523_did_you_mean_elif[] = {23, S(',', ' '), S('d', 'i'), S('d', ' '), S('y', 'o'), S('u', ' '), S('m', 'e'), S('a', 'n'), S(' ', '\''), S('#', 'e'), S('l', 'i'), S('f', '\''), S('?', 0)};
static const uint32_t __string_524_end[] = {4, S('#', 'e'), S('n', 'd')};
static const uint32_t __string_525_did_you_mean_endif[] = {24, S(',', ' '), S('d', 'i'), S('d', ' '), S('y', 'o'), S('u', ' '), S('m', 'e'), S('a', 'n'), S(' ', '\''), S('#', 'e'), S('n', 'd'), S('i', 'f'), S('\'', '?')};
static const uint32_t __string_526_Expected_newline_before[] = {24, S('E', 'x'), S('p', 'e'), S('c', 't'), S('e', 'd'), S(' ', 'n'), S('e', 'w'), S('l', 'i'), S('n', 'e'), S(' ', 'b'), S('e', 'f'), S('o', 'r'), S('e', ' ')};
static const uint32_t __string_527_Syntax_error[] = {15, S('S', 'y'), S('n', 't'), S('a', 'x'), S(' ', 'e'), S('r', 'r'), S('o', 'r'), S(':', ' '), S('\'', 0)};
static const uint32_t __string_528_if_WASM_These_will_be_fi[] = {12490, S('\n', '#'), S('i', 'f'), S(' ', 'W'), S('A', 'S'), S('M', '\n'), S('\n', ' '), S(' ', '/'), S('/', ' '), S('T', 'h'), S('e', 's'), S('e', ' '), S('w', 'i'), S('l', 'l'), S(' ', 'b'), S('e', ' '), S('f', 'i'), S('l', 'l'), S('e', 'd'), S(' ', 'i'), S('n', ' '), S('b', 'y'), S(' ', 't'), S('h', 'e'), S(' ', 'W'), S('e', 'b'), S('A', 's'), S('s', 'e'), S('m', 'b'), S('l', 'y'), S(' ', 'c'), S('o', 'd'), S('e', ' '), S('g', 'e'), S('n', 'e'), S('r', 'a'), S('t', 'o'), S('r', '\n'), S(' ', ' '), S('u', 'n'), S('s', 'a'), S('f', 'e'), S(' ', 'v'), S('a', 'r'), S(' ', 'c'), S('u', 'r'), S('r', 'e'), S('n', 't'), S('H', 'e'), S('a', 'p'), S('P', 'o'), S('i', 'n'), S('t', 'e'), S('r', ':'), S(' ', '*'), S('b', 'y'), S('t', 'e'), S(' ', '='), S(' ', 'n'), S('u', 'l'), S('l', ';'), S('\n', ' '), S(' ', 'u'), S('n', 's'), S('a', 'f'), S('e', ' '), S('v', 'a'), S('r', ' '), S('o', 'r'), S('i', 'g'), S('i', 'n'), S('a', 'l'), S('H', 'e'), S('a', 'p'), S('P', 'o'), S('i', 'n'), S('t', 'e'), S('r', ':'), S(' ', '*'), S('b', 'y'), S('t', 'e'), S(' ', '='), S(' ', 'n'), S('u', 'l'), S('l', ';'), S('\n', '\n'), S(' ', ' '), S('e', 'x'), S('t', 'e'), S('r', 'n'), S(' ', 'u'), S('n', 's'), S('a', 'f'), S('e', ' '), S('f', 'u'), S('n', 'c'), S('t', 'i'), S('o', 'n'), S(' ', 'm'), S('a', 'l'), S('l', 'o'), S('c', '('), S('s', 'i'), S('z', 'e'), S('O', 'f'), S(':', ' '), S('u', 'i'), S('n', 't'), S(')', ':'), S(' ', '*'), S('b', 'y'), S('t', 'e'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', '/'), S('/', ' '), S('A', 'l'), S('i', 'g'), S('n', ' '), S('a', 'l'), S('l', ' '), S('a', 'l'), S('l', 'o'), S('c', 'a'), S('t', 'i'), S('o', 'n'), S('s', ' '), S('t', 'o'), S(' ', '8'), S(' ', 'b'), S('y', 't'), S('e', 's'), S('\n', ' '), S(' ', ' '), S(' ', 'v'), S('a', 'r'), S(' ', 'o'), S('f', 'f'), S('s', 'e'), S('t', ' '), S('=', ' '), S('(', '('), S('c', 'u'), S('r', 'r'), S('e', 'n'), S('t', 'H'), S('e', 'a'), S('p', 'P'), S('o', 'i'), S('n', 't'), S('e', 'r'), S(' ', 'a'), S('s', ' '), S('u', 'i'), S('n', 't'), S(' ', '+'), S(' ', '7'), S(')', ' '), S('&', ' '), S('~', '7'), S(' ', 'a'), S('s', ' '), S('u', 'i'), S('n', 't'), S(')', ' '), S('a', 's'), S(' ', '*'), S('b', 'y'), S('t', 'e'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S('s', 'i'), S('z', 'e'), S('O', 'f'), S(' ', '='), S(' ', '('), S('s', 'i'), S('z', 'e'), S('O', 'f'), S(' ', '+'), S(' ', '7'), S(')', ' '), S('&', ' '), S('~', '7'), S(' ', 'a'), S('s', ' '), S('u', 'i'), S('n', 't'), S(';', '\n'), S('\n', ' '), S(' ', ' '), S(' ', '/'), S('/', ' '), S('U', 's'), S('e', ' '), S('a', ' '), S('s', 'i'), S('m', 'p'), S('l', 'e'), S(' ', 'b'), S('u', 'm'), S('p', ' '), S('a', 'l'), S('l', 'o'), S('c', 'a'), S('t', 'o'), S('r', ' '), S('f', 'o'), S('r', ' '), S('n', 'o'), S('w', '\n'), S(' ', ' '), S(' ', ' '), S('v', 'a'), S('r', ' '), S('l', 'i'), S('m', 'i'), S('t', ' '), S('=', ' '), S('o', 'f'), S('f', 's'), S('e', 't'), S(' ', '+'), S(' ', 's'), S('i', 'z'), S('e', 'O'), S('f', ';'), S('\n', ' '), S(' ', ' '), S(' ', 'c'), S('u', 'r'), S('r', 'e'), S('n', 't'), S('H', 'e'), S('a', 'p'), S('P', 'o'), S('i', 'n'), S('t', 'e'), S('r', ' '), S('=', ' '), S('l', 'i'), S('m', 'i'), S('t', ';'), S('\n', '\n'), S(' ', ' '), S(' ', ' '), S('/', '/'), S(' ', 'M'), S('a', 'k'), S('e', ' '), S('s', 'u'), S('r', 'e'), S(' ', 't'), S('h', 'e'), S(' ', 'm'), S('e', 'm'), S('o', 'r'), S('y', ' '), S('s', 't'), S('a', 'r'), S('t', 's'), S(' ', 'o'), S('f', 'f'), S(' ', 'a'), S('t', ' '), S('z', 'e'), S('r', 'o'), S('\n', ' '), S(' ', ' '), S(' ', 'v'), S('a', 'r'), S(' ', 'p'), S('t', 'r'), S(' ', '='), S(' ', 'o'), S('f', 'f'), S('s', 'e'), S('t', ';'), S('\n', ' '), S(' ', ' '), S(' ', 'w'), S('h', 'i'), S('l', 'e'), S(' ', '('), S('p', 't'), S('r', ' '), S('<', ' '), S('l', 'i'), S('m', 'i'), S('t', ')'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', '*'), S('(', 'p'), S('t', 'r'), S(' ', 'a'), S('s', ' '), S('*', 'i'), S('n', 't'), S(')', ' '), S('=', ' '), S('0', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'p'), S('t', 'r'), S(' ', '='), S(' ', 'p'), S('t', 'r'), S(' ', '+'), S(' ', '4'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S('}', '\n'), S('\n', ' '), S(' ', ' '), S(' ', 'r'), S('e', 't'), S('u', 'r'), S('n', ' '), S('o', 'f'), S('f', 's'), S('e', 't'), S(';', '\n'), S(' ', ' '), S('}', '\n'), S('\n', ' '), S(' ', 'u'), S('n', 's'), S('a', 'f'), S('e', ' '), S('f', 'u'), S('n', 'c'), S('t', 'i'), S('o', 'n'), S(' ', 'm'), S('e', 'm'), S('c', 'p'), S('y', '('), S('t', 'a'), S('r', 'g'), S('e', 't'), S(':', ' '), S('*', 'b'), S('y', 't'), S('e', ','), S(' ', 's'), S('o', 'u'), S('r', 'c'), S('e', ':'), S(' ', '*'), S('b', 'y'), S('t', 'e'), S(',', ' '), S('l', 'e'), S('n', 'g'), S('t', 'h'), S(':', ' '), S('u', 'i'), S('n', 't'), S(')', ':'), S(' ', 'v'), S('o', 'i'), S('d', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S('/', '/'), S(' ', 'N'), S('o', '-'), S('o', 'p'), S(' ', 'i'), S('f', ' '), S('e', 'i'), S('t', 'h'), S('e', 'r'), S(' ', 'o'), S('f', ' '), S('t', 'h'), S('e', ' '), S('i', 'n'), S('p', 'u'), S('t', 's'), S(' ', 'a'), S('r', 'e'), S(' ', 'n'), S('u', 'l'), S('l', '\n'), S(' ', ' '), S(' ', ' '), S('i', 'f'), S(' ', '('), S('s', 'o'), S('u', 'r'), S('c', 'e'), S(' ', '='), S('=', ' '), S('n', 'u'), S('l', 'l'), S(' ', '|'), S('|', ' '), S('t', 'a'), S('r', 'g'), S('e', 't'), S(' ', '='), S('=', ' '), S('n', 'u'), S('l', 'l'), S(')', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('r', 'e'), S('t', 'u'), S('r', 'n'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S('}', '\n'), S('\n', ' '), S(' ', ' '), S(' ', '/'), S('/', ' '), S('O', 'p'), S('t', 'i'), S('m', 'i'), S('z', 'e'), S('d', ' '), S('a', 'l'), S('i', 'g'), S('n', 'e'), S('d', ' '), S('c', 'o'), S('p', 'y'), S('\n', ' '), S(' ', ' '), S(' ', 'i'), S('f', ' '), S('(', 'l'), S('e', 'n'), S('g', 't'), S('h', ' '), S('>', '='), S(' ', '1'), S('6', ' '), S('&', '&'), S(' ', '('), S('s', 'o'), S('u', 'r'), S('c', 'e'), S(' ', 'a'), S('s', ' '), S('u', 'i'), S('n', 't'), S(')', ' '), S('%', ' '), S('4', ' '), S('=', '='), S(' ', '('), S('t', 'a'), S('r', 'g'), S('e', 't'), S(' ', 'a'), S('s', ' '), S('u', 'i'), S('n', 't'), S(')', ' '), S('%', ' '), S('4', ')'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', '/'), S('/', ' '), S('P', 'i'), S('c', 'k'), S(' ', 'o'), S('f', 'f'), S(' ', 't'), S('h', 'e'), S(' ', 'b'), S('e', 'g'), S('i', 'n'), S('n', 'i'), S('n', 'g'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'w'), S('h', 'i'), S('l', 'e'), S(' ', '('), S('(', 't'), S('a', 'r'), S('g', 'e'), S('t', ' '), S('a', 's'), S(' ', 'u'), S('i', 'n'), S('t', ')'), S(' ', '%'), S(' ', '4'), S(' ', '!'), S('=', ' '), S('0', ')'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', '*'), S('t', 'a'), S('r', 'g'), S('e', 't'), S(' ', '='), S(' ', '*'), S('s', 'o'), S('u', 'r'), S('c', 'e'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('t', 'a'), S('r', 'g'), S('e', 't'), S(' ', '='), S(' ', 't'), S('a', 'r'), S('g', 'e'), S('t', ' '), S('+', ' '), S('1', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 's'), S('o', 'u'), S('r', 'c'), S('e', ' '), S('=', ' '), S('s', 'o'), S('u', 'r'), S('c', 'e'), S(' ', '+'), S(' ', '1'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('l', 'e'), S('n', 'g'), S('t', 'h'), S(' ', '='), S(' ', 'l'), S('e', 'n'), S('g', 't'), S('h', ' '), S('-', ' '), S('1', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', '}'), S('\n', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('/', '/'), S(' ', 'P'), S('i', 'c'), S('k', ' '), S('o', 'f'), S('f', ' '), S('t', 'h'), S('e', ' '), S('e', 'n'), S('d', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('w', 'h'), S('i', 'l'), S('e', ' '), S('(', 'l'), S('e', 'n'), S('g', 't'), S('h', ' '), S('%', ' '), S('4', ' '), S('!', '='), S(' ', '0'), S(')', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('l', 'e'), S('n', 'g'), S('t', 'h'), S(' ', '='), S(' ', 'l'), S('e', 'n'), S('g', 't'), S('h', ' '), S('-', ' '), S('1', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', '*'), S('(', 't'), S('a', 'r'), S('g', 'e'), S('t', ' '), S('+', ' '), S('l', 'e'), S('n', 'g'), S('t', 'h'), S(')', ' '), S('=', ' '), S('*', '('), S('s', 'o'), S('u', 'r'), S('c', 'e'), S(' ', '+'), S(' ', 'l'), S('e', 'n'), S('g', 't'), S('h', ')'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('}', '\n'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', '/'), S('/', ' '), S('Z', 'i'), S('p', ' '), S('o', 'v'), S('e', 'r'), S(' ', 't'), S('h', 'e'), S(' ', 'm'), S('i', 'd'), S('d', 'l'), S('e', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('v', 'a'), S('r', ' '), S('e', 'n'), S('d', ' '), S('=', ' '), S('t', 'a'), S('r', 'g'), S('e', 't'), S(' ', '+'), S(' ', 'l'), S('e', 'n'), S('g', 't'), S('h', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'w'), S('h', 'i'), S('l', 'e'), S(' ', '('), S('t', 'a'), S('r', 'g'), S('e', 't'), S(' ', '<'), S(' ', 'e'), S('n', 'd'), S(')', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('*', '('), S('t', 'a'), S('r', 'g'), S('e', 't'), S(' ', 'a'), S('s', ' '), S('*', 'i'), S('n', 't'), S(')', ' '), S('=', ' '), S('*', '('), S('s', 'o'), S('u', 'r'), S('c', 'e'), S(' ', 'a'), S('s', ' '), S('*', 'i'), S('n', 't'), S(')', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 't'), S('a', 'r'), S('g', 'e'), S('t', ' '), S('=', ' '), S('t', 'a'), S('r', 'g'), S('e', 't'), S(' ', '+'), S(' ', '4'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('s', 'o'), S('u', 'r'), S('c', 'e'), S(' ', '='), S(' ', 's'), S('o', 'u'), S('r', 'c'), S('e', ' '), S('+', ' '), S('4', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', '}'), S('\n', ' '), S(' ', ' '), S(' ', '}'), S('\n', '\n'), S(' ', ' '), S(' ', ' '), S('/', '/'), S(' ', 'S'), S('l', 'o'), S('w', ' '), S('u', 'n'), S('a', 'l'), S('i', 'g'), S('n', 'e'), S('d', ' '), S('c', 'o'), S('p', 'y'), S('\n', ' '), S(' ', ' '), S(' ', 'e'), S('l', 's'), S('e', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('v', 'a'), S('r', ' '), S('e', 'n'), S('d', ' '), S('=', ' '), S('t', 'a'), S('r', 'g'), S('e', 't'), S(' ', '+'), S(' ', 'l'), S('e', 'n'), S('g', 't'), S('h', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'w'), S('h', 'i'), S('l', 'e'), S(' ', '('), S('t', 'a'), S('r', 'g'), S('e', 't'), S(' ', '<'), S(' ', 'e'), S('n', 'd'), S(')', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('*', 't'), S('a', 'r'), S('g', 'e'), S('t', ' '), S('=', ' '), S('*', 's'), S('o', 'u'), S('r', 'c'), S('e', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 't'), S('a', 'r'), S('g', 'e'), S('t', ' '), S('=', ' '), S('t', 'a'), S('r', 'g'), S('e', 't'), S(' ', '+'), S(' ', '1'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('s', 'o'), S('u', 'r'), S('c', 'e'), S(' ', '='), S(' ', 's'), S('o', 'u'), S('r', 'c'), S('e', ' '), S('+', ' '), S('1', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', '}'), S('\n', ' '), S(' ', ' '), S(' ', '}'), S('\n', ' '), S(' ', '}'), S('\n', '\n'), S(' ', ' '), S('u', 'n'), S('s', 'a'), S('f', 'e'), S(' ', 'f'), S('u', 'n'), S('c', 't'), S('i', 'o'), S('n', ' '), S('m', 'e'), S('m', 'c'), S('m', 'p'), S('(', 'a'), S(':', ' '), S('*', 'b'), S('y', 't'), S('e', ','), S(' ', 'b'), S(':', ' '), S('*', 'b'), S('y', 't'), S('e', ','), S(' ', 'l'), S('e', 'n'), S('g', 't'), S('h', ':'), S(' ', 'u'), S('i', 'n'), S('t', ')'), S(':', ' '), S('i', 'n'), S('t', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S('/', '/'), S(' ', 'N'), S('o', '-'), S('o', 'p'), S(' ', 'i'), S('f', ' '), S('e', 'i'), S('t', 'h'), S('e', 'r'), S(' ', 'o'), S('f', ' '), S('t', 'h'), S('e', ' '), S('i', 'n'), S('p', 'u'), S('t', 's'), S(' ', 'a'), S('r', 'e'), S(' ', 'n'), S('u', 'l'), S('l', '\n'), S(' ', ' '), S(' ', ' '), S('i', 'f'), S(' ', '('), S('a', ' '), S('=', '='), S(' ', 'n'), S('u', 'l'), S('l', ' '), S('|', '|'), S(' ', 'b'), S(' ', '='), S('=', ' '), S('n', 'u'), S('l', 'l'), S(')', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('r', 'e'), S('t', 'u'), S('r', 'n'), S(' ', '0'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S('}', '\n'), S('\n', ' '), S(' ', ' '), S(' ', '/'), S('/', ' '), S('R', 'e'), S('t', 'u'), S('r', 'n'), S(' ', 't'), S('h', 'e'), S(' ', 'f'), S('i', 'r'), S('s', 't'), S(' ', 'n'), S('o', 'n'), S('-', 'z'), S('e', 'r'), S('o', ' '), S('d', 'i'), S('f', 'f'), S('e', 'r'), S('e', 'n'), S('c', 'e'), S('\n', ' '), S(' ', ' '), S(' ', 'w'), S('h', 'i'), S('l', 'e'), S(' ', '('), S('l', 'e'), S('n', 'g'), S('t', 'h'), S(' ', '>'), S(' ', '0'), S(')', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('v', 'a'), S('r', ' '), S('d', 'e'), S('l', 't'), S('a', ' '), S('=', ' '), S('*', 'a'), S(' ', 'a'), S('s', ' '), S('i', 'n'), S('t', ' '), S('-', ' '), S('*', 'b'), S(' ', 'a'), S('s', ' '), S('i', 'n'), S('t', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'i'), S('f', ' '), S('(', 'd'), S('e', 'l'), S('t', 'a'), S(' ', '!'), S('=', ' '), S('0', ')'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'r'), S('e', 't'), S('u', 'r'), S('n', ' '), S('d', 'e'), S('l', 't'), S('a', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', '}'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'a'), S(' ', '='), S(' ', 'a'), S(' ', '+'), S(' ', '1'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('b', ' '), S('=', ' '), S('b', ' '), S('+', ' '), S('1', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'l'), S('e', 'n'), S('g', 't'), S('h', ' '), S('=', ' '), S('l', 'e'), S('n', 'g'), S('t', 'h'), S(' ', '-'), S(' ', '1'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S('}', '\n'), S('\n', ' '), S(' ', ' '), S(' ', '/'), S('/', ' '), S('B', 'o'), S('t', 'h'), S(' ', 'i'), S('n', 'p'), S('u', 't'), S('s', ' '), S('a', 'r'), S('e', ' '), S('i', 'd'), S('e', 'n'), S('t', 'i'), S('c', 'a'), S('l', '\n'), S(' ', ' '), S(' ', ' '), S('r', 'e'), S('t', 'u'), S('r', 'n'), S(' ', '0'), S(';', '\n'), S(' ', ' '), S('}', '\n'), S('\n', '#'), S('e', 'l'), S('i', 'f'), S(' ', 'C'), S('\n', '\n'), S(' ', ' '), S('d', 'e'), S('c', 'l'), S('a', 'r'), S('e', ' '), S('u', 'n'), S('s', 'a'), S('f', 'e'), S(' ', 'f'), S('u', 'n'), S('c', 't'), S('i', 'o'), S('n', ' '), S('m', 'a'), S('l', 'l'), S('o', 'c'), S('(', 's'), S('i', 'z'), S('e', 'O'), S('f', ':'), S(' ', 'u'), S('i', 'n'), S('t', ')'), S(':', ' '), S('*', 'b'), S('y', 't'), S('e', ';'), S('\n', ' '), S(' ', 'd'), S('e', 'c'), S('l', 'a'), S('r', 'e'), S(' ', 'u'), S('n', 's'), S('a', 'f'), S('e', ' '), S('f', 'u'), S('n', 'c'), S('t', 'i'), S('o', 'n'), S(' ', 'm'), S('e', 'm'), S('c', 'p'), S('y', '('), S('t', 'a'), S('r', 'g'), S('e', 't'), S(':', ' '), S('*', 'b'), S('y', 't'), S('e', ','), S(' ', 's'), S('o', 'u'), S('r', 'c'), S('e', ':'), S(' ', '*'), S('b', 'y'), S('t', 'e'), S(',', ' '), S('l', 'e'), S('n', 'g'), S('t', 'h'), S(':', ' '), S('u', 'i'), S('n', 't'), S(')', ':'), S(' ', 'v'), S('o', 'i'), S('d', ';'), S('\n', ' '), S(' ', 'd'), S('e', 'c'), S('l', 'a'), S('r', 'e'), S(' ', 'u'), S('n', 's'), S('a', 'f'), S('e', ' '), S('f', 'u'), S('n', 'c'), S('t', 'i'), S('o', 'n'), S(' ', 'm'), S('e', 'm'), S('c', 'm'), S('p', '('), S('a', ':'), S(' ', '*'), S('b', 'y'), S('t', 'e'), S(',', ' '), S('b', ':'), S(' ', '*'), S('b', 'y'), S('t', 'e'), S(',', ' '), S('l', 'e'), S('n', 'g'), S('t', 'h'), S(':', ' '), S('u', 'i'), S('n', 't'), S(')', ':'), S(' ', 'i'), S('n', 't'), S(';', '\n'), S('\n', '#'), S('e', 'n'), S('d', 'i'), S('f', '\n'), S('\n', '#'), S('i', 'f'), S(' ', 'W'), S('A', 'S'), S('M', ' '), S('|', '|'), S(' ', 'C'), S('\n', '\n'), S(' ', ' '), S('d', 'e'), S('c', 'l'), S('a', 'r'), S('e', ' '), S('c', 'l'), S('a', 's'), S('s', ' '), S('b', 'o'), S('o', 'l'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', 't'), S('o', 'S'), S('t', 'r'), S('i', 'n'), S('g', '('), S(')', ':'), S(' ', 's'), S('t', 'r'), S('i', 'n'), S('g', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('r', 'e'), S('t', 'u'), S('r', 'n'), S(' ', 't'), S('h', 'i'), S('s', ' '), S('?', ' '), S('"', 't'), S('r', 'u'), S('e', '"'), S(' ', ':'), S(' ', '"'), S('f', 'a'), S('l', 's'), S('e', '"'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S('}', '\n'), S(' ', ' '), S('}', '\n'), S('\n', ' '), S(' ', 'd'), S('e', 'c'), S('l', 'a'), S('r', 'e'), S(' ', 'c'), S('l', 'a'), S('s', 's'), S(' ', 's'), S('b', 'y'), S('t', 'e'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', 't'), S('o', 'S'), S('t', 'r'), S('i', 'n'), S('g', '('), S(')', ':'), S(' ', 's'), S('t', 'r'), S('i', 'n'), S('g', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('r', 'e'), S('t', 'u'), S('r', 'n'), S(' ', '('), S('t', 'h'), S('i', 's'), S(' ', 'a'), S('s', ' '), S('i', 'n'), S('t', ')'), S('.', 't'), S('o', 'S'), S('t', 'r'), S('i', 'n'), S('g', '('), S(')', ';'), S('\n', ' '), S(' ', ' '), S(' ', '}'), S('\n', ' '), S(' ', '}'), S('\n', '\n'), S(' ', ' '), S('d', 'e'), S('c', 'l'), S('a', 'r'), S('e', ' '), S('c', 'l'), S('a', 's'), S('s', ' '), S('b', 'y'), S('t', 'e'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', 't'), S('o', 'S'), S('t', 'r'), S('i', 'n'), S('g', '('), S(')', ':'), S(' ', 's'), S('t', 'r'), S('i', 'n'), S('g', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('r', 'e'), S('t', 'u'), S('r', 'n'), S(' ', '('), S('t', 'h'), S('i', 's'), S(' ', 'a'), S('s', ' '), S('u', 'i'), S('n', 't'), S(')', '.'), S('t', 'o'), S('S', 't'), S('r', 'i'), S('n', 'g'), S('(', ')'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S('}', '\n'), S(' ', ' '), S('}', '\n'), S('\n', ' '), S(' ', 'd'), S('e', 'c'), S('l', 'a'), S('r', 'e'), S(' ', 'c'), S('l', 'a'), S('s', 's'), S(' ', 's'), S('h', 'o'), S('r', 't'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', 't'), S('o', 'S'), S('t', 'r'), S('i', 'n'), S('g', '('), S(')', ':'), S(' ', 's'), S('t', 'r'), S('i', 'n'), S('g', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('r', 'e'), S('t', 'u'), S('r', 'n'), S(' ', '('), S('t', 'h'), S('i', 's'), S(' ', 'a'), S('s', ' '), S('i', 'n'), S('t', ')'), S('.', 't'), S('o', 'S'), S('t', 'r'), S('i', 'n'), S('g', '('), S(')', ';'), S('\n', ' '), S(' ', ' '), S(' ', '}'), S('\n', ' '), S(' ', '}'), S('\n', '\n'), S(' ', ' '), S('d', 'e'), S('c', 'l'), S('a', 'r'), S('e', ' '), S('c', 'l'), S('a', 's'), S('s', ' '), S('u', 's'), S('h', 'o'), S('r', 't'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', 't'), S('o', 'S'), S('t', 'r'), S('i', 'n'), S('g', '('), S(')', ':'), S(' ', 's'), S('t', 'r'), S('i', 'n'), S('g', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('r', 'e'), S('t', 'u'), S('r', 'n'), S(' ', '('), S('t', 'h'), S('i', 's'), S(' ', 'a'), S('s', ' '), S('u', 'i'), S('n', 't'), S(')', '.'), S('t', 'o'), S('S', 't'), S('r', 'i'), S('n', 'g'), S('(', ')'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S('}', '\n'), S(' ', ' '), S('}', '\n'), S('\n', ' '), S(' ', 'd'), S('e', 'c'), S('l', 'a'), S('r', 'e'), S(' ', 'c'), S('l', 'a'), S('s', 's'), S(' ', 'i'), S('n', 't'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', 't'), S('o', 'S'), S('t', 'r'), S('i', 'n'), S('g', '('), S(')', ':'), S(' ', 's'), S('t', 'r'), S('i', 'n'), S('g', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('/', '/'), S(' ', 'S'), S('p', 'e'), S('c', 'i'), S('a', 'l'), S('-', 'c'), S('a', 's'), S('e', ' '), S('t', 'h'), S('i', 's'), S(' ', 't'), S('o', ' '), S('k', 'e'), S('e', 'p'), S(' ', 't'), S('h', 'e'), S(' ', 'r'), S('e', 's'), S('t', ' '), S('o', 'f'), S(' ', 't'), S('h', 'e'), S(' ', 'c'), S('o', 'd'), S('e', ' '), S('s', 'i'), S('m', 'p'), S('l', 'e'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'i'), S('f', ' '), S('(', 't'), S('h', 'i'), S('s', ' '), S('=', '='), S(' ', '-'), S('2', '1'), S('4', '7'), S('4', '8'), S('3', '6'), S('4', '8'), S(')', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('r', 'e'), S('t', 'u'), S('r', 'n'), S(' ', '"'), S('-', '2'), S('1', '4'), S('7', '4'), S('8', '3'), S('6', '4'), S('8', '"'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('}', '\n'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', '/'), S('/', ' '), S('T', 'r'), S('e', 'a'), S('t', ' '), S('t', 'h'), S('i', 's'), S(' ', 'l'), S('i', 'k'), S('e', ' '), S('a', 'n'), S(' ', 'u'), S('n', 's'), S('i', 'g'), S('n', 'e'), S('d', ' '), S('i', 'n'), S('t', 'e'), S('g', 'e'), S('r', ' '), S('p', 'r'), S('e', 'f'), S('i', 'x'), S('e', 'd'), S(' ', 'b'), S('y', ' '), S('\'', '-'), S('\'', ' '), S('i', 'f'), S(' ', 'i'), S('t', '\''), S('s', ' '), S('n', 'e'), S('g', 'a'), S('t', 'i'), S('v', 'e'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'r'), S('e', 't'), S('u', 'r'), S('n', ' '), S('i', 'n'), S('t', 'e'), S('r', 'n'), S('a', 'l'), S('I', 'n'), S('t', 'T'), S('o', 'S'), S('t', 'r'), S('i', 'n'), S('g', '('), S('(', 't'), S('h', 'i'), S('s', ' '), S('<', ' '), S('0', ' '), S('?', ' '), S('-', 't'), S('h', 'i'), S('s', ' '), S(':', ' '), S('t', 'h'), S('i', 's'), S(')', ' '), S('a', 's'), S(' ', 'u'), S('i', 'n'), S('t', ','), S(' ', 't'), S('h', 'i'), S('s', ' '), S('<', ' '), S('0', ')'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S('}', '\n'), S(' ', ' '), S('}', '\n'), S('\n', ' '), S(' ', 'd'), S('e', 'c'), S('l', 'a'), S('r', 'e'), S(' ', 'c'), S('l', 'a'), S('s', 's'), S(' ', 'u'), S('i', 'n'), S('t', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S('t', 'o'), S('S', 't'), S('r', 'i'), S('n', 'g'), S('(', ')'), S(':', ' '), S('s', 't'), S('r', 'i'), S('n', 'g'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'r'), S('e', 't'), S('u', 'r'), S('n', ' '), S('i', 'n'), S('t', 'e'), S('r', 'n'), S('a', 'l'), S('I', 'n'), S('t', 'T'), S('o', 'S'), S('t', 'r'), S('i', 'n'), S('g', '('), S('t', 'h'), S('i', 's'), S(',', ' '), S('f', 'a'), S('l', 's'), S('e', ')'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S('}', '\n'), S(' ', ' '), S('}', '\n'), S('\n', ' '), S(' ', 'f'), S('u', 'n'), S('c', 't'), S('i', 'o'), S('n', ' '), S('i', 'n'), S('t', 'e'), S('r', 'n'), S('a', 'l'), S('I', 'n'), S('t', 'T'), S('o', 'S'), S('t', 'r'), S('i', 'n'), S('g', '('), S('v', 'a'), S('l', 'u'), S('e', ':'), S(' ', 'u'), S('i', 'n'), S('t', ','), S(' ', 's'), S('i', 'g'), S('n', ':'), S(' ', 'b'), S('o', 'o'), S('l', ')'), S(':', ' '), S('s', 't'), S('r', 'i'), S('n', 'g'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', '/'), S('/', ' '), S('A', 'v'), S('o', 'i'), S('d', ' '), S('a', 'l'), S('l', 'o'), S('c', 'a'), S('t', 'i'), S('o', 'n'), S(' ', 'f'), S('o', 'r'), S(' ', 'c'), S('o', 'm'), S('m', 'o'), S('n', ' '), S('c', 'a'), S('s', 'e'), S('s', '\n'), S(' ', ' '), S(' ', ' '), S('i', 'f'), S(' ', '('), S('v', 'a'), S('l', 'u'), S('e', ' '), S('=', '='), S(' ', '0'), S(')', ' '), S('r', 'e'), S('t', 'u'), S('r', 'n'), S(' ', '"'), S('0', '"'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S('i', 'f'), S(' ', '('), S('v', 'a'), S('l', 'u'), S('e', ' '), S('=', '='), S(' ', '1'), S(')', ' '), S('r', 'e'), S('t', 'u'), S('r', 'n'), S(' ', 's'), S('i', 'g'), S('n', ' '), S('?', ' '), S('"', '-'), S('1', '"'), S(' ', ':'), S(' ', '"'), S('1', '"'), S(';', '\n'), S('\n', ' '), S(' ', ' '), S(' ', 'u'), S('n', 's'), S('a', 'f'), S('e', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('/', '/'), S(' ', 'D'), S('e', 't'), S('e', 'r'), S('m', 'i'), S('n', 'e'), S(' ', 'h'), S('o', 'w'), S(' ', 'm'), S('a', 'n'), S('y', ' '), S('d', 'i'), S('g', 'i'), S('t', 's'), S(' ', 'w'), S('e', ' '), S('n', 'e'), S('e', 'd'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'v'), S('a', 'r'), S(' ', 'l'), S('e', 'n'), S('g', 't'), S('h', ' '), S('=', ' '), S('(', '('), S('s', 'i'), S('g', 'n'), S(' ', '?'), S(' ', '1'), S(' ', ':'), S(' ', '0'), S(')', ' '), S('+', ' '), S('(', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('v', 'a'), S('l', 'u'), S('e', ' '), S('>', '='), S(' ', '1'), S('0', '0'), S('0', '0'), S('0', '0'), S('0', '0'), S(' ', '?'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'v'), S('a', 'l'), S('u', 'e'), S(' ', '>'), S('=', ' '), S('1', '0'), S('0', '0'), S('0', '0'), S('0', '0'), S('0', '0'), S(' ', '?'), S(' ', '1'), S('0', ' '), S(':', ' '), S('9', ' '), S(':', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('v', 'a'), S('l', 'u'), S('e', ' '), S('>', '='), S(' ', '1'), S('0', '0'), S('0', '0'), S(' ', '?'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'v'), S('a', 'l'), S('u', 'e'), S(' ', '>'), S('=', ' '), S('1', '0'), S('0', '0'), S('0', '0'), S('0', ' '), S('?', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('v', 'a'), S('l', 'u'), S('e', ' '), S('>', '='), S(' ', '1'), S('0', '0'), S('0', '0'), S('0', '0'), S('0', ' '), S('?', ' '), S('8', ' '), S(':', ' '), S('7', ' '), S(':', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('v', 'a'), S('l', 'u'), S('e', ' '), S('>', '='), S(' ', '1'), S('0', '0'), S('0', '0'), S('0', ' '), S('?', ' '), S('6', ' '), S(':', ' '), S('5', ' '), S(':', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('v', 'a'), S('l', 'u'), S('e', ' '), S('>', '='), S(' ', '1'), S('0', '0'), S(' ', '?'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'v'), S('a', 'l'), S('u', 'e'), S(' ', '>'), S('=', ' '), S('1', '0'), S('0', '0'), S(' ', '?'), S(' ', '4'), S(' ', ':'), S(' ', '3'), S(' ', ':'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'v'), S('a', 'l'), S('u', 'e'), S(' ', '>'), S('=', ' '), S('1', '0'), S(' ', '?'), S(' ', '2'), S(' ', ':'), S(' ', '1'), S(')', ')'), S(' ', 'a'), S('s', ' '), S('u', 'i'), S('n', 't'), S(';', '\n'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'v'), S('a', 'r'), S(' ', 'p'), S('t', 'r'), S(' ', '='), S(' ', 's'), S('t', 'r'), S('i', 'n'), S('g', '_'), S('n', 'e'), S('w', '('), S('l', 'e'), S('n', 'g'), S('t', 'h'), S(')', ' '), S('a', 's'), S(' ', '*'), S('b', 'y'), S('t', 'e'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('v', 'a'), S('r', ' '), S('e', 'n'), S('d', ' '), S('=', ' '), S('p', 't'), S('r', ' '), S('+', ' '), S('4', ' '), S('+', ' '), S('l', 'e'), S('n', 'g'), S('t', 'h'), S(' ', '*'), S(' ', '2'), S(';', '\n'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'i'), S('f', ' '), S('(', 's'), S('i', 'g'), S('n', ')'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', '*'), S('(', '('), S('p', 't'), S('r', ' '), S('+', ' '), S('4', ')'), S(' ', 'a'), S('s', ' '), S('*', 'u'), S('s', 'h'), S('o', 'r'), S('t', ')'), S(' ', '='), S(' ', '\''), S('-', '\''), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('}', '\n'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'w'), S('h', 'i'), S('l', 'e'), S(' ', '('), S('v', 'a'), S('l', 'u'), S('e', ' '), S('!', '='), S(' ', '0'), S(')', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('e', 'n'), S('d', ' '), S('=', ' '), S('e', 'n'), S('d', ' '), S('+', ' '), S('-', '2'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('*', '('), S('e', 'n'), S('d', ' '), S('a', 's'), S(' ', '*'), S('u', 's'), S('h', 'o'), S('r', 't'), S(')', ' '), S('=', ' '), S('(', 'v'), S('a', 'l'), S('u', 'e'), S(' ', '%'), S(' ', '1'), S('0', ' '), S('+', ' '), S('\'', '0'), S('\'', ')'), S(' ', 'a'), S('s', ' '), S('u', 's'), S('h', 'o'), S('r', 't'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('v', 'a'), S('l', 'u'), S('e', ' '), S('=', ' '), S('v', 'a'), S('l', 'u'), S('e', ' '), S('/', ' '), S('1', '0'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('}', '\n'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'r'), S('e', 't'), S('u', 'r'), S('n', ' '), S('p', 't'), S('r', ' '), S('a', 's'), S(' ', 's'), S('t', 'r'), S('i', 'n'), S('g', ';'), S('\n', ' '), S(' ', ' '), S(' ', '}'), S('\n', ' '), S(' ', '}'), S('\n', '\n'), S(' ', ' '), S('f', 'u'), S('n', 'c'), S('t', 'i'), S('o', 'n'), S(' ', 's'), S('t', 'r'), S('i', 'n'), S('g', '_'), S('n', 'e'), S('w', '('), S('l', 'e'), S('n', 'g'), S('t', 'h'), S(':', ' '), S('u', 'i'), S('n', 't'), S(')', ':'), S(' ', 's'), S('t', 'r'), S('i', 'n'), S('g', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S('u', 'n'), S('s', 'a'), S('f', 'e'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'v'), S('a', 'r'), S(' ', 'p'), S('t', 'r'), S(' ', '='), S(' ', 'm'), S('a', 'l'), S('l', 'o'), S('c', '('), S('4', ' '), S('+', ' '), S('l', 'e'), S('n', 'g'), S('t', 'h'), S(' ', '*'), S(' ', '2'), S(')', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', '*'), S('(', 'p'), S('t', 'r'), S(' ', 'a'), S('s', ' '), S('*', 'u'), S('i', 'n'), S('t', ')'), S(' ', '='), S(' ', 'l'), S('e', 'n'), S('g', 't'), S('h', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'r'), S('e', 't'), S('u', 'r'), S('n', ' '), S('p', 't'), S('r', ' '), S('a', 's'), S(' ', 's'), S('t', 'r'), S('i', 'n'), S('g', ';'), S('\n', ' '), S(' ', ' '), S(' ', '}'), S('\n', ' '), S(' ', '}'), S('\n', '\n'), S(' ', ' '), S('d', 'e'), S('c', 'l'), S('a', 'r'), S('e', ' '), S('c', 'l'), S('a', 's'), S('s', ' '), S('s', 't'), S('r', 'i'), S('n', 'g'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', 'c'), S('h', 'a'), S('r', 'A'), S('t', '('), S('i', 'n'), S('d', 'e'), S('x', ':'), S(' ', 'i'), S('n', 't'), S(')', ':'), S(' ', 's'), S('t', 'r'), S('i', 'n'), S('g', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('r', 'e'), S('t', 'u'), S('r', 'n'), S(' ', 't'), S('h', 'i'), S('s', '.'), S('s', 'l'), S('i', 'c'), S('e', '('), S('i', 'n'), S('d', 'e'), S('x', ','), S(' ', 'i'), S('n', 'd'), S('e', 'x'), S(' ', '+'), S(' ', '1'), S(')', ';'), S('\n', ' '), S(' ', ' '), S(' ', '}'), S('\n', '\n'), S(' ', ' '), S(' ', ' '), S('c', 'h'), S('a', 'r'), S('C', 'o'), S('d', 'e'), S('A', 't'), S('(', 'i'), S('n', 'd'), S('e', 'x'), S(':', ' '), S('i', 'n'), S('t', ')'), S(':', ' '), S('u', 's'), S('h', 'o'), S('r', 't'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'r'), S('e', 't'), S('u', 'r'), S('n', ' '), S('t', 'h'), S('i', 's'), S('[', 'i'), S('n', 'd'), S('e', 'x'), S(']', ';'), S('\n', ' '), S(' ', ' '), S(' ', '}'), S('\n', '\n'), S(' ', ' '), S(' ', ' '), S('g', 'e'), S('t', ' '), S('l', 'e'), S('n', 'g'), S('t', 'h'), S('(', ')'), S(':', ' '), S('i', 'n'), S('t', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('u', 'n'), S('s', 'a'), S('f', 'e'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'r'), S('e', 't'), S('u', 'r'), S('n', ' '), S('*', '('), S('t', 'h'), S('i', 's'), S(' ', 'a'), S('s', ' '), S('*', 'i'), S('n', 't'), S(')', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', '}'), S('\n', ' '), S(' ', ' '), S(' ', '}'), S('\n', '\n'), S(' ', ' '), S(' ', ' '), S('o', 'p'), S('e', 'r'), S('a', 't'), S('o', 'r'), S(' ', '['), S(']', ' '), S('(', 'i'), S('n', 'd'), S('e', 'x'), S(':', ' '), S('i', 'n'), S('t', ')'), S(':', ' '), S('u', 's'), S('h', 'o'), S('r', 't'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'i'), S('f', ' '), S('(', 'i'), S('n', 'd'), S('e', 'x'), S(' ', 'a'), S('s', ' '), S('u', 'i'), S('n', 't'), S(' ', '<'), S(' ', 't'), S('h', 'i'), S('s', '.'), S('l', 'e'), S('n', 'g'), S('t', 'h'), S(' ', 'a'), S('s', ' '), S('u', 'i'), S('n', 't'), S(')', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('u', 'n'), S('s', 'a'), S('f', 'e'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'r'), S('e', 't'), S('u', 'r'), S('n', ' '), S('*', '('), S('(', 't'), S('h', 'i'), S('s', ' '), S('a', 's'), S(' ', '*'), S('b', 'y'), S('t', 'e'), S(' ', '+'), S(' ', '4'), S(' ', '+'), S(' ', 'i'), S('n', 'd'), S('e', 'x'), S(' ', '*'), S(' ', '2'), S(')', ' '), S('a', 's'), S(' ', '*'), S('u', 's'), S('h', 'o'), S('r', 't'), S(')', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', '}'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', '}'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'r'), S('e', 't'), S('u', 'r'), S('n', ' '), S('0', ';'), S('\n', ' '), S(' ', ' '), S(' ', '}'), S('\n', '\n'), S(' ', ' '), S(' ', ' '), S('o', 'p'), S('e', 'r'), S('a', 't'), S('o', 'r'), S(' ', '='), S('=', ' '), S('(', 'o'), S('t', 'h'), S('e', 'r'), S(':', ' '), S('s', 't'), S('r', 'i'), S('n', 'g'), S(')', ':'), S(' ', 'b'), S('o', 'o'), S('l', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('u', 'n'), S('s', 'a'), S('f', 'e'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'i'), S('f', ' '), S('(', 't'), S('h', 'i'), S('s', ' '), S('a', 's'), S(' ', '*'), S('b', 'y'), S('t', 'e'), S(' ', '='), S('=', ' '), S('o', 't'), S('h', 'e'), S('r', ' '), S('a', 's'), S(' ', '*'), S('b', 'y'), S('t', 'e'), S(')', ' '), S('r', 'e'), S('t', 'u'), S('r', 'n'), S(' ', 't'), S('r', 'u'), S('e', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'i'), S('f', ' '), S('(', 't'), S('h', 'i'), S('s', ' '), S('a', 's'), S(' ', '*'), S('b', 'y'), S('t', 'e'), S(' ', '='), S('=', ' '), S('n', 'u'), S('l', 'l'), S(' ', '|'), S('|', ' '), S('o', 't'), S('h', 'e'), S('r', ' '), S('a', 's'), S(' ', '*'), S('b', 'y'), S('t', 'e'), S(' ', '='), S('=', ' '), S('n', 'u'), S('l', 'l'), S(')', ' '), S('r', 'e'), S('t', 'u'), S('r', 'n'), S(' ', 'f'), S('a', 'l'), S('s', 'e'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('v', 'a'), S('r', ' '), S('l', 'e'), S('n', 'g'), S('t', 'h'), S(' ', '='), S(' ', 't'), S('h', 'i'), S('s', '.'), S('l', 'e'), S('n', 'g'), S('t', 'h'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('i', 'f'), S(' ', '('), S('l', 'e'), S('n', 'g'), S('t', 'h'), S(' ', '!'), S('=', ' '), S('o', 't'), S('h', 'e'), S('r', '.'), S('l', 'e'), S('n', 'g'), S('t', 'h'), S(')', ' '), S('r', 'e'), S('t', 'u'), S('r', 'n'), S(' ', 'f'), S('a', 'l'), S('s', 'e'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('r', 'e'), S('t', 'u'), S('r', 'n'), S(' ', 'm'), S('e', 'm'), S('c', 'm'), S('p', '('), S('t', 'h'), S('i', 's'), S(' ', 'a'), S('s', ' '), S('*', 'b'), S('y', 't'), S('e', ' '), S('+', ' '), S('4', ','), S(' ', 'o'), S('t', 'h'), S('e', 'r'), S(' ', 'a'), S('s', ' '), S('*', 'b'), S('y', 't'), S('e', ' '), S('+', ' '), S('4', ','), S(' ', 'l'), S('e', 'n'), S('g', 't'), S('h', ' '), S('a', 's'), S(' ', 'u'), S('i', 'n'), S('t', ' '), S('*', ' '), S('2', ')'), S(' ', '='), S('=', ' '), S('0', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', '}'), S('\n', ' '), S(' ', ' '), S(' ', '}'), S('\n', '\n'), S(' ', ' '), S(' ', ' '), S('s', 'l'), S('i', 'c'), S('e', '('), S('s', 't'), S('a', 'r'), S('t', ':'), S(' ', 'i'), S('n', 't'), S(',', ' '), S('e', 'n'), S('d', ':'), S(' ', 'i'), S('n', 't'), S(')', ':'), S(' ', 's'), S('t', 'r'), S('i', 'n'), S('g', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('v', 'a'), S('r', ' '), S('l', 'e'), S('n', 'g'), S('t', 'h'), S(' ', '='), S(' ', 't'), S('h', 'i'), S('s', '.'), S('l', 'e'), S('n', 'g'), S('t', 'h'), S(';', '\n'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'i'), S('f', ' '), S('(', 's'), S('t', 'a'), S('r', 't'), S(' ', '<'), S(' ', '0'), S(')', ' '), S('s', 't'), S('a', 'r'), S('t', ' '), S('=', ' '), S('s', 't'), S('a', 'r'), S('t', ' '), S('+', ' '), S('l', 'e'), S('n', 'g'), S('t', 'h'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('i', 'f'), S(' ', '('), S('e', 'n'), S('d', ' '), S('<', ' '), S('0', ')'), S(' ', 'e'), S('n', 'd'), S(' ', '='), S(' ', 'e'), S('n', 'd'), S(' ', '+'), S(' ', 'l'), S('e', 'n'), S('g', 't'), S('h', ';'), S('\n', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('i', 'f'), S(' ', '('), S('s', 't'), S('a', 'r'), S('t', ' '), S('<', ' '), S('0', ')'), S(' ', 's'), S('t', 'a'), S('r', 't'), S(' ', '='), S(' ', '0'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('e', 'l'), S('s', 'e'), S(' ', 'i'), S('f', ' '), S('(', 's'), S('t', 'a'), S('r', 't'), S(' ', '>'), S(' ', 'l'), S('e', 'n'), S('g', 't'), S('h', ')'), S(' ', 's'), S('t', 'a'), S('r', 't'), S(' ', '='), S(' ', 'l'), S('e', 'n'), S('g', 't'), S('h', ';'), S('\n', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('i', 'f'), S(' ', '('), S('e', 'n'), S('d', ' '), S('<', ' '), S('s', 't'), S('a', 'r'), S('t', ')'), S(' ', 'e'), S('n', 'd'), S(' ', '='), S(' ', 's'), S('t', 'a'), S('r', 't'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('e', 'l'), S('s', 'e'), S(' ', 'i'), S('f', ' '), S('(', 'e'), S('n', 'd'), S(' ', '>'), S(' ', 'l'), S('e', 'n'), S('g', 't'), S('h', ')'), S(' ', 'e'), S('n', 'd'), S(' ', '='), S(' ', 'l'), S('e', 'n'), S('g', 't'), S('h', ';'), S('\n', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('u', 'n'), S('s', 'a'), S('f', 'e'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'v'), S('a', 'r'), S(' ', 'r'), S('a', 'n'), S('g', 'e'), S(' ', '='), S(' ', '('), S('e', 'n'), S('d', ' '), S('-', ' '), S('s', 't'), S('a', 'r'), S('t', ')'), S(' ', 'a'), S('s', ' '), S('u', 'i'), S('n', 't'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('v', 'a'), S('r', ' '), S('p', 't'), S('r', ' '), S('=', ' '), S('s', 't'), S('r', 'i'), S('n', 'g'), S('_', 'n'), S('e', 'w'), S('(', 'r'), S('a', 'n'), S('g', 'e'), S(')', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'm'), S('e', 'm'), S('c', 'p'), S('y', '('), S('p', 't'), S('r', ' '), S('a', 's'), S(' ', '*'), S('b', 'y'), S('t', 'e'), S(' ', '+'), S(' ', '4'), S(',', ' '), S('t', 'h'), S('i', 's'), S(' ', 'a'), S('s', ' '), S('*', 'b'), S('y', 't'), S('e', ' '), S('+', ' '), S('4', ' '), S('+', ' '), S('s', 't'), S('a', 'r'), S('t', ' '), S('*', ' '), S('2', ','), S(' ', 'r'), S('a', 'n'), S('g', 'e'), S(' ', '*'), S(' ', '2'), S(')', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'r'), S('e', 't'), S('u', 'r'), S('n', ' '), S('p', 't'), S('r', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', '}'), S('\n', ' '), S(' ', ' '), S(' ', '}'), S('\n', '\n'), S(' ', ' '), S(' ', ' '), S('s', 't'), S('a', 'r'), S('t', 's'), S('W', 'i'), S('t', 'h'), S('(', 't'), S('e', 'x'), S('t', ':'), S(' ', 's'), S('t', 'r'), S('i', 'n'), S('g', ')'), S(':', ' '), S('b', 'o'), S('o', 'l'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'v'), S('a', 'r'), S(' ', 't'), S('e', 'x'), S('t', 'L'), S('e', 'n'), S('g', 't'), S('h', ' '), S('=', ' '), S('t', 'e'), S('x', 't'), S('.', 'l'), S('e', 'n'), S('g', 't'), S('h', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'i'), S('f', ' '), S('(', 't'), S('h', 'i'), S('s', '.'), S('l', 'e'), S('n', 'g'), S('t', 'h'), S(' ', '<'), S(' ', 't'), S('e', 'x'), S('t', 'L'), S('e', 'n'), S('g', 't'), S('h', ')'), S(' ', 'r'), S('e', 't'), S('u', 'r'), S('n', ' '), S('f', 'a'), S('l', 's'), S('e', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'u'), S('n', 's'), S('a', 'f'), S('e', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('r', 'e'), S('t', 'u'), S('r', 'n'), S(' ', 'm'), S('e', 'm'), S('c', 'm'), S('p', '('), S('t', 'h'), S('i', 's'), S(' ', 'a'), S('s', ' '), S('*', 'b'), S('y', 't'), S('e', ' '), S('+', ' '), S('4', ','), S(' ', 't'), S('e', 'x'), S('t', ' '), S('a', 's'), S(' ', '*'), S('b', 'y'), S('t', 'e'), S(' ', '+'), S(' ', '4'), S(',', ' '), S('t', 'e'), S('x', 't'), S('L', 'e'), S('n', 'g'), S('t', 'h'), S(' ', 'a'), S('s', ' '), S('u', 'i'), S('n', 't'), S(' ', '*'), S(' ', '2'), S(')', ' '), S('=', '='), S(' ', '0'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('}', '\n'), S(' ', ' '), S(' ', ' '), S('}', '\n'), S('\n', ' '), S(' ', ' '), S(' ', 'e'), S('n', 'd'), S('s', 'W'), S('i', 't'), S('h', '('), S('t', 'e'), S('x', 't'), S(':', ' '), S('s', 't'), S('r', 'i'), S('n', 'g'), S(')', ':'), S(' ', 'b'), S('o', 'o'), S('l', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('v', 'a'), S('r', ' '), S('t', 'h'), S('i', 's'), S('L', 'e'), S('n', 'g'), S('t', 'h'), S(' ', '='), S(' ', 't'), S('h', 'i'), S('s', '.'), S('l', 'e'), S('n', 'g'), S('t', 'h'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('v', 'a'), S('r', ' '), S('t', 'e'), S('x', 't'), S('L', 'e'), S('n', 'g'), S('t', 'h'), S(' ', '='), S(' ', 't'), S('e', 'x'), S('t', '.'), S('l', 'e'), S('n', 'g'), S('t', 'h'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('i', 'f'), S(' ', '('), S('t', 'h'), S('i', 's'), S('L', 'e'), S('n', 'g'), S('t', 'h'), S(' ', '<'), S(' ', 't'), S('e', 'x'), S('t', 'L'), S('e', 'n'), S('g', 't'), S('h', ')'), S(' ', 'r'), S('e', 't'), S('u', 'r'), S('n', ' '), S('f', 'a'), S('l', 's'), S('e', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'u'), S('n', 's'), S('a', 'f'), S('e', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('r', 'e'), S('t', 'u'), S('r', 'n'), S(' ', 'm'), S('e', 'm'), S('c', 'm'), S('p', '('), S('t', 'h'), S('i', 's'), S(' ', 'a'), S('s', ' '), S('*', 'b'), S('y', 't'), S('e', ' '), S('+', ' '), S('4', ' '), S('+', ' '), S('(', 't'), S('h', 'i'), S('s', 'L'), S('e', 'n'), S('g', 't'), S('h', ' '), S('-', ' '), S('t', 'e'), S('x', 't'), S('L', 'e'), S('n', 'g'), S('t', 'h'), S(')', ' '), S('*', ' '), S('2', ','), S(' ', 't'), S('e', 'x'), S('t', ' '), S('a', 's'), S(' ', '*'), S('b', 'y'), S('t', 'e'), S(' ', '+'), S(' ', '4'), S(',', ' '), S('t', 'e'), S('x', 't'), S('L', 'e'), S('n', 'g'), S('t', 'h'), S(' ', 'a'), S('s', ' '), S('u', 'i'), S('n', 't'), S(' ', '*'), S(' ', '2'), S(')', ' '), S('=', '='), S(' ', '0'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('}', '\n'), S(' ', ' '), S(' ', ' '), S('}', '\n'), S('\n', ' '), S(' ', ' '), S(' ', 'i'), S('n', 'd'), S('e', 'x'), S('O', 'f'), S('(', 't'), S('e', 'x'), S('t', ':'), S(' ', 's'), S('t', 'r'), S('i', 'n'), S('g', ')'), S(':', ' '), S('i', 'n'), S('t', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('v', 'a'), S('r', ' '), S('t', 'h'), S('i', 's'), S('L', 'e'), S('n', 'g'), S('t', 'h'), S(' ', '='), S(' ', 't'), S('h', 'i'), S('s', '.'), S('l', 'e'), S('n', 'g'), S('t', 'h'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('v', 'a'), S('r', ' '), S('t', 'e'), S('x', 't'), S('L', 'e'), S('n', 'g'), S('t', 'h'), S(' ', '='), S(' ', 't'), S('e', 'x'), S('t', '.'), S('l', 'e'), S('n', 'g'), S('t', 'h'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('i', 'f'), S(' ', '('), S('t', 'h'), S('i', 's'), S('L', 'e'), S('n', 'g'), S('t', 'h'), S(' ', '>'), S('=', ' '), S('t', 'e'), S('x', 't'), S('L', 'e'), S('n', 'g'), S('t', 'h'), S(')', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('v', 'a'), S('r', ' '), S('i', ' '), S('=', ' '), S('0', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'w'), S('h', 'i'), S('l', 'e'), S(' ', '('), S('i', ' '), S('<', ' '), S('t', 'h'), S('i', 's'), S('L', 'e'), S('n', 'g'), S('t', 'h'), S(' ', '-'), S(' ', 't'), S('e', 'x'), S('t', 'L'), S('e', 'n'), S('g', 't'), S('h', ')'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'u'), S('n', 's'), S('a', 'f'), S('e', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('i', 'f'), S(' ', '('), S('m', 'e'), S('m', 'c'), S('m', 'p'), S('(', 't'), S('h', 'i'), S('s', ' '), S('a', 's'), S(' ', '*'), S('b', 'y'), S('t', 'e'), S(' ', '+'), S(' ', '4'), S(' ', '+'), S(' ', 'i'), S(' ', '*'), S(' ', '2'), S(',', ' '), S('t', 'e'), S('x', 't'), S(' ', 'a'), S('s', ' '), S('*', 'b'), S('y', 't'), S('e', ' '), S('+', ' '), S('4', ','), S(' ', 't'), S('e', 'x'), S('t', 'L'), S('e', 'n'), S('g', 't'), S('h', ' '), S('a', 's'), S(' ', 'u'), S('i', 'n'), S('t', ' '), S('*', ' '), S('2', ')'), S(' ', '='), S('=', ' '), S('0', ')'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'r'), S('e', 't'), S('u', 'r'), S('n', ' '), S('i', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', '}'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', '}'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'i'), S(' ', '='), S(' ', 'i'), S(' ', '+'), S(' ', '1'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('}', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('}', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('r', 'e'), S('t', 'u'), S('r', 'n'), S(' ', '-'), S('1', ';'), S('\n', ' '), S(' ', ' '), S(' ', '}'), S('\n', '\n'), S(' ', ' '), S(' ', ' '), S('l', 'a'), S('s', 't'), S('I', 'n'), S('d', 'e'), S('x', 'O'), S('f', '('), S('t', 'e'), S('x', 't'), S(':', ' '), S('s', 't'), S('r', 'i'), S('n', 'g'), S(')', ':'), S(' ', 'i'), S('n', 't'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'v'), S('a', 'r'), S(' ', 't'), S('h', 'i'), S('s', 'L'), S('e', 'n'), S('g', 't'), S('h', ' '), S('=', ' '), S('t', 'h'), S('i', 's'), S('.', 'l'), S('e', 'n'), S('g', 't'), S('h', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'v'), S('a', 'r'), S(' ', 't'), S('e', 'x'), S('t', 'L'), S('e', 'n'), S('g', 't'), S('h', ' '), S('=', ' '), S('t', 'e'), S('x', 't'), S('.', 'l'), S('e', 'n'), S('g', 't'), S('h', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'i'), S('f', ' '), S('(', 't'), S('h', 'i'), S('s', 'L'), S('e', 'n'), S('g', 't'), S('h', ' '), S('>', '='), S(' ', 't'), S('e', 'x'), S('t', 'L'), S('e', 'n'), S('g', 't'), S('h', ')'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'v'), S('a', 'r'), S(' ', 'i'), S(' ', '='), S(' ', 't'), S('h', 'i'), S('s', 'L'), S('e', 'n'), S('g', 't'), S('h', ' '), S('-', ' '), S('t', 'e'), S('x', 't'), S('L', 'e'), S('n', 'g'), S('t', 'h'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('w', 'h'), S('i', 'l'), S('e', ' '), S('(', 'i'), S(' ', '>'), S('=', ' '), S('0', ')'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'u'), S('n', 's'), S('a', 'f'), S('e', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('i', 'f'), S(' ', '('), S('m', 'e'), S('m', 'c'), S('m', 'p'), S('(', 't'), S('h', 'i'), S('s', ' '), S('a', 's'), S(' ', '*'), S('b', 'y'), S('t', 'e'), S(' ', '+'), S(' ', '4'), S(' ', '+'), S(' ', 'i'), S(' ', '*'), S(' ', '2'), S(',', ' '), S('t', 'e'), S('x', 't'), S(' ', 'a'), S('s', ' '), S('*', 'b'), S('y', 't'), S('e', ' '), S('+', ' '), S('4', ','), S(' ', 't'), S('e', 'x'), S('t', 'L'), S('e', 'n'), S('g', 't'), S('h', ' '), S('a', 's'), S(' ', 'u'), S('i', 'n'), S('t', ' '), S('*', ' '), S('2', ')'), S(' ', '='), S('=', ' '), S('0', ')'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'r'), S('e', 't'), S('u', 'r'), S('n', ' '), S('i', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', '}'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', '}'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'i'), S(' ', '='), S(' ', 'i'), S(' ', '-'), S(' ', '1'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('}', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('}', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('r', 'e'), S('t', 'u'), S('r', 'n'), S(' ', '-'), S('1', ';'), S('\n', ' '), S(' ', ' '), S(' ', '}'), S('\n', ' '), S(' ', '}'), S('\n', '\n'), S('#', 'e'), S('l', 's'), S('e', '\n'), S('\n', ' '), S(' ', 'd'), S('e', 'c'), S('l', 'a'), S('r', 'e'), S(' ', 'c'), S('l', 'a'), S('s', 's'), S(' ', 'b'), S('o', 'o'), S('l', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S('t', 'o'), S('S', 't'), S('r', 'i'), S('n', 'g'), S('(', ')'), S(':', ' '), S('s', 't'), S('r', 'i'), S('n', 'g'), S(';', '\n'), S(' ', ' '), S('}', '\n'), S('\n', ' '), S(' ', 'd'), S('e', 'c'), S('l', 'a'), S('r', 'e'), S(' ', 'c'), S('l', 'a'), S('s', 's'), S(' ', 's'), S('b', 'y'), S('t', 'e'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', 't'), S('o', 'S'), S('t', 'r'), S('i', 'n'), S('g', '('), S(')', ':'), S(' ', 's'), S('t', 'r'), S('i', 'n'), S('g', ';'), S('\n', ' '), S(' ', '}'), S('\n', '\n'), S(' ', ' '), S('d', 'e'), S('c', 'l'), S('a', 'r'), S('e', ' '), S('c', 'l'), S('a', 's'), S('s', ' '), S('b', 'y'), S('t', 'e'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', 't'), S('o', 'S'), S('t', 'r'), S('i', 'n'), S('g', '('), S(')', ':'), S(' ', 's'), S('t', 'r'), S('i', 'n'), S('g', ';'), S('\n', ' '), S(' ', '}'), S('\n', '\n'), S(' ', ' '), S('d', 'e'), S('c', 'l'), S('a', 'r'), S('e', ' '), S('c', 'l'), S('a', 's'), S('s', ' '), S('s', 'h'), S('o', 'r'), S('t', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S('t', 'o'), S('S', 't'), S('r', 'i'), S('n', 'g'), S('(', ')'), S(':', ' '), S('s', 't'), S('r', 'i'), S('n', 'g'), S(';', '\n'), S(' ', ' '), S('}', '\n'), S('\n', ' '), S(' ', 'd'), S('e', 'c'), S('l', 'a'), S('r', 'e'), S(' ', 'c'), S('l', 'a'), S('s', 's'), S(' ', 'u'), S('s', 'h'), S('o', 'r'), S('t', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S('t', 'o'), S('S', 't'), S('r', 'i'), S('n', 'g'), S('(', ')'), S(':', ' '), S('s', 't'), S('r', 'i'), S('n', 'g'), S(';', '\n'), S(' ', ' '), S('}', '\n'), S('\n', ' '), S(' ', 'd'), S('e', 'c'), S('l', 'a'), S('r', 'e'), S(' ', 'c'), S('l', 'a'), S('s', 's'), S(' ', 'i'), S('n', 't'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', 't'), S('o', 'S'), S('t', 'r'), S('i', 'n'), S('g', '('), S(')', ':'), S(' ', 's'), S('t', 'r'), S('i', 'n'), S('g', ';'), S('\n', ' '), S(' ', '}'), S('\n', '\n'), S(' ', ' '), S('d', 'e'), S('c', 'l'), S('a', 'r'), S('e', ' '), S('c', 'l'), S('a', 's'), S('s', ' '), S('u', 'i'), S('n', 't'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', 't'), S('o', 'S'), S('t', 'r'), S('i', 'n'), S('g', '('), S(')', ':'), S(' ', 's'), S('t', 'r'), S('i', 'n'), S('g', ';'), S('\n', ' '), S(' ', '}'), S('\n', '\n'), S(' ', ' '), S('d', 'e'), S('c', 'l'), S('a', 'r'), S('e', ' '), S('c', 'l'), S('a', 's'), S('s', ' '), S('s', 't'), S('r', 'i'), S('n', 'g'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', 'c'), S('h', 'a'), S('r', 'A'), S('t', '('), S('i', 'n'), S('d', 'e'), S('x', ':'), S(' ', 'i'), S('n', 't'), S(')', ':'), S(' ', 's'), S('t', 'r'), S('i', 'n'), S('g', ';'), S('\n', ' '), S(' ', ' '), S(' ', 'c'), S('h', 'a'), S('r', 'C'), S('o', 'd'), S('e', 'A'), S('t', '('), S('i', 'n'), S('d', 'e'), S('x', ':'), S(' ', 'i'), S('n', 't'), S(')', ':'), S(' ', 'u'), S('s', 'h'), S('o', 'r'), S('t', ';'), S('\n', ' '), S(' ', ' '), S(' ', 'g'), S('e', 't'), S(' ', 'l'), S('e', 'n'), S('g', 't'), S('h', '('), S(')', ':'), S(' ', 'i'), S('n', 't'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S('i', 'n'), S('d', 'e'), S('x', 'O'), S('f', '('), S('t', 'e'), S('x', 't'), S(':', ' '), S('s', 't'), S('r', 'i'), S('n', 'g'), S(')', ':'), S(' ', 'i'), S('n', 't'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S('l', 'a'), S('s', 't'), S('I', 'n'), S('d', 'e'), S('x', 'O'), S('f', '('), S('t', 'e'), S('x', 't'), S(':', ' '), S('s', 't'), S('r', 'i'), S('n', 'g'), S(')', ':'), S(' ', 'i'), S('n', 't'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S('o', 'p'), S('e', 'r'), S('a', 't'), S('o', 'r'), S(' ', '='), S('=', ' '), S('(', 'o'), S('t', 'h'), S('e', 'r'), S(':', ' '), S('s', 't'), S('r', 'i'), S('n', 'g'), S(')', ':'), S(' ', 'b'), S('o', 'o'), S('l', ';'), S('\n', ' '), S(' ', ' '), S(' ', 'o'), S('p', 'e'), S('r', 'a'), S('t', 'o'), S('r', ' '), S('[', ']'), S(' ', '('), S('i', 'n'), S('d', 'e'), S('x', ':'), S(' ', 'i'), S('n', 't'), S(')', ':'), S(' ', 'u'), S('s', 'h'), S('o', 'r'), S('t', ' '), S('{', ' '), S('r', 'e'), S('t', 'u'), S('r', 'n'), S(' ', 't'), S('h', 'i'), S('s', '.'), S('c', 'h'), S('a', 'r'), S('C', 'o'), S('d', 'e'), S('A', 't'), S('(', 'i'), S('n', 'd'), S('e', 'x'), S(')', ';'), S(' ', '}'), S('\n', ' '), S(' ', ' '), S(' ', 's'), S('l', 'i'), S('c', 'e'), S('(', 's'), S('t', 'a'), S('r', 't'), S(':', ' '), S('i', 'n'), S('t', ','), S(' ', 'e'), S('n', 'd'), S(':', ' '), S('i', 'n'), S('t', ')'), S(':', ' '), S('s', 't'), S('r', 'i'), S('n', 'g'), S(';', '\n'), S('\n', ' '), S(' ', ' '), S(' ', '#'), S('i', 'f'), S(' ', 'J'), S('S', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('s', 't'), S('a', 'r'), S('t', 's'), S('W', 'i'), S('t', 'h'), S('(', 't'), S('e', 'x'), S('t', ':'), S(' ', 's'), S('t', 'r'), S('i', 'n'), S('g', ')'), S(':', ' '), S('b', 'o'), S('o', 'l'), S(' ', '{'), S(' ', 'r'), S('e', 't'), S('u', 'r'), S('n', ' '), S('t', 'h'), S('i', 's'), S('.', 's'), S('l', 'i'), S('c', 'e'), S('(', '0'), S(',', ' '), S('t', 'e'), S('x', 't'), S('.', 'l'), S('e', 'n'), S('g', 't'), S('h', ')'), S(' ', '='), S('=', ' '), S('t', 'e'), S('x', 't'), S(';', ' '), S('}', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('e', 'n'), S('d', 's'), S('W', 'i'), S('t', 'h'), S('(', 't'), S('e', 'x'), S('t', ':'), S(' ', 's'), S('t', 'r'), S('i', 'n'), S('g', ')'), S(':', ' '), S('b', 'o'), S('o', 'l'), S(' ', '{'), S(' ', 'r'), S('e', 't'), S('u', 'r'), S('n', ' '), S('t', 'h'), S('i', 's'), S('.', 's'), S('l', 'i'), S('c', 'e'), S('(', '-'), S('t', 'e'), S('x', 't'), S('.', 'l'), S('e', 'n'), S('g', 't'), S('h', ','), S(' ', 't'), S('h', 'i'), S('s', '.'), S('l', 'e'), S('n', 'g'), S('t', 'h'), S(')', ' '), S('=', '='), S(' ', 't'), S('e', 'x'), S('t', ';'), S(' ', '}'), S('\n', ' '), S(' ', ' '), S(' ', '#'), S('e', 'l'), S('s', 'e'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 's'), S('t', 'a'), S('r', 't'), S('s', 'W'), S('i', 't'), S('h', '('), S('t', 'e'), S('x', 't'), S(':', ' '), S('s', 't'), S('r', 'i'), S('n', 'g'), S(')', ':'), S(' ', 'b'), S('o', 'o'), S('l', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'e'), S('n', 'd'), S('s', 'W'), S('i', 't'), S('h', '('), S('t', 'e'), S('x', 't'), S(':', ' '), S('s', 't'), S('r', 'i'), S('n', 'g'), S(')', ':'), S(' ', 'b'), S('o', 'o'), S('l', ';'), S('\n', ' '), S(' ', ' '), S(' ', '#'), S('e', 'n'), S('d', 'i'), S('f', '\n'), S(' ', ' '), S('}', '\n'), S('\n', '#'), S('e', 'n'), S('d', 'i'), S('f', '\n'), S('\n', '#'), S('i', 'f'), S(' ', 'C'), S('\n', '\n'), S(' ', ' '), S('e', 'x'), S('t', 'e'), S('r', 'n'), S(' ', 'u'), S('n', 's'), S('a', 'f'), S('e', ' '), S('f', 'u'), S('n', 'c'), S('t', 'i'), S('o', 'n'), S(' ', 'c'), S('s', 't'), S('r', 'i'), S('n', 'g'), S('_', 't'), S('o', '_'), S('u', 't'), S('f', '1'), S('6', '('), S('u', 't'), S('f', '8'), S(':', ' '), S('*', 'b'), S('y', 't'), S('e', ')'), S(':', ' '), S('s', 't'), S('r', 'i'), S('n', 'g'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', 'i'), S('f', ' '), S('(', 'u'), S('t', 'f'), S('8', ' '), S('=', '='), S(' ', 'n'), S('u', 'l'), S('l', ')'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'r'), S('e', 't'), S('u', 'r'), S('n', ' '), S('n', 'u'), S('l', 'l'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S('}', '\n'), S('\n', ' '), S(' ', ' '), S(' ', 'v'), S('a', 'r'), S(' ', 'u'), S('t', 'f'), S('1', '6'), S('_', 'l'), S('e', 'n'), S('g', 't'), S('h', ':'), S(' ', 'u'), S('i', 'n'), S('t', ' '), S('=', ' '), S('0', ';'), S('\n', ' '), S(' ', ' '), S(' ', 'v'), S('a', 'r'), S(' ', 'a'), S(':', ' '), S('b', 'y'), S('t', 'e'), S(',', ' '), S('b', ':'), S(' ', 'b'), S('y', 't'), S('e', ','), S(' ', 'c'), S(':', ' '), S('b', 'y'), S('t', 'e'), S(',', ' '), S('d', ':'), S(' ', 'b'), S('y', 't'), S('e', ';'), S('\n', '\n'), S(' ', ' '), S(' ', ' '), S('/', '/'), S(' ', 'M'), S('e', 'a'), S('s', 'u'), S('r', 'e'), S(' ', 't'), S('e', 'x'), S('t', '\n'), S(' ', ' '), S(' ', ' '), S('v', 'a'), S('r', ' '), S('i', ':'), S(' ', 'u'), S('i', 'n'), S('t', ' '), S('=', ' '), S('0', ';'), S('\n', ' '), S(' ', ' '), S(' ', 'w'), S('h', 'i'), S('l', 'e'), S(' ', '('), S('(', 'a'), S(' ', '='), S(' ', '*'), S('(', 'u'), S('t', 'f'), S('8', ' '), S('+', ' '), S('i', ')'), S(')', ' '), S('!', '='), S(' ', '\''), S('\\', '0'), S('\'', ')'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'i'), S(' ', '='), S(' ', 'i'), S(' ', '+'), S(' ', '1'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('v', 'a'), S('r', ' '), S('c', 'o'), S('d', 'e'), S('P', 'o'), S('i', 'n'), S('t', ':'), S(' ', 'u'), S('i', 'n'), S('t', ';'), S('\n', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('/', '/'), S(' ', 'D'), S('e', 'c'), S('o', 'd'), S('e', ' '), S('U', 'T'), S('F', '-'), S('8', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('i', 'f'), S(' ', '('), S('(', 'b'), S(' ', '='), S(' ', '*'), S('(', 'u'), S('t', 'f'), S('8', ' '), S('+', ' '), S('i', ')'), S(')', ' '), S('!', '='), S(' ', '\''), S('\\', '0'), S('\'', ' '), S('&', '&'), S(' ', 'a'), S(' ', '>'), S('=', ' '), S('0', 'x'), S('C', '0'), S(')', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('i', ' '), S('=', ' '), S('i', ' '), S('+', ' '), S('1', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'i'), S('f', ' '), S('(', '('), S('c', ' '), S('=', ' '), S('*', '('), S('u', 't'), S('f', '8'), S(' ', '+'), S(' ', 'i'), S(')', ')'), S(' ', '!'), S('=', ' '), S('\'', '\\'), S('0', '\''), S(' ', '&'), S('&', ' '), S('a', ' '), S('>', '='), S(' ', '0'), S('x', 'E'), S('0', ')'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'i'), S(' ', '='), S(' ', 'i'), S(' ', '+'), S(' ', '1'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('i', 'f'), S(' ', '('), S('(', 'd'), S(' ', '='), S(' ', '*'), S('(', 'u'), S('t', 'f'), S('8', ' '), S('+', ' '), S('i', ')'), S(')', ' '), S('!', '='), S(' ', '\''), S('\\', '0'), S('\'', ' '), S('&', '&'), S(' ', 'a'), S(' ', '>'), S('=', ' '), S('0', 'x'), S('F', '0'), S(')', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('i', ' '), S('=', ' '), S('i', ' '), S('+', ' '), S('1', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'c'), S('o', 'd'), S('e', 'P'), S('o', 'i'), S('n', 't'), S(' ', '='), S(' ', '('), S('(', 'a'), S(' ', '&'), S(' ', '0'), S('x', '0'), S('7', ')'), S(' ', '<'), S('<', ' '), S('1', '8'), S(')', ' '), S('|', ' '), S('(', '('), S('b', ' '), S('&', ' '), S('0', 'x'), S('3', 'F'), S(')', ' '), S('<', '<'), S(' ', '1'), S('2', ')'), S(' ', '|'), S(' ', '('), S('(', 'c'), S(' ', '&'), S(' ', '0'), S('x', '3'), S('F', ')'), S(' ', '<'), S('<', ' '), S('6', ')'), S(' ', '|'), S(' ', '('), S('d', ' '), S('&', ' '), S('0', 'x'), S('3', 'F'), S(')', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', '}'), S(' ', 'e'), S('l', 's'), S('e', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('c', 'o'), S('d', 'e'), S('P', 'o'), S('i', 'n'), S('t', ' '), S('=', ' '), S('(', '('), S('a', ' '), S('&', ' '), S('0', 'x'), S('0', 'F'), S(')', ' '), S('<', '<'), S(' ', '1'), S('2', ')'), S(' ', '|'), S(' ', '('), S('(', 'b'), S(' ', '&'), S(' ', '0'), S('x', '3'), S('F', ')'), S(' ', '<'), S('<', ' '), S('6', ')'), S(' ', '|'), S(' ', '('), S('c', ' '), S('&', ' '), S('0', 'x'), S('3', 'F'), S(')', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', '}'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', '}'), S(' ', 'e'), S('l', 's'), S('e', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('c', 'o'), S('d', 'e'), S('P', 'o'), S('i', 'n'), S('t', ' '), S('=', ' '), S('(', '('), S('a', ' '), S('&', ' '), S('0', 'x'), S('1', 'F'), S(')', ' '), S('<', '<'), S(' ', '6'), S(')', ' '), S('|', ' '), S('(', 'b'), S(' ', '&'), S(' ', '0'), S('x', '3'), S('F', ')'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('}', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('}', ' '), S('e', 'l'), S('s', 'e'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'c'), S('o', 'd'), S('e', 'P'), S('o', 'i'), S('n', 't'), S(' ', '='), S(' ', 'a'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('}', '\n'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', '/'), S('/', ' '), S('E', 'n'), S('c', 'o'), S('d', 'e'), S(' ', 'U'), S('T', 'F'), S('-', '1'), S('6', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('u', 't'), S('f', '1'), S('6', '_'), S('l', 'e'), S('n', 'g'), S('t', 'h'), S(' ', '='), S(' ', 'u'), S('t', 'f'), S('1', '6'), S('_', 'l'), S('e', 'n'), S('g', 't'), S('h', ' '), S('+', ' '), S('(', 'c'), S('o', 'd'), S('e', 'P'), S('o', 'i'), S('n', 't'), S(' ', '<'), S(' ', '0'), S('x', '1'), S('0', '0'), S('0', '0'), S(' ', '?'), S(' ', '1'), S(' ', ':'), S(' ', '2'), S(')', ' '), S('a', 's'), S(' ', 'u'), S('i', 'n'), S('t', ';'), S('\n', ' '), S(' ', ' '), S(' ', '}'), S('\n', '\n'), S(' ', ' '), S(' ', ' '), S('v', 'a'), S('r', ' '), S('o', 'u'), S('t', 'p'), S('u', 't'), S(' ', '='), S(' ', 's'), S('t', 'r'), S('i', 'n'), S('g', '_'), S('n', 'e'), S('w', '('), S('u', 't'), S('f', '1'), S('6', '_'), S('l', 'e'), S('n', 'g'), S('t', 'h'), S(')', ';'), S('\n', ' '), S(' ', ' '), S(' ', 'v'), S('a', 'r'), S(' ', 'u'), S('t', 'f'), S('1', '6'), S(' ', '='), S(' ', 'o'), S('u', 't'), S('p', 'u'), S('t', ' '), S('a', 's'), S(' ', '*'), S('u', 's'), S('h', 'o'), S('r', 't'), S(' ', '+'), S(' ', '2'), S(';', '\n'), S('\n', ' '), S(' ', ' '), S(' ', '/'), S('/', ' '), S('C', 'o'), S('n', 'v'), S('e', 'r'), S('t', ' '), S('t', 'e'), S('x', 't'), S('\n', ' '), S(' ', ' '), S(' ', 'i'), S(' ', '='), S(' ', '0'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S('w', 'h'), S('i', 'l'), S('e', ' '), S('(', '('), S('a', ' '), S('=', ' '), S('*', '('), S('u', 't'), S('f', '8'), S(' ', '+'), S(' ', 'i'), S(')', ')'), S(' ', '!'), S('=', ' '), S('\'', '\\'), S('0', '\''), S(')', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('i', ' '), S('=', ' '), S('i', ' '), S('+', ' '), S('1', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'v'), S('a', 'r'), S(' ', 'c'), S('o', 'd'), S('e', 'P'), S('o', 'i'), S('n', 't'), S(':', ' '), S('u', 'i'), S('n', 't'), S(';', '\n'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', '/'), S('/', ' '), S('D', 'e'), S('c', 'o'), S('d', 'e'), S(' ', 'U'), S('T', 'F'), S('-', '8'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'i'), S('f', ' '), S('(', '('), S('b', ' '), S('=', ' '), S('*', '('), S('u', 't'), S('f', '8'), S(' ', '+'), S(' ', 'i'), S(')', ')'), S(' ', '!'), S('=', ' '), S('\'', '\\'), S('0', '\''), S(' ', '&'), S('&', ' '), S('a', ' '), S('>', '='), S(' ', '0'), S('x', 'C'), S('0', ')'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'i'), S(' ', '='), S(' ', 'i'), S(' ', '+'), S(' ', '1'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('i', 'f'), S(' ', '('), S('(', 'c'), S(' ', '='), S(' ', '*'), S('(', 'u'), S('t', 'f'), S('8', ' '), S('+', ' '), S('i', ')'), S(')', ' '), S('!', '='), S(' ', '\''), S('\\', '0'), S('\'', ' '), S('&', '&'), S(' ', 'a'), S(' ', '>'), S('=', ' '), S('0', 'x'), S('E', '0'), S(')', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('i', ' '), S('=', ' '), S('i', ' '), S('+', ' '), S('1', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'i'), S('f', ' '), S('(', '('), S('d', ' '), S('=', ' '), S('*', '('), S('u', 't'), S('f', '8'), S(' ', '+'), S(' ', 'i'), S(')', ')'), S(' ', '!'), S('=', ' '), S('\'', '\\'), S('0', '\''), S(' ', '&'), S('&', ' '), S('a', ' '), S('>', '='), S(' ', '0'), S('x', 'F'), S('0', ')'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'i'), S(' ', '='), S(' ', 'i'), S(' ', '+'), S(' ', '1'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('c', 'o'), S('d', 'e'), S('P', 'o'), S('i', 'n'), S('t', ' '), S('=', ' '), S('(', '('), S('a', ' '), S('&', ' '), S('0', 'x'), S('0', '7'), S(')', ' '), S('<', '<'), S(' ', '1'), S('8', ')'), S(' ', '|'), S(' ', '('), S('(', 'b'), S(' ', '&'), S(' ', '0'), S('x', '3'), S('F', ')'), S(' ', '<'), S('<', ' '), S('1', '2'), S(')', ' '), S('|', ' '), S('(', '('), S('c', ' '), S('&', ' '), S('0', 'x'), S('3', 'F'), S(')', ' '), S('<', '<'), S(' ', '6'), S(')', ' '), S('|', ' '), S('(', 'd'), S(' ', '&'), S(' ', '0'), S('x', '3'), S('F', ')'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('}', ' '), S('e', 'l'), S('s', 'e'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'c'), S('o', 'd'), S('e', 'P'), S('o', 'i'), S('n', 't'), S(' ', '='), S(' ', '('), S('(', 'a'), S(' ', '&'), S(' ', '0'), S('x', '0'), S('F', ')'), S(' ', '<'), S('<', ' '), S('1', '2'), S(')', ' '), S('|', ' '), S('(', '('), S('b', ' '), S('&', ' '), S('0', 'x'), S('3', 'F'), S(')', ' '), S('<', '<'), S(' ', '6'), S(')', ' '), S('|', ' '), S('(', 'c'), S(' ', '&'), S(' ', '0'), S('x', '3'), S('F', ')'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('}', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('}', ' '), S('e', 'l'), S('s', 'e'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'c'), S('o', 'd'), S('e', 'P'), S('o', 'i'), S('n', 't'), S(' ', '='), S(' ', '('), S('(', 'a'), S(' ', '&'), S(' ', '0'), S('x', '1'), S('F', ')'), S(' ', '<'), S('<', ' '), S('6', ')'), S(' ', '|'), S(' ', '('), S('b', ' '), S('&', ' '), S('0', 'x'), S('3', 'F'), S(')', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', '}'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', '}'), S(' ', 'e'), S('l', 's'), S('e', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('c', 'o'), S('d', 'e'), S('P', 'o'), S('i', 'n'), S('t', ' '), S('=', ' '), S('a', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', '}'), S('\n', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('/', '/'), S(' ', 'E'), S('n', 'c'), S('o', 'd'), S('e', ' '), S('U', 'T'), S('F', '-'), S('1', '6'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'i'), S('f', ' '), S('(', 'c'), S('o', 'd'), S('e', 'P'), S('o', 'i'), S('n', 't'), S(' ', '<'), S(' ', '0'), S('x', '1'), S('0', '0'), S('0', '0'), S(')', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('*', 'u'), S('t', 'f'), S('1', '6'), S(' ', '='), S(' ', 'c'), S('o', 'd'), S('e', 'P'), S('o', 'i'), S('n', 't'), S(' ', 'a'), S('s', ' '), S('u', 's'), S('h', 'o'), S('r', 't'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('}', ' '), S('e', 'l'), S('s', 'e'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', '*'), S('u', 't'), S('f', '1'), S('6', ' '), S('=', ' '), S('(', '('), S('c', 'o'), S('d', 'e'), S('P', 'o'), S('i', 'n'), S('t', ' '), S('>', '>'), S(' ', '1'), S('0', ')'), S(' ', '+'), S(' ', '('), S('0', 'x'), S('D', '8'), S('0', '0'), S(' ', '-'), S(' ', '('), S('0', 'x'), S('1', '0'), S('0', '0'), S('0', ' '), S('>', '>'), S(' ', '1'), S('0', ')'), S(')', ')'), S(' ', 'a'), S('s', ' '), S('u', 's'), S('h', 'o'), S('r', 't'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('u', 't'), S('f', '1'), S('6', ' '), S('=', ' '), S('u', 't'), S('f', '1'), S('6', ' '), S('+', ' '), S('1', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', '*'), S('u', 't'), S('f', '1'), S('6', ' '), S('=', ' '), S('(', '('), S('c', 'o'), S('d', 'e'), S('P', 'o'), S('i', 'n'), S('t', ' '), S('&', ' '), S('0', 'x'), S('3', 'F'), S('F', ')'), S(' ', '+'), S(' ', '0'), S('x', 'D'), S('C', '0'), S('0', ')'), S(' ', 'a'), S('s', ' '), S('u', 's'), S('h', 'o'), S('r', 't'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('}', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('u', 't'), S('f', '1'), S('6', ' '), S('=', ' '), S('u', 't'), S('f', '1'), S('6', ' '), S('+', ' '), S('1', ';'), S('\n', ' '), S(' ', ' '), S(' ', '}'), S('\n', '\n'), S(' ', ' '), S(' ', ' '), S('r', 'e'), S('t', 'u'), S('r', 'n'), S(' ', 'o'), S('u', 't'), S('p', 'u'), S('t', ';'), S('\n', ' '), S(' ', '}'), S('\n', '\n'), S(' ', ' '), S('e', 'x'), S('t', 'e'), S('r', 'n'), S(' ', 'u'), S('n', 's'), S('a', 'f'), S('e', ' '), S('f', 'u'), S('n', 'c'), S('t', 'i'), S('o', 'n'), S(' ', 'u'), S('t', 'f'), S('1', '6'), S('_', 't'), S('o', '_'), S('c', 's'), S('t', 'r'), S('i', 'n'), S('g', '('), S('i', 'n'), S('p', 'u'), S('t', ':'), S(' ', 's'), S('t', 'r'), S('i', 'n'), S('g', ')'), S(':', ' '), S('*', 'b'), S('y', 't'), S('e', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S('i', 'f'), S(' ', '('), S('i', 'n'), S('p', 'u'), S('t', ' '), S('a', 's'), S(' ', '*'), S('u', 'i'), S('n', 't'), S(' ', '='), S('=', ' '), S('n', 'u'), S('l', 'l'), S(')', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('r', 'e'), S('t', 'u'), S('r', 'n'), S(' ', 'n'), S('u', 'l'), S('l', ';'), S('\n', ' '), S(' ', ' '), S(' ', '}'), S('\n', '\n'), S(' ', ' '), S(' ', ' '), S('v', 'a'), S('r', ' '), S('u', 't'), S('f', '1'), S('6', '_'), S('l', 'e'), S('n', 'g'), S('t', 'h'), S(' ', '='), S(' ', '*'), S('(', 'i'), S('n', 'p'), S('u', 't'), S(' ', 'a'), S('s', ' '), S('*', 'u'), S('i', 'n'), S('t', ')'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S('v', 'a'), S('r', ' '), S('u', 't'), S('f', '8'), S('_', 'l'), S('e', 'n'), S('g', 't'), S('h', ':'), S(' ', 'u'), S('i', 'n'), S('t', ' '), S('=', ' '), S('0', ';'), S('\n', ' '), S(' ', ' '), S(' ', 'v'), S('a', 'r'), S(' ', 'u'), S('t', 'f'), S('1', '6'), S(' ', '='), S(' ', 'i'), S('n', 'p'), S('u', 't'), S(' ', 'a'), S('s', ' '), S('*', 'u'), S('s', 'h'), S('o', 'r'), S('t', ' '), S('+', ' '), S('2', ';'), S('\n', '\n'), S(' ', ' '), S(' ', ' '), S('/', '/'), S(' ', 'M'), S('e', 'a'), S('s', 'u'), S('r', 'e'), S(' ', 't'), S('e', 'x'), S('t', '\n'), S(' ', ' '), S(' ', ' '), S('v', 'a'), S('r', ' '), S('i', ':'), S(' ', 'u'), S('i', 'n'), S('t', ' '), S('=', ' '), S('0', ';'), S('\n', ' '), S(' ', ' '), S(' ', 'w'), S('h', 'i'), S('l', 'e'), S(' ', '('), S('i', ' '), S('<', ' '), S('u', 't'), S('f', '1'), S('6', '_'), S('l', 'e'), S('n', 'g'), S('t', 'h'), S(')', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('v', 'a'), S('r', ' '), S('c', 'o'), S('d', 'e'), S('P', 'o'), S('i', 'n'), S('t', ':'), S(' ', 'u'), S('i', 'n'), S('t', ';'), S('\n', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('/', '/'), S(' ', 'D'), S('e', 'c'), S('o', 'd'), S('e', ' '), S('U', 'T'), S('F', '-'), S('1', '6'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'v'), S('a', 'r'), S(' ', 'a'), S(' ', '='), S(' ', '*'), S('(', 'u'), S('t', 'f'), S('1', '6'), S(' ', '+'), S(' ', 'i'), S(')', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'i'), S(' ', '='), S(' ', 'i'), S(' ', '+'), S(' ', '1'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('i', 'f'), S(' ', '('), S('i', ' '), S('<', ' '), S('u', 't'), S('f', '1'), S('6', '_'), S('l', 'e'), S('n', 'g'), S('t', 'h'), S(' ', '&'), S('&', ' '), S('a', ' '), S('>', '='), S(' ', '0'), S('x', 'D'), S('8', '0'), S('0', ' '), S('&', '&'), S(' ', 'a'), S(' ', '<'), S('=', ' '), S('0', 'x'), S('D', 'B'), S('F', 'F'), S(')', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('v', 'a'), S('r', ' '), S('b', ' '), S('=', ' '), S('*', '('), S('u', 't'), S('f', '1'), S('6', ' '), S('+', ' '), S('i', ')'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('i', ' '), S('=', ' '), S('i', ' '), S('+', ' '), S('1', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'c'), S('o', 'd'), S('e', 'P'), S('o', 'i'), S('n', 't'), S(' ', '='), S(' ', '('), S('a', ' '), S('<', '<'), S(' ', '1'), S('0', ')'), S(' ', '+'), S(' ', 'b'), S(' ', '+'), S(' ', '('), S('0', 'x'), S('1', '0'), S('0', '0'), S('0', ' '), S('-', ' '), S('(', '0'), S('x', 'D'), S('8', '0'), S('0', ' '), S('<', '<'), S(' ', '1'), S('0', ')'), S(' ', '-'), S(' ', '0'), S('x', 'D'), S('C', '0'), S('0', ')'), S(' ', 'a'), S('s', ' '), S('u', 'i'), S('n', 't'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('}', ' '), S('e', 'l'), S('s', 'e'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'c'), S('o', 'd'), S('e', 'P'), S('o', 'i'), S('n', 't'), S(' ', '='), S(' ', 'a'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('}', '\n'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', '/'), S('/', ' '), S('E', 'n'), S('c', 'o'), S('d', 'e'), S(' ', 'U'), S('T', 'F'), S('-', '8'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'u'), S('t', 'f'), S('8', '_'), S('l', 'e'), S('n', 'g'), S('t', 'h'), S(' ', '='), S(' ', 'u'), S('t', 'f'), S('8', '_'), S('l', 'e'), S('n', 'g'), S('t', 'h'), S(' ', '+'), S(' ', '('), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'c'), S('o', 'd'), S('e', 'P'), S('o', 'i'), S('n', 't'), S(' ', '<'), S(' ', '0'), S('x', '8'), S('0', ' '), S('?', ' '), S('1', ' '), S(':', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('c', 'o'), S('d', 'e'), S('P', 'o'), S('i', 'n'), S('t', ' '), S('<', ' '), S('0', 'x'), S('8', '0'), S('0', ' '), S('?', ' '), S('2', ' '), S(':', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('c', 'o'), S('d', 'e'), S('P', 'o'), S('i', 'n'), S('t', ' '), S('<', ' '), S('0', 'x'), S('1', '0'), S('0', '0'), S('0', ' '), S('?', ' '), S('3', ' '), S(':', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('4', ')'), S(' ', 'a'), S('s', ' '), S('u', 'i'), S('n', 't'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S('}', '\n'), S('\n', ' '), S(' ', ' '), S(' ', 'v'), S('a', 'r'), S(' ', 'u'), S('t', 'f'), S('8', ' '), S('=', ' '), S('m', 'a'), S('l', 'l'), S('o', 'c'), S('(', 'u'), S('t', 'f'), S('8', '_'), S('l', 'e'), S('n', 'g'), S('t', 'h'), S(' ', '+'), S(' ', '1'), S(')', ';'), S('\n', ' '), S(' ', ' '), S(' ', 'v'), S('a', 'r'), S(' ', 'n'), S('e', 'x'), S('t', ' '), S('=', ' '), S('u', 't'), S('f', '8'), S(';', '\n'), S('\n', ' '), S(' ', ' '), S(' ', '/'), S('/', ' '), S('C', 'o'), S('n', 'v'), S('e', 'r'), S('t', ' '), S('t', 'e'), S('x', 't'), S('\n', ' '), S(' ', ' '), S(' ', 'i'), S(' ', '='), S(' ', '0'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S('w', 'h'), S('i', 'l'), S('e', ' '), S('(', 'i'), S(' ', '<'), S(' ', 'u'), S('t', 'f'), S('1', '6'), S('_', 'l'), S('e', 'n'), S('g', 't'), S('h', ')'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'v'), S('a', 'r'), S(' ', 'c'), S('o', 'd'), S('e', 'P'), S('o', 'i'), S('n', 't'), S(':', ' '), S('u', 'i'), S('n', 't'), S(';', '\n'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', '/'), S('/', ' '), S('D', 'e'), S('c', 'o'), S('d', 'e'), S(' ', 'U'), S('T', 'F'), S('-', '1'), S('6', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('v', 'a'), S('r', ' '), S('a', ' '), S('=', ' '), S('*', '('), S('u', 't'), S('f', '1'), S('6', ' '), S('+', ' '), S('i', ')'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('i', ' '), S('=', ' '), S('i', ' '), S('+', ' '), S('1', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'i'), S('f', ' '), S('(', 'i'), S(' ', '<'), S(' ', 'u'), S('t', 'f'), S('1', '6'), S('_', 'l'), S('e', 'n'), S('g', 't'), S('h', ' '), S('&', '&'), S(' ', 'a'), S(' ', '>'), S('=', ' '), S('0', 'x'), S('D', '8'), S('0', '0'), S(' ', '&'), S('&', ' '), S('a', ' '), S('<', '='), S(' ', '0'), S('x', 'D'), S('B', 'F'), S('F', ')'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'v'), S('a', 'r'), S(' ', 'b'), S(' ', '='), S(' ', '*'), S('(', 'u'), S('t', 'f'), S('1', '6'), S(' ', '+'), S(' ', 'i'), S(')', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'i'), S(' ', '='), S(' ', 'i'), S(' ', '+'), S(' ', '1'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('c', 'o'), S('d', 'e'), S('P', 'o'), S('i', 'n'), S('t', ' '), S('=', ' '), S('(', 'a'), S(' ', '<'), S('<', ' '), S('1', '0'), S(')', ' '), S('+', ' '), S('b', ' '), S('+', ' '), S('(', '0'), S('x', '1'), S('0', '0'), S('0', '0'), S(' ', '-'), S(' ', '('), S('0', 'x'), S('D', '8'), S('0', '0'), S(' ', '<'), S('<', ' '), S('1', '0'), S(')', ' '), S('-', ' '), S('0', 'x'), S('D', 'C'), S('0', '0'), S(')', ' '), S('a', 's'), S(' ', 'u'), S('i', 'n'), S('t', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', '}'), S(' ', 'e'), S('l', 's'), S('e', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('c', 'o'), S('d', 'e'), S('P', 'o'), S('i', 'n'), S('t', ' '), S('=', ' '), S('a', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', '}'), S('\n', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('/', '/'), S(' ', 'E'), S('n', 'c'), S('o', 'd'), S('e', ' '), S('U', 'T'), S('F', '-'), S('8', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('i', 'f'), S(' ', '('), S('c', 'o'), S('d', 'e'), S('P', 'o'), S('i', 'n'), S('t', ' '), S('<', ' '), S('0', 'x'), S('8', '0'), S(')', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('*', 'n'), S('e', 'x'), S('t', ' '), S('=', ' '), S('c', 'o'), S('d', 'e'), S('P', 'o'), S('i', 'n'), S('t', ' '), S('a', 's'), S(' ', 'b'), S('y', 't'), S('e', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', '}'), S(' ', 'e'), S('l', 's'), S('e', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('i', 'f'), S(' ', '('), S('c', 'o'), S('d', 'e'), S('P', 'o'), S('i', 'n'), S('t', ' '), S('<', ' '), S('0', 'x'), S('8', '0'), S('0', ')'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', '*'), S('n', 'e'), S('x', 't'), S(' ', '='), S(' ', '('), S('(', '('), S('c', 'o'), S('d', 'e'), S('P', 'o'), S('i', 'n'), S('t', ' '), S('>', '>'), S(' ', '6'), S(')', ' '), S('&', ' '), S('0', 'x'), S('1', 'F'), S(')', ' '), S('|', ' '), S('0', 'x'), S('C', '0'), S(')', ' '), S('a', 's'), S(' ', 'b'), S('y', 't'), S('e', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', '}'), S(' ', 'e'), S('l', 's'), S('e', ' '), S('{', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('i', 'f'), S(' ', '('), S('c', 'o'), S('d', 'e'), S('P', 'o'), S('i', 'n'), S('t', ' '), S('<', ' '), S('0', 'x'), S('1', '0'), S('0', '0'), S('0', ')'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', '*'), S('n', 'e'), S('x', 't'), S(' ', '='), S(' ', '('), S('(', '('), S('c', 'o'), S('d', 'e'), S('P', 'o'), S('i', 'n'), S('t', ' '), S('>', '>'), S(' ', '1'), S('2', ')'), S(' ', '&'), S(' ', '0'), S('x', '0'), S('F', ')'), S(' ', '|'), S(' ', '0'), S('x', 'E'), S('0', ')'), S(' ', 'a'), S('s', ' '), S('b', 'y'), S('t', 'e'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('}', ' '), S('e', 'l'), S('s', 'e'), S(' ', '{'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', '*'), S('n', 'e'), S('x', 't'), S(' ', '='), S(' ', '('), S('(', '('), S('c', 'o'), S('d', 'e'), S('P', 'o'), S('i', 'n'), S('t', ' '), S('>', '>'), S(' ', '1'), S('8', ')'), S(' ', '&'), S(' ', '0'), S('x', '0'), S('7', ')'), S(' ', '|'), S(' ', '0'), S('x', 'F'), S('0', ')'), S(' ', 'a'), S('s', ' '), S('b', 'y'), S('t', 'e'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('n', 'e'), S('x', 't'), S(' ', '='), S(' ', 'n'), S('e', 'x'), S('t', ' '), S('+', ' '), S('1', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', '*'), S('n', 'e'), S('x', 't'), S(' ', '='), S(' ', '('), S('(', '('), S('c', 'o'), S('d', 'e'), S('P', 'o'), S('i', 'n'), S('t', ' '), S('>', '>'), S(' ', '1'), S('2', ')'), S(' ', '&'), S(' ', '0'), S('x', '3'), S('F', ')'), S(' ', '|'), S(' ', '0'), S('x', '8'), S('0', ')'), S(' ', 'a'), S('s', ' '), S('b', 'y'), S('t', 'e'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('}', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('n', 'e'), S('x', 't'), S(' ', '='), S(' ', 'n'), S('e', 'x'), S('t', ' '), S('+', ' '), S('1', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', '*'), S('n', 'e'), S('x', 't'), S(' ', '='), S(' ', '('), S('(', '('), S('c', 'o'), S('d', 'e'), S('P', 'o'), S('i', 'n'), S('t', ' '), S('>', '>'), S(' ', '6'), S(')', ' '), S('&', ' '), S('0', 'x'), S('3', 'F'), S(')', ' '), S('|', ' '), S('0', 'x'), S('8', '0'), S(')', ' '), S('a', 's'), S(' ', 'b'), S('y', 't'), S('e', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', '}'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'n'), S('e', 'x'), S('t', ' '), S('=', ' '), S('n', 'e'), S('x', 't'), S(' ', '+'), S(' ', '1'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S('*', 'n'), S('e', 'x'), S('t', ' '), S('=', ' '), S('(', '('), S('c', 'o'), S('d', 'e'), S('P', 'o'), S('i', 'n'), S('t', ' '), S('&', ' '), S('0', 'x'), S('3', 'F'), S(')', ' '), S('|', ' '), S('0', 'x'), S('8', '0'), S(')', ' '), S('a', 's'), S(' ', 'b'), S('y', 't'), S('e', ';'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', '}'), S('\n', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'n'), S('e', 'x'), S('t', ' '), S('=', ' '), S('n', 'e'), S('x', 't'), S(' ', '+'), S(' ', '1'), S(';', '\n'), S(' ', ' '), S(' ', ' '), S('}', '\n'), S('\n', ' '), S(' ', ' '), S(' ', '/'), S('/', ' '), S('C', ' '), S('s', 't'), S('r', 'i'), S('n', 'g'), S('s', ' '), S('a', 'r'), S('e', ' '), S('n', 'u'), S('l', 'l'), S('-', 't'), S('e', 'r'), S('m', 'i'), S('n', 'a'), S('t', 'e'), S('d', '\n'), S(' ', ' '), S(' ', ' '), S('*', 'n'), S('e', 'x'), S('t', ' '), S('=', ' '), S('\'', '\\'), S('0', '\''), S(';', '\n'), S('\n', ' '), S(' ', ' '), S(' ', 'r'), S('e', 't'), S('u', 'r'), S('n', ' '), S('u', 't'), S('f', '8'), S(';', '\n'), S(' ', ' '), S('}', '\n'), S('\n', '#'), S('e', 'n'), S('d', 'i'), S('f', '\n')};
static const uint32_t __string_529[] = {2, S(':', ' ')};
static const uint32_t __string_530_error[] = {7, S('e', 'r'), S('r', 'o'), S('r', ':'), S(' ', 0)};
static const uint32_t __string_531_warning[] = {9, S('w', 'a'), S('r', 'n'), S('i', 'n'), S('g', ':'), S(' ', 0)};
static const uint32_t __string_532_error[] = {7, S('e', 'r'), S('r', 'o'), S('r', ':'), S(' ', 0)};
static const uint32_t __string_533[] = {1, S('\n', 0)};
static const uint32_t __string_534_Usage_thinc_FLAGS_INPUTS[] = {346, S('\n', 'U'), S('s', 'a'), S('g', 'e'), S(':', ' '), S('t', 'h'), S('i', 'n'), S('c', ' '), S('[', 'F'), S('L', 'A'), S('G', 'S'), S(']', ' '), S('[', 'I'), S('N', 'P'), S('U', 'T'), S('S', ']'), S('\n', '\n'), S(' ', ' '), S('-', '-'), S('h', 'e'), S('l', 'p'), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', ' '), S(' ', 'P'), S('r', 'i'), S('n', 't'), S(' ', 't'), S('h', 'i'), S('s', ' '), S('m', 'e'), S('s', 's'), S('a', 'g'), S('e', '.'), S('\n', ' '), S(' ', '-'), S('-', 'o'), S('u', 't'), S(' ', '['), S('P', 'A'), S('T', 'H'), S(']', ' '), S(' ', ' '), S(' ', ' '), S('E', 'm'), S('i', 't'), S(' ', 'c'), S('o', 'd'), S('e', ' '), S('t', 'o'), S(' ', 'P'), S('A', 'T'), S('H', ' '), S('(', 't'), S('h', 'e'), S(' ', 't'), S('a', 'r'), S('g', 'e'), S('t', ' '), S('f', 'o'), S('r', 'm'), S('a', 't'), S(' ', 'i'), S('s', ' '), S('t', 'h'), S('e', ' '), S('f', 'i'), S('l', 'e'), S(' ', 'e'), S('x', 't'), S('e', 'n'), S('s', 'i'), S('o', 'n'), S(')', '.'), S('\n', ' '), S(' ', '-'), S('-', 'd'), S('e', 'f'), S('i', 'n'), S('e', ' '), S('[', 'N'), S('A', 'M'), S('E', ']'), S(' ', ' '), S('D', 'e'), S('f', 'i'), S('n', 'e'), S(' ', 't'), S('h', 'e'), S(' ', 'f'), S('l', 'a'), S('g', ' '), S('N', 'A'), S('M', 'E'), S(' ', 'i'), S('n', ' '), S('a', 'l'), S('l', ' '), S('i', 'n'), S('p', 'u'), S('t', ' '), S('f', 'i'), S('l', 'e'), S('s', '.'), S('\n', '\n'), S('E', 'x'), S('a', 'm'), S('p', 'l'), S('e', 's'), S(':', '\n'), S('\n', ' '), S(' ', 't'), S('h', 'i'), S('n', 'c'), S(' ', 'm'), S('a', 'i'), S('n', '.'), S('t', 'h'), S('i', 'n'), S(' ', '-'), S('-', 'o'), S('u', 't'), S(' ', 'm'), S('a', 'i'), S('n', '.'), S('j', 's'), S('\n', ' '), S(' ', 't'), S('h', 'i'), S('n', 'c'), S(' ', 's'), S('r', 'c'), S('/', '*'), S('.', 't'), S('h', 'i'), S('n', ' '), S('-', '-'), S('o', 'u'), S('t', ' '), S('m', 'a'), S('i', 'n'), S('.', 'w'), S('a', 's'), S('m', '\n'), S(' ', ' '), S('t', 'h'), S('i', 'n'), S('c', ' '), S('n', 'a'), S('t', 'i'), S('v', 'e'), S('.', 't'), S('h', 'i'), S('n', ' '), S('-', '-'), S('o', 'u'), S('t', ' '), S('m', 'a'), S('i', 'n'), S('.', 'c'), S(' ', '-'), S('-', 'd'), S('e', 'f'), S('i', 'n'), S('e', ' '), S('E', 'N'), S('A', 'B'), S('L', 'E'), S('_', 'T'), S('E', 'S'), S('T', 'S'), S('\n', '\n')};
static const uint32_t __string_535[] = {1, S('-', 0)};
static const uint32_t __string_536_h[] = {2, S('-', 'h')};
static const uint32_t __string_537_help[] = {5, S('-', 'h'), S('e', 'l'), S('p', 0)};
static const uint32_t __string_538_help[] = {6, S('-', '-'), S('h', 'e'), S('l', 'p')};
static const uint32_t __string_539[] = {2, S('/', '?')};
static const uint32_t __string_540_c[] = {3, S('-', '-'), S('c', 0)};
static const uint32_t __string_541_js[] = {4, S('-', '-'), S('j', 's')};
static const uint32_t __string_542_wasm[] = {6, S('-', '-'), S('w', 'a'), S('s', 'm')};
static const uint32_t __string_543_define[] = {8, S('-', '-'), S('d', 'e'), S('f', 'i'), S('n', 'e')};
static const uint32_t __string_544_out[] = {5, S('-', '-'), S('o', 'u'), S('t', 0)};
static const uint32_t __string_545_Invalid_flag[] = {14, S('I', 'n'), S('v', 'a'), S('l', 'i'), S('d', ' '), S('f', 'l'), S('a', 'g'), S(':', ' ')};
static const uint32_t __string_546_No_input_files[] = {14, S('N', 'o'), S(' ', 'i'), S('n', 'p'), S('u', 't'), S(' ', 'f'), S('i', 'l'), S('e', 's')};
static const uint32_t __string_547_Missing_an_output_file_use_the[] = {43, S('M', 'i'), S('s', 's'), S('i', 'n'), S('g', ' '), S('a', 'n'), S(' ', 'o'), S('u', 't'), S('p', 'u'), S('t', ' '), S('f', 'i'), S('l', 'e'), S(' ', '('), S('u', 's'), S('e', ' '), S('t', 'h'), S('e', 160), S('-', '-'), S('o', 'u'), S('t', ' '), S('f', 'l'), S('a', 'g'), S(')', 0)};
static const uint32_t __string_548_c[] = {2, S('.', 'c')};
static const uint32_t __string_549_js[] = {3, S('.', 'j'), S('s', 0)};
static const uint32_t __string_550_wasm[] = {5, S('.', 'w'), S('a', 's'), S('m', 0)};
static const uint32_t __string_551_Missing_a_target_use_either_c[] = {50, S('M', 'i'), S('s', 's'), S('i', 'n'), S('g', ' '), S('a', ' '), S('t', 'a'), S('r', 'g'), S('e', 't'), S(' ', '('), S('u', 's'), S('e', ' '), S('e', 'i'), S('t', 'h'), S('e', 'r'), S(' ', '-'), S('-', 'c'), S(',', ' '), S('-', '-'), S('j', 's'), S(',', ' '), S('o', 'r'), S(' ', '-'), S('-', 'w'), S('a', 's'), S('m', ')')};
static const uint32_t __string_552_define[] = {8, S('-', '-'), S('d', 'e'), S('f', 'i'), S('n', 'e')};
static const uint32_t __string_553_out[] = {5, S('-', '-'), S('o', 'u'), S('t', 0)};
static const uint32_t __string_554[] = {1, S('-', 0)};
static const uint32_t __string_555_Cannot_read_from[] = {17, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'r'), S('e', 'a'), S('d', ' '), S('f', 'r'), S('o', 'm'), S(' ', 0)};
static const uint32_t __string_556_h[] = {2, S('.', 'h')};
static const uint32_t __string_557_Cannot_write_to[] = {16, S('C', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'w'), S('r', 'i'), S('t', 'e'), S(' ', 't'), S('o', ' ')};
static const uint32_t __string_558[] = {1, S('%', 0)};
static const uint32_t __string_559[] = {1, S('&', 0)};
static const uint32_t __string_560[] = {1, S('*', 0)};
static const uint32_t __string_561[] = {2, S('*', '*')};
static const uint32_t __string_562[] = {1, S('/', 0)};
static const uint32_t __string_563[] = {1, S('<', 0)};
static const uint32_t __string_564[] = {2, S('<', '<')};
static const uint32_t __string_565[] = {2, S('=', '=')};
static const uint32_t __string_566[] = {1, S('>', 0)};
static const uint32_t __string_567[] = {2, S('>', '>')};
static const uint32_t __string_568[] = {2, S('[', ']')};
static const uint32_t __string_569[] = {1, S('^', 0)};
static const uint32_t __string_570[] = {1, S('|', 0)};
static const uint32_t __string_571[] = {3, S('[', ']'), S('=', 0)};
static const uint32_t __string_572_Unexpected[] = {11, S('U', 'n'), S('e', 'x'), S('p', 'e'), S('c', 't'), S('e', 'd'), S(' ', 0)};
static const uint32_t __string_573_Expected[] = {9, S('E', 'x'), S('p', 'e'), S('c', 't'), S('e', 'd'), S(' ', 0)};
static const uint32_t __string_574_Expected[] = {9, S('E', 'x'), S('p', 'e'), S('c', 't'), S('e', 'd'), S(' ', 0)};
static const uint32_t __string_575_but_found[] = {11, S(' ', 'b'), S('u', 't'), S(' ', 'f'), S('o', 'u'), S('n', 'd'), S(' ', 0)};
static const uint32_t __string_576_Invalid_escape_code[] = {21, S('I', 'n'), S('v', 'a'), S('l', 'i'), S('d', ' '), S('e', 's'), S('c', 'a'), S('p', 'e'), S(' ', 'c'), S('o', 'd'), S('e', ' '), S('\'', 0)};
static const uint32_t __string_577_Invalid_character_literal_strin[] = {53, S('I', 'n'), S('v', 'a'), S('l', 'i'), S('d', ' '), S('c', 'h'), S('a', 'r'), S('a', 'c'), S('t', 'e'), S('r', ' '), S('l', 'i'), S('t', 'e'), S('r', 'a'), S('l', ' '), S('(', 's'), S('t', 'r'), S('i', 'n'), S('g', 's'), S(' ', 'u'), S('s', 'e'), S(' ', 'd'), S('o', 'u'), S('b', 'l'), S('e', ' '), S('q', 'u'), S('o', 't'), S('e', 's'), S(')', 0)};
static const uint32_t __string_578_operator[] = {8, S('o', 'p'), S('e', 'r'), S('a', 't'), S('o', 'r')};
static const uint32_t __string_579_get[] = {3, S('g', 'e'), S('t', 0)};
static const uint32_t __string_580_set[] = {3, S('s', 'e'), S('t', 0)};
static const uint32_t __string_581_Instance_functions_don_t_need_th[] = {52, S('I', 'n'), S('s', 't'), S('a', 'n'), S('c', 'e'), S(' ', 'f'), S('u', 'n'), S('c', 't'), S('i', 'o'), S('n', 's'), S(' ', 'd'), S('o', 'n'), S('\'', 't'), S(' ', 'n'), S('e', 'e'), S('d', ' '), S('t', 'h'), S('e', ' '), S('\'', 'f'), S('u', 'n'), S('c', 't'), S('i', 'o'), S('n', '\''), S(' ', 'k'), S('e', 'y'), S('w', 'o'), S('r', 'd')};
static const uint32_t __string_582_Instance_variables_don_t_need_th[] = {35, S('I', 'n'), S('s', 't'), S('a', 'n'), S('c', 'e'), S(' ', 'v'), S('a', 'r'), S('i', 'a'), S('b', 'l'), S('e', 's'), S(' ', 'd'), S('o', 'n'), S('\'', 't'), S(' ', 'n'), S('e', 'e'), S('d', ' '), S('t', 'h'), S('e', ' '), S('\'', 0)};
static const uint32_t __string_583_keyword[] = {9, S('\'', ' '), S('k', 'e'), S('y', 'w'), S('o', 'r'), S('d', 0)};
static const uint32_t __string_584[] = {3, S('[', ']'), S('=', 0)};
static const uint32_t __string_585[] = {2, S('[', ']')};
static const uint32_t __string_586_The_operator[] = {14, S('T', 'h'), S('e', ' '), S('o', 'p'), S('e', 'r'), S('a', 't'), S('o', 'r'), S(' ', '\'')};
static const uint32_t __string_587_cannot_be_implemented[] = {23, S('\'', ' '), S('c', 'a'), S('n', 'n'), S('o', 't'), S(' ', 'b'), S('e', ' '), S('i', 'm'), S('p', 'l'), S('e', 'm'), S('e', 'n'), S('t', 'e'), S('d', 0)};
static const uint32_t __string_588_it_is_automatically_derived_fr[] = {40, S(' ', '('), S('i', 't'), S(' ', 'i'), S('s', ' '), S('a', 'u'), S('t', 'o'), S('m', 'a'), S('t', 'i'), S('c', 'a'), S('l', 'l'), S('y', ' '), S('d', 'e'), S('r', 'i'), S('v', 'e'), S('d', ' '), S('f', 'r'), S('o', 'm'), S(' ', '\''), S('=', '='), S('\'', ')')};
static const uint32_t __string_589_it_is_automatically_derived_fr[] = {39, S(' ', '('), S('i', 't'), S(' ', 'i'), S('s', ' '), S('a', 'u'), S('t', 'o'), S('m', 'a'), S('t', 'i'), S('c', 'a'), S('l', 'l'), S('y', ' '), S('d', 'e'), S('r', 'i'), S('v', 'e'), S('d', ' '), S('f', 'r'), S('o', 'm'), S(' ', '\''), S('>', '\''), S(')', 0)};
static const uint32_t __string_590_it_is_automatically_derived_fr[] = {39, S(' ', '('), S('i', 't'), S(' ', 'i'), S('s', ' '), S('a', 'u'), S('t', 'o'), S('m', 'a'), S('t', 'i'), S('c', 'a'), S('l', 'l'), S('y', ' '), S('d', 'e'), S('r', 'i'), S('v', 'e'), S('d', ' '), S('f', 'r'), S('o', 'm'), S(' ', '\''), S('<', '\''), S(')', 0)};
static const uint32_t __string_591[] = {0};
static const uint32_t __string_592_Inline_initialization_of_instanc[] = {64, S('I', 'n'), S('l', 'i'), S('n', 'e'), S(' ', 'i'), S('n', 'i'), S('t', 'i'), S('a', 'l'), S('i', 'z'), S('a', 't'), S('i', 'o'), S('n', ' '), S('o', 'f'), S(' ', 'i'), S('n', 's'), S('t', 'a'), S('n', 'c'), S('e', ' '), S('v', 'a'), S('r', 'i'), S('a', 'b'), S('l', 'e'), S('s', ' '), S('i', 's'), S(' ', 'n'), S('o', 't'), S(' ', 's'), S('u', 'p'), S('p', 'o'), S('r', 't'), S('e', 'd'), S(' ', 'y'), S('e', 't')};
static const uint32_t __string_593_Use_the_0o_prefix_for_octal_in[] = {38, S('U', 's'), S('e', ' '), S('t', 'h'), S('e', ' '), S('\'', '0'), S('o', '\''), S(' ', 'p'), S('r', 'e'), S('f', 'i'), S('x', ' '), S('f', 'o'), S('r', ' '), S('o', 'c'), S('t', 'a'), S('l', ' '), S('i', 'n'), S('t', 'e'), S('g', 'e'), S('r', 's')};
static const uint32_t __string_594_Integer_literal_is_too_big_to_fi[] = {44, S('I', 'n'), S('t', 'e'), S('g', 'e'), S('r', ' '), S('l', 'i'), S('t', 'e'), S('r', 'a'), S('l', ' '), S('i', 's'), S(' ', 't'), S('o', 'o'), S(' ', 'b'), S('i', 'g'), S(' ', 't'), S('o', ' '), S('f', 'i'), S('t', ' '), S('i', 'n'), S(' ', '3'), S('2', ' '), S('b', 'i'), S('t', 's')};
static const uint32_t __string_595_Unexpected[] = {11, S('U', 'n'), S('e', 'x'), S('p', 'e'), S('c', 't'), S('e', 'd'), S(' ', 0)};
static const uint32_t __string_596_Expected[] = {9, S('E', 'x'), S('p', 'e'), S('c', 't'), S('e', 'd'), S(' ', 0)};
static const uint32_t __string_597_but_found[] = {11, S(' ', 'b'), S('u', 't'), S(' ', 'f'), S('o', 'u'), S('n', 'd'), S(' ', 0)};
static const uint32_t __string_598_0[] = {1, S('0', 0)};
static const uint32_t __string_599_Use_undef_to_turn_a_preproces[] = {44, S('U', 's'), S('e', ' '), S('\'', '#'), S('u', 'n'), S('d', 'e'), S('f', '\''), S(' ', 't'), S('o', ' '), S('t', 'u'), S('r', 'n'), S(' ', 'a'), S(' ', 'p'), S('r', 'e'), S('p', 'r'), S('o', 'c'), S('e', 's'), S('s', 'o'), S('r', ' '), S('f', 'l'), S('a', 'g'), S(' ', 'o'), S('f', 'f')};
static const uint32_t __string_600_All_define_and_undef_direc[] = {68, S('A', 'l'), S('l', ' '), S('\'', '#'), S('d', 'e'), S('f', 'i'), S('n', 'e'), S('\'', ' '), S('a', 'n'), S('d', ' '), S('\'', '#'), S('u', 'n'), S('d', 'e'), S('f', '\''), S(' ', 'd'), S('i', 'r'), S('e', 'c'), S('t', 'i'), S('v', 'e'), S('s', ' '), S('m', 'u'), S('s', 't'), S(' ', 'b'), S('e', ' '), S('a', 't'), S(' ', 't'), S('h', 'e'), S(' ', 't'), S('o', 'p'), S(' ', 'o'), S('f', ' '), S('t', 'h'), S('e', ' '), S('f', 'i'), S('l', 'e')};
static const uint32_t __string_601_defined[] = {7, S('d', 'e'), S('f', 'i'), S('n', 'e'), S('d', 0)};
static const uint32_t __string_602_There_is_no_defined_operator[] = {30, S('T', 'h'), S('e', 'r'), S('e', ' '), S('i', 's'), S(' ', 'n'), S('o', ' '), S('\'', 'd'), S('e', 'f'), S('i', 'n'), S('e', 'd'), S('\'', ' '), S('o', 'p'), S('e', 'r'), S('a', 't'), S('o', 'r')};
static const uint32_t __string_603_just_use[] = {12, S(' ', '('), S('j', 'u'), S('s', 't'), S(' ', 'u'), S('s', 'e'), S(' ', '\'')};
static const uint32_t __string_604_instead[] = {10, S('\'', ' '), S('i', 'n'), S('s', 't'), S('e', 'a'), S('d', ')')};
static const uint32_t __string_605_0[] = {1, S('0', 0)};
static const uint32_t __string_606_Unexpected_integer_did_you_mean[] = {34, S('U', 'n'), S('e', 'x'), S('p', 'e'), S('c', 't'), S('e', 'd'), S(' ', 'i'), S('n', 't'), S('e', 'g'), S('e', 'r'), S(' ', '('), S('d', 'i'), S('d', ' '), S('y', 'o'), S('u', ' '), S('m', 'e'), S('a', 'n'), S(' ', '\'')};
static const uint32_t __string_607_true[] = {4, S('t', 'r'), S('u', 'e')};
static const uint32_t __string_608_false[] = {5, S('f', 'a'), S('l', 's'), S('e', 0)};
static const uint32_t __string_609[] = {3, S('\'', ')'), S('?', 0)};
static const uint32_t __string_610_Duplicate_symbol[] = {18, S('D', 'u'), S('p', 'l'), S('i', 'c'), S('a', 't'), S('e', ' '), S('s', 'y'), S('m', 'b'), S('o', 'l'), S(' ', '\'')};
static const uint32_t __string_611[] = {1, S('\'', 0)};
static const uint32_t __string_612[] = {2, S('\\', '"')};
static const uint32_t __string_613_0[] = {2, S('\\', '0')};
static const uint32_t __string_614_t[] = {2, S('\\', 't')};
static const uint32_t __string_615_r[] = {2, S('\\', 'r')};
static const uint32_t __string_616_n[] = {2, S('\\', 'n')};
static const uint32_t __string_617[] = {2, S('\\', '\\')};
static const uint32_t __string_618_signatures[] = {10, S('s', 'i'), S('g', 'n'), S('a', 't'), S('u', 'r'), S('e', 's')};
static const uint32_t __string_619_import_table[] = {12, S('i', 'm'), S('p', 'o'), S('r', 't'), S('_', 't'), S('a', 'b'), S('l', 'e')};
static const uint32_t __string_620_function_signatures[] = {19, S('f', 'u'), S('n', 'c'), S('t', 'i'), S('o', 'n'), S('_', 's'), S('i', 'g'), S('n', 'a'), S('t', 'u'), S('r', 'e'), S('s', 0)};
static const uint32_t __string_621_memory[] = {6, S('m', 'e'), S('m', 'o'), S('r', 'y')};
static const uint32_t __string_622_export_table[] = {12, S('e', 'x'), S('p', 'o'), S('r', 't'), S('_', 't'), S('a', 'b'), S('l', 'e')};
static const uint32_t __string_623_function_bodies[] = {15, S('f', 'u'), S('n', 'c'), S('t', 'i'), S('o', 'n'), S('_', 'b'), S('o', 'd'), S('i', 'e'), S('s', 0)};
static const uint32_t __string_624_data_segments[] = {13, S('d', 'a'), S('t', 'a'), S('_', 's'), S('e', 'g'), S('m', 'e'), S('n', 't'), S('s', 0)};
static const uint32_t __string_625_currentHeapPointer[] = {18, S('c', 'u'), S('r', 'r'), S('e', 'n'), S('t', 'H'), S('e', 'a'), S('p', 'P'), S('o', 'i'), S('n', 't'), S('e', 'r')};
static const uint32_t __string_626_originalHeapPointer[] = {19, S('o', 'r'), S('i', 'g'), S('i', 'n'), S('a', 'l'), S('H', 'e'), S('a', 'p'), S('P', 'o'), S('i', 'n'), S('t', 'e'), S('r', 0)};
static const uint32_t __string_627_global[] = {6, S('g', 'l'), S('o', 'b'), S('a', 'l')};
static const uint32_t __string_628_malloc[] = {6, S('m', 'a'), S('l', 'l'), S('o', 'c')};
...
static void CResult_emitExpression(struct CResult *__this, struct Node *node, int32_t parentPrecedence) {
  ...
  if (node->kind == 25) {
    ...
    while (i < length) {
      ...
      if (i + 1 < length) {
        StringBuilder_append(codePrefix, (const uint16_t *)__string_13);
        cEmitCharacter(codePrefix, string_op_get(value, i + 1));
        StringBuilder_appendChar(codePrefix, 41);
      }

      else {
        StringBuilder_append(codePrefix, (const uint16_t *)__string_14_0);
      }

      i = i + 2;
    }

    StringBuilder_append(codePrefix, (const uint16_t *)__string_15);
    __this->nextStringLiteral = __this->nextStringLiteral + 1;
    StringBuilder_append(StringBuilder_append(code, (const uint16_t *)__string_16_const_uint16_t), name);
  }
    ...
    StringBuilder_append(code, Type_isReference(target->resolvedType) ? (const uint16_t *)__string_17 : (const uint16_t *)__string_18);
    CResult_emitSymbolName(__this, node->symbol);
  }
    ...
    StringBuilder_append(code, (const uint16_t *)__string_19);
    ...
    StringBuilder_append(code, (const uint16_t *)__string_22_calloc_1_sizeof);
    CResult_emitType(__this, node->resolvedType, 2);
    StringBuilder_append(code, (const uint16_t *)__string_23);
  }

  else if (node->kind == 34) {
    CResult_emitUnary(__this, node, parentPrecedence, (const uint16_t *)__string_24);
  }
    ...
    CResult_emitBinary(__this, node, parentPrecedence, (const uint16_t *)__string_33, 10);
  }

  else if (node->kind == 45) {
    CResult_emitBinary(__this, node, parentPrecedence, (const uint16_t *)__string_34, 1);
  }

  else if (node->kind == 46) {
    CResult_emitBinary(__this, node, parentPrecedence, (const uint16_t *)__string_35, 6);
  }

  else if (node->kind == 47) {
    CResult_emitBinary(__this, node, parentPrecedence, (const uint16_t *)__string_36, 4);
  }

  else if (node->kind == 48) {
    CResult_emitBinary(__this, node, parentPrecedence, (const uint16_t *)__string_37, 5);
  }

  else if (node->kind == 49) {
    CResult_emitBinary(__this, node, parentPrecedence, (const uint16_t *)__string_38, 11);
  }

  else if (node->kind == 50) {
    CResult_emitBinary(__this, node, parentPrecedence, (const uint16_t *)__string_39, 7);
  }

  else if (node->kind == 52) {
    CResult_emitBinary(__this, node, parentPrecedence, (const uint16_t *)__string_40, 8);
  }
    ...
    CResult_emitBinary(__this, node, parentPrecedence, (const uint16_t *)__string_44, 3);
  }

  else if (node->kind == 57) {
    CResult_emitBinary(__this, node, parentPrecedence, (const uint16_t *)__string_45, 2);
  }

  else if (node->kind == 58) {
    CResult_emitBinary(__this, node, parentPrecedence, (const uint16_t *)__string_46, 11);
  }

  else if (node->kind == 59) {
    CResult_emitBinary(__this, node, parentPrecedence, (const uint16_t *)__string_47, 7);
  }

  else if (node->kind == 60) {
    CResult_emitBinary(__this, node, parentPrecedence, (const uint16_t *)__string_48, 11);
  }

  else if (node->kind == 61) {
    CResult_emitBinary(__this, node, parentPrecedence, (const uint16_t *)__string_49, 9);
  }
    ...
    CResult_emitBinary(__this, node, parentPrecedence, (const uint16_t *)__string_51, 10);
  }
...
static void CResult_emitType(struct CResult *__this, struct Type *originalType, int32_t mode) {
  ...
  if (Type_isClass(type)) {
    StringBuilder_append(code, (const uint16_t *)__string_52_struct);
  }

  if (type == context->boolType || type == context->byteType) {
    StringBuilder_append(code, (const uint16_t *)__string_53_uint8_t);
  }

  else if (type == context->sbyteType) {
    StringBuilder_append(code, (const uint16_t *)__string_54_int8_t);
  }

  else if (type == context->intType) {
    StringBuilder_append(code, (const uint16_t *)__string_55_int32_t);
  }

  else if (type == context->shortType) {
    StringBuilder_append(code, (const uint16_t *)__string_56_int16_t);
  }

  else if (type == context->stringType) {
    StringBuilder_append(code, (const uint16_t *)__string_57_const_uint16_t);
  }

  else if (type == context->uintType) {
    StringBuilder_append(code, (const uint16_t *)__string_58_uint32_t);
  }

  else if (type == context->ushortType) {
    StringBuilder_append(code, (const uint16_t *)__string_59_uint16_t);
  }
  ...
  if (originalType->pointerTo != NULL) {
    ...
    if (Type_isReference(type)) {
      StringBuilder_append(code, (const uint16_t *)__string_60);
    }
...
static void CResult_emitStatement(struct CResult *__this, struct Node *node) {
  ...
  if (node->kind == 12) {
    ...
    while (1) {
      StringBuilder_append(code, (const uint16_t *)__string_61_if);
      CResult_emitExpression(__this, Node_ifValue(node), 0);
      StringBuilder_append(code, (const uint16_t *)__string_62);
      ...
      CResult_emitIndent(__this);
      StringBuilder_append(code, (const uint16_t *)__string_64_else);
    ...
    CResult_emitNewlineBefore(__this, node);
    CResult_emitIndent(__this);
    StringBuilder_append(code, (const uint16_t *)__string_65_while);
    ...
    CResult_emitNewlineBefore(__this, node);
    CResult_emitIndent(__this);
    StringBuilder_append(code, (const uint16_t *)__string_67_break);
    CResult_emitNewlineAfter(__this, node);
  }
    ...
    CResult_emitNewlineBefore(__this, node);
    CResult_emitIndent(__this);
    StringBuilder_append(code, (const uint16_t *)__string_68_continue);
    CResult_emitNewlineAfter(__this, node);
  }
    ...
    StringBuilder_append(code, (const uint16_t *)__string_69);
    CResult_emitNewlineAfter(__this, node);
  }
    ...
    if (value != NULL) {
      StringBuilder_append(code, (const uint16_t *)__string_70_return);
      CResult_emitExpression(__this, value, 0);
      StringBuilder_append(code, (const uint16_t *)__string_71);
    }

    else {
      StringBuilder_append(code, (const uint16_t *)__string_72_return);
    }
...
static void CResult_emitIncludes(struct CResult *__this, struct StringBuilder *code, int32_t mode) {
  if (mode == 0) {
    StringBuilder_append(code, (const uint16_t *)__string_75_include_stdint_h);
  }

  else {
    StringBuilder_append(StringBuilder_append(StringBuilder_append(code, (const uint16_t *)__string_76_include), __this->headerName), (const uint16_t *)__string_77);
    StringBuilder_append(code, (const uint16_t *)__string_78_include_stdlib_h);
    StringBuilder_append(code, (const uint16_t *)__string_79_include_string_h);
  }
}
  ...
  while (node != NULL) {
    if (node->kind == 5) {
      if (CResult_shouldEmitClass(__this, node) && (Node_isDeclareOrExtern(node) ? mode == 0 : mode == 1)) {
        CResult_emitNewlineBefore(__this, node);
        StringBuilder_append(StringBuilder_append(StringBuilder_append(code, (const uint16_t *)__string_80_struct), node->symbol->name), (const uint16_t *)__string_81);
      }
    }
  ...
  while (node != NULL) {
    if (node->kind == 5) {
      if (CResult_shouldEmitClass(__this, node) && mode != 0) {
        CResult_emitNewlineBefore(__this, node);
        StringBuilder_append(code, (const uint16_t *)__string_82_struct);
        CResult_emitSymbolName(__this, node->symbol);
        StringBuilder_append(code, (const uint16_t *)__string_83);
        __this->indent = __this->indent + 1;
        struct Node *child = node->firstChild;
      ...
      if (mode == 0 && Node_isExtern(node)) {
        CResult_emitNewlineBefore(__this, node);
        StringBuilder_append(code, (const uint16_t *)__string_86_enum);
        __this->indent = __this->indent + 1;
        struct Node *child = node->firstChild;
        ...
        while (child != NULL) {
          ...
          CResult_emitIndent(__this);
          CResult_emitSymbolName(__this, node->symbol);
          StringBuilder_append(code, (const uint16_t *)__string_87__);
          CResult_emitSymbolName(__this, child->symbol);
          StringBuilder_append(code, (const uint16_t *)__string_88);
          StringBuilder_append(code, int_toString(child->symbol->offset));
          child = child->nextSibling;
          StringBuilder_append(code, child != NULL ? (const uint16_t *)__string_89 : (const uint16_t *)__string_90);
        }

        __this->indent = __this->indent - 1;
        CResult_emitIndent(__this);
        StringBuilder_append(code, (const uint16_t *)__string_91);
        CResult_emitNewlineAfter(__this, node);
      }
    }
...
static uint8_t CResult_shouldEmitFunction(struct CResult *__this, struct Symbol *symbol) {
  return symbol->kind != 5 || (!string_op_equals(symbol->name, (const uint16_t *)__string_92_malloc) && !string_op_equals(symbol->name, (const uint16_t *)__string_93_memcpy) && !string_op_equals(symbol->name, (const uint16_t *)__string_94_memcmp));
}
...
static void CResult_emitFunctionDeclarations(struct CResult *__this, struct Node *node, int32_t mode) {
  ...
  while (node != NULL) {
    if (node->kind == 11 && (mode != 0 || Node_isDeclareOrExtern(node))) {
      ...
      if (CResult_shouldEmitFunction(__this, symbol)) {
        ...
        if (!Node_isDeclareOrExtern(node)) {
          StringBuilder_append(code, (const uint16_t *)__string_95_static);
        }
        ...
        if (symbol->kind == 4) {
          child->symbol->rename = (const uint16_t *)__string_96___this;
        }
        ...
        while (child != returnType) {
          ...
          if (child != returnType) {
            StringBuilder_append(code, (const uint16_t *)__string_97);
          }
        }
...
static void CResult_emitGlobalVariables(struct CResult *__this, struct Node *node, int32_t mode) {
  ...
  while (node != NULL) {
    if (node->kind == 2 && (mode != 0 || Node_isExtern(node))) {
      struct Node *value = Node_variableValue(node);
      CResult_emitNewlineBefore(__this, node);

      if (!Node_isDeclareOrExtern(node)) {
        StringBuilder_append(code, (const uint16_t *)__string_99_static);
      }

      CResult_emitType(__this, node->symbol->resolvedType, 1);
      CResult_emitSymbolName(__this, node->symbol);
      StringBuilder_append(code, (const uint16_t *)__string_100);
      CResult_emitExpression(__this, value, 0);
  ...
  while (node != NULL) {
    if (node->kind == 11) {
      ...
      if (body != NULL && CResult_shouldEmitFunction(__this, symbol)) {
        ...
        if (!Node_isDeclareOrExtern(node)) {
          StringBuilder_append(code, (const uint16_t *)__string_102_static);
        }
        ...
        while (child != returnType) {
          ...
          if (child != returnType) {
            StringBuilder_append(code, (const uint16_t *)__string_103);
          }
        }
...
static void CResult_finishImplementation(struct CResult *__this) {
  if (__this->hasStrings) {
    StringBuilder_append(__this->codePrefix, (const uint16_t *)__string_105_undef_S);
  }
}
...
static void cEmitCharacter(struct StringBuilder *builder, uint16_t c) {
  if (isASCII(c)) {
    ...
    StringBuilder_append(builder, (const uint16_t *)__string_106_0);
  }

  else if (c == 13) {
    StringBuilder_append(builder, (const uint16_t *)__string_107_r);
  }

  else if (c == 10) {
    StringBuilder_append(builder, (const uint16_t *)__string_108_n);
  }

  else if (c == 9) {
    StringBuilder_append(builder, (const uint16_t *)__string_109_t);
  }
...
static void cEmit(struct Compiler *compiler) {
  ...
  result->headerName = replaceFileExtension(compiler->outputName, (const uint16_t *)__string_110_h);
...
static void initialize(struct CheckContext *context, struct Node *node, struct Scope *parentScope, int32_t mode) {
  ...
  if (node->parent != NULL) {
    ...
    if (kind != 2 && kind != 15 && (kind != 11 || parentKind != 5) && (parentKind == 0) != (kind == 5 || kind == 9 || kind == 11 || kind == 6)) {
      Log_error(context->log, node->range, (const uint16_t *)__string_111_This_statement_is_not_allowed_he);
    }
  }
  ...
  if (kind == 5 || kind == 9) {
    ...
    if (Node_isOperator(node)) {
      if (string_op_equals(symbol->name, (const uint16_t *)__string_112) || string_op_equals(symbol->name, (const uint16_t *)__string_113)) {
        if (node->firstChild == Node_functionReturnType(node)) {
          symbol->flags = 8;
          symbol->rename = string_op_equals(symbol->name, (const uint16_t *)__string_114) ? (const uint16_t *)__string_115_op_positive : (const uint16_t *)__string_116_op_negative;
        }

        else {
          symbol->flags = 2;
          symbol->rename = string_op_equals(symbol->name, (const uint16_t *)__string_117) ? (const uint16_t *)__string_118_op_add : (const uint16_t *)__string_119_op_subtract;
        }
      }

      else {
        symbol->rename = string_op_equals(symbol->name, (const uint16_t *)__string_120) ? (const uint16_t *)__string_121_op_remainder : string_op_equals(symbol->name, (const uint16_t *)__string_122) ? (const uint16_t *)__string_123_op_and : string_op_equals(symbol->name, (const uint16_t *)__string_124) ? (const uint16_t *)__string_125_op_multiply : string_op_equals(symbol->name, (const uint16_t *)__string_126) ? (const uint16_t *)__string_127_op_exponent : string_op_equals(symbol->name, (const uint16_t *)__string_128) ? (const uint16_t *)__string_129_op_increment : string_op_equals(symbol->name, (const uint16_t *)__string_130) ? (const uint16_t *)__string_131_op_decrement : string_op_equals(symbol->name, (const uint16_t *)__string_132) ? (const uint16_t *)__string_133_op_divide : string_op_equals(symbol->name, (const uint16_t *)__string_134) ? (const uint16_t *)__string_135_op_lessThan : string_op_equals(symbol->name, (const uint16_t *)__string_136) ? (const uint16_t *)__string_137_op_shiftLeft : string_op_equals(symbol->name, (const uint16_t *)__string_138) ? (const uint16_t *)__string_139_op_equals : string_op_equals(symbol->name, (const uint16_t *)__string_140) ? (const uint16_t *)__string_141_op_greaterThan : string_op_equals(symbol->name, (const uint16_t *)__string_142) ? (const uint16_t *)__string_143_op_shiftRight : string_op_equals(symbol->name, (const uint16_t *)__string_144) ? (const uint16_t *)__string_145_op_get : string_op_equals(symbol->name, (const uint16_t *)__string_146) ? (const uint16_t *)__string_147_op_set : string_op_equals(symbol->name, (const uint16_t *)__string_148) ? (const uint16_t *)__string_149_op_xor : string_op_equals(symbol->name, (const uint16_t *)__string_150) ? (const uint16_t *)__string_151_op_or : string_op_equals(symbol->name, (const uint16_t *)__string_152) ? (const uint16_t *)__string_153_op_complement : NULL;
      }
    }
    ...
    if (symbol->kind == 4) {
      ...
      Node_insertChildBefore(node, node->firstChild, createVariable((const uint16_t *)__string_154_this, createType(parent->resolvedType), NULL));
    }
  }
  ...
  if (kind == 0 && mode == 1) {
    context->boolType = Scope_findLocal(parentScope, (const uint16_t *)__string_155_bool, 0)->resolvedType;
    context->byteType = Scope_findLocal(parentScope, (const uint16_t *)__string_156_byte, 0)->resolvedType;
    context->intType = Scope_findLocal(parentScope, (const uint16_t *)__string_157_int, 0)->resolvedType;
    context->sbyteType = Scope_findLocal(parentScope, (const uint16_t *)__string_158_sbyte, 0)->resolvedType;
    context->shortType = Scope_findLocal(parentScope, (const uint16_t *)__string_159_short, 0)->resolvedType;
    context->stringType = Scope_findLocal(parentScope, (const uint16_t *)__string_160_string, 0)->resolvedType;
    context->uintType = Scope_findLocal(parentScope, (const uint16_t *)__string_161_uint, 0)->resolvedType;
    context->ushortType = Scope_findLocal(parentScope, (const uint16_t *)__string_162_ushort, 0)->resolvedType;
...
static void initializeSymbol(struct CheckContext *context, struct Symbol *symbol) {
  ...
  forbidFlag(context, node, 2, (const uint16_t *)__string_163_Unsupported_flag_export);
  forbidFlag(context, node, 128, (const uint16_t *)__string_164_Unsupported_flag_protected);
  forbidFlag(context, node, 1024, (const uint16_t *)__string_165_Unsupported_flag_static);

  if (symbol->kind == 0 || symbol->kind == 3) {
    forbidFlag(context, node, 8, (const uint16_t *)__string_166_Cannot_use_get_on_a_class);
    forbidFlag(context, node, 512, (const uint16_t *)__string_167_Cannot_use_set_on_a_class);
    forbidFlag(context, node, 256, (const uint16_t *)__string_168_Cannot_use_public_on_a_class);
    forbidFlag(context, node, 64, (const uint16_t *)__string_169_Cannot_use_private_on_a_class);
  }

  else if (symbol->kind == 1) {
    forbidFlag(context, node, 8, (const uint16_t *)__string_170_Cannot_use_get_on_an_enum);
    forbidFlag(context, node, 512, (const uint16_t *)__string_171_Cannot_use_set_on_an_enum);
    forbidFlag(context, node, 256, (const uint16_t *)__string_172_Cannot_use_public_on_an_enum);
    forbidFlag(context, node, 64, (const uint16_t *)__string_173_Cannot_use_private_on_an_enum);
    symbol->resolvedType = calloc(1, sizeof(struct Type));
    symbol->resolvedType->symbol = symbol;
    ...
    if (symbol->kind != 4) {
      forbidFlag(context, node, 8, (const uint16_t *)__string_174_Cannot_use_get_here);
      forbidFlag(context, node, 512, (const uint16_t *)__string_175_Cannot_use_set_here);
      forbidFlag(context, node, 256, (const uint16_t *)__string_176_Cannot_use_public_here);
      forbidFlag(context, node, 64, (const uint16_t *)__string_177_Cannot_use_private_here);
    }

    else if (Node_isGet(node)) {
      forbidFlag(context, node, 512, (const uint16_t *)__string_178_Cannot_use_both_get_and_set);

      if (argumentCount != 1) {
        Log_error(context->log, symbol->range, (const uint16_t *)__string_179_Getters_must_not_have_any_argume);
      }
    }

    else if (Node_isSet(node)) {
      symbol->rename = StringBuilder_finish(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_180_set_), symbol->name));

      if (argumentCount != 2) {
        Log_error(context->log, symbol->range, (const uint16_t *)__string_181_Setters_must_have_exactly_one_ar);
      }
    }

    else if (Node_isOperator(node)) {
      if (string_op_equals(symbol->name, (const uint16_t *)__string_182) || string_op_equals(symbol->name, (const uint16_t *)__string_183) || string_op_equals(symbol->name, (const uint16_t *)__string_184)) {
        if (argumentCount != 1) {
          Log_error(context->log, symbol->range, StringBuilder_finish(StringBuilder_append(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_185_Operator), symbol->name), (const uint16_t *)__string_186_must_not_have_any_arguments)));
        }
      }

      else if (string_op_equals(symbol->name, (const uint16_t *)__string_187) || string_op_equals(symbol->name, (const uint16_t *)__string_188)) {
        if (argumentCount > 2) {
          Log_error(context->log, symbol->range, StringBuilder_finish(StringBuilder_append(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_189_Operator), symbol->name), (const uint16_t *)__string_190_must_have_at_most_one_argument)));
        }
      }

      else if (string_op_equals(symbol->name, (const uint16_t *)__string_191)) {
        if (argumentCount < 2) {
          Log_error(context->log, symbol->range, (const uint16_t *)__string_192_Operator_must_have_at_leas);
        }
      }

      else if (argumentCount != 2) {
        Log_error(context->log, symbol->range, StringBuilder_finish(StringBuilder_append(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_193_Operator), symbol->name), (const uint16_t *)__string_194_must_have_exactly_one_argument)));
      }
    }
    ...
    if (symbol->kind == 4) {
      ...
      forbidFlag(context, node, 4, (const uint16_t *)__string_195_Cannot_use_extern_on_an_instan);
      forbidFlag(context, node, 1, (const uint16_t *)__string_196_Cannot_use_declare_on_an_insta);
      ...
      if (Node_isDeclare(parent->node)) {
        ...
        if (body == NULL) {
          Log_error(context->log, node->lastChild->range, (const uint16_t *)__string_197_Must_implement_this_function);
        }
      ...
      if (shouldConvertInstanceToGlobal) {
        ...
        assert(string_op_equals(node->firstChild->symbol->name, (const uint16_t *)__string_198_this));
        node->firstChild->symbol->rename = (const uint16_t *)__string_199___this;
      }
    }

    else if (body == NULL) {
      forbidFlag(context, node, 4, (const uint16_t *)__string_200_Cannot_use_extern_on_an_unimpl);
      requireFlag(context, node, 1, (const uint16_t *)__string_201_Declared_functions_must_be_prefi);
    }

    else {
      forbidFlag(context, node, 1, (const uint16_t *)__string_202_Cannot_use_declare_on_a_functi);
    }
    ...
    forbidFlag(context, node, 8, (const uint16_t *)__string_203_Cannot_use_get_on_a_variable);
    forbidFlag(context, node, 512, (const uint16_t *)__string_204_Cannot_use_set_on_a_variable);
    ...
    if (symbol->kind != 9) {
      forbidFlag(context, node, 256, (const uint16_t *)__string_205_Cannot_use_public_here);
      forbidFlag(context, node, 64, (const uint16_t *)__string_206_Cannot_use_private_here);
    }
    ...
    if (type != NULL) {
      ...
      Log_error(context->log, node->internalRange, (const uint16_t *)__string_207_Cannot_create_untyped_variables);
      symbol->resolvedType = context->errorType;
    }

    if (symbol->resolvedType == context->voidType || symbol->resolvedType == context->nullType) {
      Log_error(context->log, node->internalRange, StringBuilder_finish(StringBuilder_appendChar(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_208_Cannot_create_a_variable_with_ty), Type_toString(symbol->resolvedType)), 39)));
      symbol->resolvedType = context->errorType;
    }
    ...
    if (symbol->kind == 7) {
      if (value != NULL) {
        ...
        if (value->kind == 24 || value->kind == 18) {
          ...
          Log_error(context->log, value->range, (const uint16_t *)__string_209_Invalid_constant_initializer);
          symbol->resolvedType = context->errorType;
        }
      }
        ...
        Log_error(context->log, node->internalRange, (const uint16_t *)__string_210_Constants_must_be_initialized);
      }
    }
    ...
    if (symbol->scope->symbol == NULL) {
      ...
      while (scope != NULL) {
        ...
        if (shadowed != NULL) {
          Log_error(context->log, node->internalRange, StringBuilder_finish(StringBuilder_append(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_211_The_symbol), symbol->name), (const uint16_t *)__string_212_shadows_another_symbol_with_th)));
...
static void resolveAsExpression(struct CheckContext *context, struct Node *node, struct Scope *parentScope) {
  ...
  if (node->resolvedType != context->errorType) {
    if (Node_isType(node)) {
      Log_error(context->log, node->range, (const uint16_t *)__string_213_Expected_expression_but_found_ty);
      node->resolvedType = context->errorType;
    }

    else if (node->resolvedType == context->voidType && node->parent->kind != 10) {
      Log_error(context->log, node->range, (const uint16_t *)__string_214_This_expression_does_not_return);
      node->resolvedType = context->errorType;
    }
  }
}
...
static void resolveAsType(struct CheckContext *context, struct Node *node, struct Scope *parentScope) {
  ...
  if (node->resolvedType != context->errorType && !Node_isType(node)) {
    Log_error(context->log, node->range, (const uint16_t *)__string_215_Expected_type_but_found_expressi);
    node->resolvedType = context->errorType;
  }
}
...
static void checkConversion(struct CheckContext *context, struct Node *node, struct Type *to, int32_t kind) {
  if (!canConvert(context, node, to, kind)) {
    Log_error(context->log, node->range, StringBuilder_finish(StringBuilder_append(StringBuilder_append(StringBuilder_append(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_216_Cannot_convert_from_type), Type_toString(node->resolvedType)), (const uint16_t *)__string_217_to_type), Type_toString(to)), kind == 0 && canConvert(context, node, to, 1) ? (const uint16_t *)__string_218_without_a_cast : (const uint16_t *)__string_219)));
    node->resolvedType = context->errorType;
  }
}
...
static void checkStorage(struct CheckContext *context, struct Node *target) {
  ...
  if (target->resolvedType != context->errorType && target->kind != 23 && target->kind != 35 && ((target->kind != 25 && target->kind != 21) || (target->symbol != NULL && (!isVariable(target->symbol->kind) || target->symbol->kind == 7)))) {
    Log_error(context->log, target->range, (const uint16_t *)__string_220_Cannot_store_to_this_location);
...
static uint8_t isSymbolAccessAllowed(struct CheckContext *context, struct Symbol *symbol, struct Node *node, struct Range *range) {
  if (Symbol_isUnsafe(symbol) && !context->isUnsafeAllowed) {
    Log_error(context->log, range, StringBuilder_finish(StringBuilder_append(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_221_Cannot_use_symbol), symbol->name), (const uint16_t *)__string_222_outside_an_unsafe_block)));
  ...
  if (symbol->node != NULL && Node_isPrivate(symbol->node)) {
    ...
    if (parent != NULL && context->enclosingClass != parent) {
      Log_error(context->log, range, StringBuilder_finish(StringBuilder_append(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_223_Cannot_access_private_symbol), symbol->name), (const uint16_t *)__string_224_here)));
  ...
  if (isFunction(symbol->kind) && (Symbol_isSetter(symbol) ? !Node_isAssignTarget(node) : !Node_isCallValue(node))) {
    if (Symbol_isSetter(symbol)) {
      Log_error(context->log, range, StringBuilder_finish(StringBuilder_append(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_225_Cannot_use_setter), symbol->name), (const uint16_t *)__string_226_here)));
    }

    else {
      Log_error(context->log, range, StringBuilder_finish(StringBuilder_appendChar(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_227_Must_call_function), symbol->name), 39)));
    }
  ...
  if (kind == 0 || kind == 1) {
    ...
    if (value != NULL) {
      ...
      if (symbol->kind == 8 && value->kind != 24 && value->kind != 18 && value->kind != 27) {
        Log_error(context->log, value->range, (const uint16_t *)__string_228_Global_initializers_must_be_comp);
      }
    }
    ...
    if (!found) {
      Log_error(context->log, node->range, (const uint16_t *)__string_229_Cannot_use_this_statement_outsid);
    }
  }
    ...
    if (type != context->errorType) {
      struct Symbol *symbol = Type_hasInstanceMembers(type) ? Type_findMember(type, (const uint16_t *)__string_230, 0) : NULL;

      if (symbol == NULL) {
        Log_error(context->log, node->internalRange, StringBuilder_finish(StringBuilder_appendChar(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_231_Cannot_index_into_type), Type_toString(target->resolvedType)), 39)));
      }
    ...
    struct Symbol *symbol = Scope_findNested(parentScope, (const uint16_t *)__string_232_this, 0, 0);

    if (symbol == NULL) {
      Log_error(context->log, node->range, (const uint16_t *)__string_233_Cannot_use_this_here);
    }
    ...
    if (symbol == NULL) {
      struct StringBuilder *builder = StringBuilder_append(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_234_No_symbol_named), name), (const uint16_t *)__string_235_here);
      symbol = Scope_findNested(parentScope, name, 0, 1);

      if (symbol != NULL) {
        StringBuilder_append(StringBuilder_append(StringBuilder_append(builder, (const uint16_t *)__string_236_did_you_mean_this), symbol->name), (const uint16_t *)__string_237);
      }

      else if (string_op_equals(name, (const uint16_t *)__string_238_number)) {
        StringBuilder_append(builder, (const uint16_t *)__string_239_did_you_mean_int);
      }

      else if (string_op_equals(name, (const uint16_t *)__string_240_boolean)) {
        StringBuilder_append(builder, (const uint16_t *)__string_241_did_you_mean_bool);
      }
      ...
      Log_error(context->log, node->range, StringBuilder_finish(StringBuilder_append(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_242_Cyclic_reference_to_symbol), name), (const uint16_t *)__string_243_here)));
    }
    ...
    if (target->resolvedType != context->errorType) {
      if ((Node_isType(target) && Type_isEnum(target->resolvedType)) || (!Node_isType(target) && Type_hasInstanceMembers(target->resolvedType))) {
        ...
        if (string_length(name) > 0) {
          ...
          if (symbol == NULL) {
            Log_error(context->log, node->internalRange, StringBuilder_finish(StringBuilder_appendChar(StringBuilder_append(StringBuilder_append(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_244_No_member_named), name), (const uint16_t *)__string_245_on_type), Type_toString(target->resolvedType)), 39)));
          }
        ...
        Log_error(context->log, node->internalRange, StringBuilder_finish(StringBuilder_append(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_246_The_type), Type_toString(target->resolvedType)), (const uint16_t *)__string_247_has_no_members)));
      }
    }
  }
    ...
    if (value->resolvedType != context->errorType) {
      ...
      if (symbol == NULL || !isFunction(symbol->kind)) {
        Log_error(context->log, value->range, StringBuilder_finish(StringBuilder_appendChar(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_248_Cannot_call_value_of_type), Type_toString(value->resolvedType)), 39)));
      }
        ...
        if (argumentVariable != returnType) {
          Log_error(context->log, node->internalRange, StringBuilder_finish(StringBuilder_appendChar(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_249_Not_enough_arguments_for_functio), symbol->name), 39)));
        }
          ...
          Log_error(context->log, node->internalRange, StringBuilder_finish(StringBuilder_appendChar(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_250_Too_many_arguments_for_function), symbol->name), 39)));
        }
    ...
    if (value != NULL) {
      ...
      if (context->currentReturnType != NULL) {
        if (context->currentReturnType != context->voidType) {
          ...
          Log_error(context->log, value->range, (const uint16_t *)__string_251_Unexpected_return_value_in_funct);
        }
      }
    }

    else if (context->currentReturnType != NULL && context->currentReturnType != context->voidType) {
      Log_error(context->log, node->range, StringBuilder_finish(StringBuilder_appendChar(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_252_Expected_return_value_in_functio), Type_toString(context->currentReturnType)), 39)));
    }
  }
    ...
    if (yes->resolvedType != commonType && (yes->resolvedType != context->nullType || !Type_isReference(commonType)) && no->resolvedType != commonType && (no->resolvedType != context->nullType || !Type_isReference(commonType))) {
      Log_error(context->log, spanRanges(yes->range, no->range), StringBuilder_finish(StringBuilder_appendChar(StringBuilder_append(StringBuilder_append(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_253_Type), Type_toString(yes->resolvedType)), (const uint16_t *)__string_254_is_not_the_same_as_type), Type_toString(no->resolvedType)), 39)));
    }
    ...
    if (left->kind == 23) {
      ...
      if (type != context->errorType) {
        struct Symbol *symbol = Type_hasInstanceMembers(type) ? Type_findMember(type, (const uint16_t *)__string_255, 0) : NULL;

        if (symbol == NULL) {
          Log_error(context->log, left->internalRange, StringBuilder_finish(StringBuilder_appendChar(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_256_Cannot_index_into_type), Type_toString(target->resolvedType)), 39)));
        }
    ...
    if (type->resolvedType != context->errorType) {
      if (!Type_isClass(type->resolvedType)) {
        Log_error(context->log, type->range, StringBuilder_finish(StringBuilder_appendChar(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_257_Cannot_construct_type), Type_toString(type->resolvedType)), 39)));
      }
    ...
    if (type->nextSibling != NULL) {
      Log_error(context->log, node->internalRange, (const uint16_t *)__string_258_Constructors_with_arguments_are);
    }
  }
    ...
    if (context->target == 2) {
      Log_error(context->log, node->internalRange, (const uint16_t *)__string_259_Cannot_use_pointers_when_compili);
    }

    else if (!context->isUnsafeAllowed) {
      Log_error(context->log, node->internalRange, (const uint16_t *)__string_260_Cannot_use_pointers_outside_an);
    }
      ...
      if (type != context->errorType) {
        if (!Type_isInteger(type) && type->pointerTo == NULL) {
          Log_error(context->log, node->internalRange, StringBuilder_finish(StringBuilder_appendChar(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_261_Cannot_create_a_pointer_to_non_i), Type_toString(type)), 39)));
        }
    ...
    if (type != context->errorType) {
      if (type->pointerTo == NULL) {
        Log_error(context->log, node->internalRange, StringBuilder_finish(StringBuilder_appendChar(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_262_Cannot_dereference_type), Type_toString(type)), 39)));
      }
    ...
    struct Node *value = Node_unaryValue(node);
    resolveAsExpression(context, value, parentScope);
    Log_error(context->log, node->internalRange, (const uint16_t *)__string_263_The_address_of_operator_is_not_s);
  }
    ...
    if (kind == 37) {
      ...
      if (symbol != NULL) {
        ...
        Log_error(context->log, node->internalRange, StringBuilder_finish(StringBuilder_appendChar(StringBuilder_append(StringBuilder_append(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_264_Cannot_use_unary_operator), name), (const uint16_t *)__string_265_with_type), Type_toString(value->resolvedType)), 39)));
      }
    }
  }
    ...
    if (kind == 57 || kind == 56) {
      ...
      if (leftType != rightType) {
        Log_error(context->log, node->internalRange, StringBuilder_finish(StringBuilder_appendChar(StringBuilder_append(StringBuilder_append(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_266_Cannot_compare_type), Type_toString(leftType)), (const uint16_t *)__string_267_with_type), Type_toString(rightType)), 39)));
      }
    }
      ...
      if (kind == 44 || kind == 63 || kind == 58 || kind == 49 || kind == 60 || kind == 46 || kind == 47 || kind == 48 || kind == 61 || kind == 62) {
        ...
        Log_error(context->log, node->internalRange, (const uint16_t *)__string_268_This_operator_is_not_currently_s);
      }
    }

    else if (leftType != context->errorType) {
      const uint16_t *name = Range_toString(node->internalRange);
      struct Symbol *symbol = Type_findMember(leftType, kind == 59 ? (const uint16_t *)__string_269 : kind == 55 ? (const uint16_t *)__string_270 : kind == 53 ? (const uint16_t *)__string_271 : name, 4);
      ...
      if (symbol != NULL) {
        ...
        if (leftType != context->errorType && rightType != context->errorType && leftType != rightType && !canConvert(context, right, leftType, 0) && !canConvert(context, left, rightType, 0)) {
          Log_error(context->log, node->internalRange, StringBuilder_finish(StringBuilder_appendChar(StringBuilder_append(StringBuilder_append(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_272_Cannot_compare_type), Type_toString(leftType)), (const uint16_t *)__string_273_with_type), Type_toString(rightType)), 39)));
        }
      }

      else {
        Log_error(context->log, node->internalRange, StringBuilder_finish(StringBuilder_appendChar(StringBuilder_append(StringBuilder_append(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_274_Cannot_use_binary_operator), name), (const uint16_t *)__string_275_with_type), Type_toString(leftType)), 39)));
      }
    }
  }
...
static void Compiler_initialize(struct Compiler *__this, int32_t target, const uint16_t *outputName) {
  ...
  __this->librarySource = Compiler_addInput(__this, (const uint16_t *)__string_276_native, library());
  __this->librarySource->isLibrary = 1;
  Compiler_createGlobals(__this);

  if (target == 1) {
    Preprocessor_define(__this->preprocessor, (const uint16_t *)__string_277_C, 1);
  }

  else if (target == 2) {
    Preprocessor_define(__this->preprocessor, (const uint16_t *)__string_278_JS, 1);
  }

  else if (target == 3) {
    Preprocessor_define(__this->preprocessor, (const uint16_t *)__string_279_WASM, 1);
  }
}
...
static void Compiler_createGlobals(struct Compiler *__this) {
  ...
  struct Scope *scope = calloc(1, sizeof(struct Scope));
  global->scope = scope;
  context->errorType = Scope_defineNativeType(scope, context->log, (const uint16_t *)__string_280_error);
  context->nullType = Scope_defineNativeType(scope, context->log, (const uint16_t *)__string_281_null);
  context->voidType = Scope_defineNativeType(scope, context->log, (const uint16_t *)__string_282_void);
...
static uint8_t Compiler_finish(struct Compiler *__this) {
  ...
  Profiler_end((const uint16_t *)__string_283_lexing);
  Profiler_begin();
  ...
  Profiler_end((const uint16_t *)__string_284_preprocessing);
  Profiler_begin();
  source = __this->firstSource;
  ...
  Profiler_end((const uint16_t *)__string_285_parsing);
  Profiler_begin();
  ...
  Profiler_end((const uint16_t *)__string_286_checking);
  ...
  Profiler_begin();
  treeShaking(global);
  Profiler_end((const uint16_t *)__string_287_shaking);
  Profiler_begin();
  ...
  Profiler_end((const uint16_t *)__string_288_emitting);
...
static const uint16_t *replaceFileExtension(const uint16_t *path, const uint16_t *extension) {
  struct StringBuilder *builder = StringBuilder_new();
  int32_t dot = string_lastIndexOf(path, (const uint16_t *)__string_289);
  int32_t forward = string_lastIndexOf(path, (const uint16_t *)__string_290);
  int32_t backward = string_lastIndexOf(path, (const uint16_t *)__string_291);
...
static void JsResult_emitIndent(struct JsResult *__this) {
  ...
  while (i > 0) {
    StringBuilder_append(__this->code, (const uint16_t *)__string_292);
    i = i - 1;
  }
}
...
static void JsResult_emitBlock(struct JsResult *__this, struct Node *node) {
  __this->previousNode = NULL;
  StringBuilder_append(__this->code, (const uint16_t *)__string_293);
  __this->indent = __this->indent + 1;
...
static void JsResult_emitUnary(struct JsResult *__this, struct Node *node, int32_t parentPrecedence, const uint16_t *operator) {
  ...
  if (shouldCastToInt) {
    StringBuilder_append(code, isUnsigned ? (const uint16_t *)__string_294_0 : (const uint16_t *)__string_295_0);
  }
...
static void JsResult_emitBinary(struct JsResult *__this, struct Node *node, int32_t parentPrecedence, const uint16_t *operator, int32_t operatorPrecedence, int32_t mode) {
  ...
  if (shouldCastToInt) {
    StringBuilder_append(code, isUnsigned ? (const uint16_t *)__string_296_0 : (const uint16_t *)__string_297_0);
  }
...
static void JsResult_emitCommaSeparatedExpressions(struct JsResult *__this, struct Node *start, struct Node *stop) {
  while (start != stop) {
    ...
    if (start != stop) {
      StringBuilder_append(__this->code, (const uint16_t *)__string_298);
    }
  }
}
...
static void JsResult_emitExpression(struct JsResult *__this, struct Node *node, int32_t parentPrecedence) {
  ...
  if (node->kind == 25) {
    ...
    if (symbol->kind == 5 && Node_isDeclare(symbol->node)) {
      StringBuilder_append(code, (const uint16_t *)__string_299___declare);
    }
    ...
    StringBuilder_append(code, (const uint16_t *)__string_300_null);
  }

  else if (node->kind == 18) {
    StringBuilder_append(code, node->intValue != 0 ? (const uint16_t *)__string_301_true : (const uint16_t *)__string_302_false);
  }
    ...
    if (from == type || fromSize < typeSize) {
      ...
      StringBuilder_append(code, (const uint16_t *)__string_303);
      StringBuilder_append(code, shift);
      StringBuilder_append(code, (const uint16_t *)__string_304);
      StringBuilder_append(code, shift);
      ...
      StringBuilder_append(code, (const uint16_t *)__string_305);
      ...
      StringBuilder_append(code, (const uint16_t *)__string_306_0);
      ...
      JsResult_emitExpression(__this, value, 9);
      StringBuilder_append(code, (const uint16_t *)__string_307_0);
    ...
    StringBuilder_append(code, (const uint16_t *)__string_310_new);
    JsResult_emitExpression(__this, Node_newType(node), 14);
    StringBuilder_append(code, (const uint16_t *)__string_311);
  }
    ...
    if (invertedKind != value->kind) {
      ...
      JsResult_emitUnary(__this, node, parentPrecedence, (const uint16_t *)__string_312);
    }
  }

  else if (node->kind == 34) {
    JsResult_emitUnary(__this, node, parentPrecedence, (const uint16_t *)__string_313);
  }

  else if (node->kind == 36) {
    JsResult_emitUnary(__this, node, parentPrecedence, (const uint16_t *)__string_314);
  }

  else if (node->kind == 39) {
    JsResult_emitUnary(__this, node, parentPrecedence, (const uint16_t *)__string_315);
  }
    ...
    JsResult_emitBinary(__this, node, parentPrecedence, (const uint16_t *)__string_320, 10, 1);
  }

  else if (node->kind == 45) {
    JsResult_emitBinary(__this, node, parentPrecedence, (const uint16_t *)__string_321, 1, 0);
  }

  else if (node->kind == 46) {
    JsResult_emitBinary(__this, node, parentPrecedence, (const uint16_t *)__string_322, 6, 0);
  }

  else if (node->kind == 47) {
    JsResult_emitBinary(__this, node, parentPrecedence, (const uint16_t *)__string_323, 4, 0);
  }

  else if (node->kind == 48) {
    JsResult_emitBinary(__this, node, parentPrecedence, (const uint16_t *)__string_324, 5, 0);
  }

  else if (node->kind == 49) {
    JsResult_emitBinary(__this, node, parentPrecedence, (const uint16_t *)__string_325, 11, 1);
  }

  else if (node->kind == 50) {
    JsResult_emitBinary(__this, node, parentPrecedence, (const uint16_t *)__string_326, 7, 0);
  }

  else if (node->kind == 52) {
    JsResult_emitBinary(__this, node, parentPrecedence, (const uint16_t *)__string_327, 8, 0);
  }

  else if (node->kind == 53) {
    JsResult_emitBinary(__this, node, parentPrecedence, (const uint16_t *)__string_328, 8, 0);
  }

  else if (node->kind == 54) {
    JsResult_emitBinary(__this, node, parentPrecedence, (const uint16_t *)__string_329, 8, 0);
  }

  else if (node->kind == 55) {
    JsResult_emitBinary(__this, node, parentPrecedence, (const uint16_t *)__string_330, 8, 0);
  }

  else if (node->kind == 56) {
    JsResult_emitBinary(__this, node, parentPrecedence, (const uint16_t *)__string_331, 3, 0);
  }

  else if (node->kind == 57) {
    JsResult_emitBinary(__this, node, parentPrecedence, (const uint16_t *)__string_332, 2, 0);
  }

  else if (node->kind == 59) {
    JsResult_emitBinary(__this, node, parentPrecedence, (const uint16_t *)__string_333, 7, 0);
  }

  else if (node->kind == 60) {
    JsResult_emitBinary(__this, node, parentPrecedence, (const uint16_t *)__string_334, 11, 1);
  }

  else if (node->kind == 61) {
    JsResult_emitBinary(__this, node, parentPrecedence, (const uint16_t *)__string_335, 9, 0);
  }

  else if (node->kind == 62) {
    JsResult_emitBinary(__this, node, parentPrecedence, Node_isUnsignedOperator(node) ? (const uint16_t *)__string_336 : (const uint16_t *)__string_337, 9, 0);
  }

  else if (node->kind == 63) {
    JsResult_emitBinary(__this, node, parentPrecedence, (const uint16_t *)__string_338, 10, 1);
  }
    ...
    StringBuilder_append(code, (const uint16_t *)__string_339___imul);
    ...
    if (isUnsigned) {
      StringBuilder_append(code, (const uint16_t *)__string_341_0);
...
static void JsResult_emitStatement(struct JsResult *__this, struct Node *node) {
  ...
  if (node->kind == 11) {
    ...
    if (symbol->kind == 4) {
      ...
      StringBuilder_append(code, (const uint16_t *)__string_342_prototype);
      JsResult_emitSymbolName(__this, symbol);
      StringBuilder_append(code, (const uint16_t *)__string_343_function);
      needsSemicolon = 1;
    }

    else if (Node_isExtern(node)) {
      StringBuilder_append(code, (const uint16_t *)__string_344_var);
      JsResult_emitSymbolName(__this, symbol);
      StringBuilder_append(code, (const uint16_t *)__string_345___extern);
      JsResult_emitSymbolName(__this, symbol);
      StringBuilder_append(code, (const uint16_t *)__string_346_function);
      needsSemicolon = 1;
    }
    ...
    while (child != returnType) {
      ...
      if (child != returnType) {
        StringBuilder_append(code, (const uint16_t *)__string_348);
      }
    }

    StringBuilder_append(code, (const uint16_t *)__string_349);
    JsResult_emitBlock(__this, Node_functionBody(node));
    StringBuilder_append(code, needsSemicolon ? (const uint16_t *)__string_350 : (const uint16_t *)__string_351);
    ...
    while (1) {
      StringBuilder_append(code, (const uint16_t *)__string_352_if);
      ...
      JsResult_emitIndent(__this);
      StringBuilder_append(code, (const uint16_t *)__string_355_else);
    ...
    JsResult_emitNewlineBefore(__this, node);
    JsResult_emitIndent(__this);
    StringBuilder_append(code, (const uint16_t *)__string_356_while);
    ...
    JsResult_emitNewlineBefore(__this, node);
    JsResult_emitIndent(__this);
    StringBuilder_append(code, (const uint16_t *)__string_358_break);
    JsResult_emitNewlineAfter(__this, node);
  }
    ...
    JsResult_emitNewlineBefore(__this, node);
    JsResult_emitIndent(__this);
    StringBuilder_append(code, (const uint16_t *)__string_359_continue);
    JsResult_emitNewlineAfter(__this, node);
  }
    ...
    if (value != NULL) {
      StringBuilder_append(code, (const uint16_t *)__string_361_return);
      JsResult_emitExpression(__this, value, 0);
      StringBuilder_append(code, (const uint16_t *)__string_362);
    }

    else {
      StringBuilder_append(code, (const uint16_t *)__string_363_return);
    }
    ...
    JsResult_emitNewlineBefore(__this, node);
    JsResult_emitIndent(__this);
    StringBuilder_append(code, (const uint16_t *)__string_364_var);
    struct Node *child = node->firstChild;
    ...
    while (child != NULL) {
      ...
      if (child != NULL) {
        StringBuilder_append(code, (const uint16_t *)__string_365);
      }
    ...
    StringBuilder_append(code, (const uint16_t *)__string_367);
    JsResult_emitNewlineAfter(__this, node);
  }
    ...
    if (!Node_isDeclare(node)) {
      JsResult_emitNewlineBefore(__this, node);
      JsResult_emitIndent(__this);
      StringBuilder_append(code, (const uint16_t *)__string_368_function);
      JsResult_emitSymbolName(__this, node->symbol);
      ...
      while (argument != NULL) {
        if (argument->kind == 2) {
          JsResult_emitIndent(__this);
          StringBuilder_append(code, (const uint16_t *)__string_370_this);
          ...
          StringBuilder_append(code, (const uint16_t *)__string_372);
        }
    ...
    if (Node_isExtern(node)) {
      JsResult_emitNewlineBefore(__this, node);
      JsResult_emitIndent(__this);
      StringBuilder_append(code, (const uint16_t *)__string_374___extern);
      JsResult_emitSymbolName(__this, node->symbol);
      ...
      while (child != NULL) {
        ...
        StringBuilder_append(code, int_toString(child->symbol->offset));
        child = child->nextSibling;
        StringBuilder_append(code, child != NULL ? (const uint16_t *)__string_377 : (const uint16_t *)__string_378);
      }
...
static void jsEmit(struct Compiler *compiler) {
  ...
  result->context = compiler->context;
  result->code = code;
  StringBuilder_append(code, (const uint16_t *)__string_380_function___declare___extern);
  result->indent = 1;
  ...
  if (result->foundMultiply) {
    ...
    StringBuilder_append(code, (const uint16_t *)__string_381_var___imul_Math_imul_functi);
    result->indent = 2;
    JsResult_emitIndent(result);
    StringBuilder_append(code, (const uint16_t *)__string_382_return_a_b_16_16);
    result->indent = 1;
    JsResult_emitIndent(result);
    StringBuilder_append(code, (const uint16_t *)__string_383);
  }

  StringBuilder_append(code, (const uint16_t *)__string_384);
  JsResult_emitIndent(result);
  StringBuilder_append(code, (const uint16_t *)__string_385_typeof_global_undefined);
  JsResult_emitIndent(result);
  StringBuilder_append(code, (const uint16_t *)__string_386_typeof_exports_undefined);
...
static const uint16_t *tokenToString(int32_t token) {
  if (token == 0) {
    return (const uint16_t *)__string_388_end_of_file;
  }

  if (token == 1) {
    return (const uint16_t *)__string_389_character_literal;
  }

  if (token == 2) {
    return (const uint16_t *)__string_390_identifier;
  }

  if (token == 3) {
    return (const uint16_t *)__string_391_integer_literal;
  }

  if (token == 4) {
    return (const uint16_t *)__string_392_string_literal;
  }
  ...
  if (token == 40) {
    return (const uint16_t *)__string_428_alignof;
  }

  if (token == 41) {
    return (const uint16_t *)__string_429_as;
  }

  if (token == 42) {
    return (const uint16_t *)__string_430_break;
  }

  if (token == 43) {
    return (const uint16_t *)__string_431_class;
  }

  if (token == 44) {
    return (const uint16_t *)__string_432_const;
  }

  if (token == 45) {
    return (const uint16_t *)__string_433_continue;
  }

  if (token == 46) {
    return (const uint16_t *)__string_434_declare;
  }

  if (token == 47) {
    return (const uint16_t *)__string_435_else;
  }

  if (token == 48) {
    return (const uint16_t *)__string_436_enum;
  }

  if (token == 49) {
    return (const uint16_t *)__string_437_export;
  }

  if (token == 50) {
    return (const uint16_t *)__string_438_extends;
  }

  if (token == 51) {
    return (const uint16_t *)__string_439_extern;
  }

  if (token == 52) {
    return (const uint16_t *)__string_440_false;
  }

  if (token == 53) {
    return (const uint16_t *)__string_441_function;
  }

  if (token == 54) {
    return (const uint16_t *)__string_442_if;
  }

  if (token == 55) {
    return (const uint16_t *)__string_443_implements;
  }

  if (token == 56) {
    return (const uint16_t *)__string_444_import;
  }

  if (token == 57) {
    return (const uint16_t *)__string_445_interface;
  }

  if (token == 58) {
    return (const uint16_t *)__string_446_let;
  }

  if (token == 59) {
    return (const uint16_t *)__string_447_new;
  }

  if (token == 60) {
    return (const uint16_t *)__string_448_null;
  }

  if (token == 61) {
    return (const uint16_t *)__string_449_operator;
  }

  if (token == 62) {
    return (const uint16_t *)__string_450_private;
  }

  if (token == 63) {
    return (const uint16_t *)__string_451_protected;
  }

  if (token == 64) {
    return (const uint16_t *)__string_452_public;
  }

  if (token == 65) {
    return (const uint16_t *)__string_453_return;
  }

  if (token == 66) {
    return (const uint16_t *)__string_454_sizeof;
  }

  if (token == 67) {
    return (const uint16_t *)__string_455_static;
  }

  if (token == 68) {
    return (const uint16_t *)__string_456_this;
  }

  if (token == 69) {
    return (const uint16_t *)__string_457_true;
  }

  if (token == 70) {
    return (const uint16_t *)__string_458_unsafe;
  }

  if (token == 71) {
    return (const uint16_t *)__string_459_var;
  }

  if (token == 72) {
    return (const uint16_t *)__string_460_while;
  }

  if (token == 73) {
    return (const uint16_t *)__string_461_define;
  }

  if (token == 74) {
    return (const uint16_t *)__string_462_elif;
  }

  if (token == 75) {
    return (const uint16_t *)__string_463_else;
  }

  if (token == 76) {
    return (const uint16_t *)__string_464_endif;
  }

  if (token == 77) {
    return (const uint16_t *)__string_465_error;
  }

  if (token == 78) {
    return (const uint16_t *)__string_466_if;
  }

  if (token == 80) {
    return (const uint16_t *)__string_467_newline;
  }

  if (token == 81) {
    return (const uint16_t *)__string_468_undef;
  }

  if (token == 82) {
    return (const uint16_t *)__string_469_warning;
  }
  ...
  while (i < limit) {
    ...
    if (c == 10) {
      ...
      if (length >= 2 && length <= 10) {
        ...
        if (length == 2) {
          if (string_op_equals(text, (const uint16_t *)__string_470_as)) {
            kind = 41;
          }

          else if (string_op_equals(text, (const uint16_t *)__string_471_if)) {
            kind = 54;
          }
        }

        else if (length == 3) {
          if (string_op_equals(text, (const uint16_t *)__string_472_let)) {
            kind = 58;
          }

          else if (string_op_equals(text, (const uint16_t *)__string_473_new)) {
            kind = 59;
          }

          else if (string_op_equals(text, (const uint16_t *)__string_474_var)) {
            kind = 71;
          }
        }

        else if (length == 4) {
          if (string_op_equals(text, (const uint16_t *)__string_475_else)) {
            kind = 47;
          }

          else if (string_op_equals(text, (const uint16_t *)__string_476_enum)) {
            kind = 48;
          }

          else if (string_op_equals(text, (const uint16_t *)__string_477_null)) {
            kind = 60;
          }

          else if (string_op_equals(text, (const uint16_t *)__string_478_this)) {
            kind = 68;
          }

          else if (string_op_equals(text, (const uint16_t *)__string_479_true)) {
            kind = 69;
          }
        }

        else if (length == 5) {
          if (string_op_equals(text, (const uint16_t *)__string_480_break)) {
            kind = 42;
          }

          else if (string_op_equals(text, (const uint16_t *)__string_481_class)) {
            kind = 43;
          }

          else if (string_op_equals(text, (const uint16_t *)__string_482_const)) {
            kind = 44;
          }

          else if (string_op_equals(text, (const uint16_t *)__string_483_false)) {
            kind = 52;
          }

          else if (string_op_equals(text, (const uint16_t *)__string_484_while)) {
            kind = 72;
          }
        }

        else if (length == 6) {
          if (string_op_equals(text, (const uint16_t *)__string_485_export)) {
            kind = 49;
          }

          else if (string_op_equals(text, (const uint16_t *)__string_486_extern)) {
            kind = 51;
          }

          else if (string_op_equals(text, (const uint16_t *)__string_487_import)) {
            kind = 56;
          }

          else if (string_op_equals(text, (const uint16_t *)__string_488_public)) {
            kind = 64;
          }

          else if (string_op_equals(text, (const uint16_t *)__string_489_return)) {
            kind = 65;
          }

          else if (string_op_equals(text, (const uint16_t *)__string_490_sizeof)) {
            kind = 66;
          }

          else if (string_op_equals(text, (const uint16_t *)__string_491_static)) {
            kind = 67;
          }

          else if (string_op_equals(text, (const uint16_t *)__string_492_unsafe)) {
            kind = 70;
          }
        }

        else if (length == 7) {
          if (string_op_equals(text, (const uint16_t *)__string_493_alignof)) {
            kind = 40;
          }

          else if (string_op_equals(text, (const uint16_t *)__string_494_declare)) {
            kind = 46;
          }

          else if (string_op_equals(text, (const uint16_t *)__string_495_extends)) {
            kind = 50;
          }

          else if (string_op_equals(text, (const uint16_t *)__string_496_private)) {
            kind = 62;
          }
        }

        else if (string_op_equals(text, (const uint16_t *)__string_497_continue)) {
          kind = 45;
        }

        else if (string_op_equals(text, (const uint16_t *)__string_498_function)) {
          kind = 53;
        }

        else if (string_op_equals(text, (const uint16_t *)__string_499_implements)) {
          kind = 55;
        }

        else if (string_op_equals(text, (const uint16_t *)__string_500_interface)) {
          kind = 57;
        }

        else if (string_op_equals(text, (const uint16_t *)__string_501_protected)) {
          kind = 63;
        }
      }
    }
      ...
      if (i < limit) {
        ...
        if (i < limit && (isAlpha(string_op_get(contents, i)) || isNumber(string_op_get(contents, i)))) {
          ...
          Log_error(log, createRange(source, start, i), StringBuilder_finish(StringBuilder_appendChar(StringBuilder_appendSlice(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_502_Invalid_integer_literal), contents, start, i), 39)));
      ...
      if (kind == 0) {
        Log_error(log, createRange(source, start, i), c == 39 ? (const uint16_t *)__string_503_Unterminated_character_literal : c == 96 ? (const uint16_t *)__string_504_Unterminated_template_literal : (const uint16_t *)__string_505_Unterminated_string_literal);
      ...
      if (i < limit && string_op_get(contents, i) == 42) {
        ...
        if (!foundEnd) {
          Log_error(log, createRange(source, start, start + 2), (const uint16_t *)__string_506_Unterminated_multi_line_comment);
      ...
      if (i < limit && string_op_get(contents, i) == 61) {
        ...
        if (i < limit && string_op_get(contents, i) == 61) {
          i = i + 1;
          Log_error(log, createRange(source, start, i), (const uint16_t *)__string_507_Use_instead_of);
        }
      }
    }
      ...
      if (i < limit && string_op_get(contents, i) == 61) {
        ...
        if (i < limit && string_op_get(contents, i) == 61) {
          i = i + 1;
          Log_error(log, createRange(source, start, i), (const uint16_t *)__string_508_Use_instead_of);
        }
      }
    }
      ...
      if (string_op_equals(text, (const uint16_t *)__string_509_define)) {
        kind = 73;
      }

      else if (string_op_equals(text, (const uint16_t *)__string_510_elif)) {
        kind = 74;
      }

      else if (string_op_equals(text, (const uint16_t *)__string_511_else)) {
        kind = 75;
      }

      else if (string_op_equals(text, (const uint16_t *)__string_512_endif)) {
        kind = 76;
      }

      else if (string_op_equals(text, (const uint16_t *)__string_513_error)) {
        kind = 77;
      }

      else if (string_op_equals(text, (const uint16_t *)__string_514_if)) {
        kind = 78;
      }

      else if (string_op_equals(text, (const uint16_t *)__string_515_undef)) {
        kind = 81;
      }

      else if (string_op_equals(text, (const uint16_t *)__string_516_warning)) {
        kind = 82;
      }

      else if (start == 0 && string_op_equals(text, (const uint16_t *)__string_517) && i < limit && string_op_get(contents, i) == 33) {
        while (i < limit && string_op_get(contents, i) != 10) {
          i = i + 1;
        }
        ...
        struct StringBuilder *builder = StringBuilder_appendChar(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_518_Invalid_preprocessor_token), text), 39);

        if (string_op_equals(text, (const uint16_t *)__string_519_ifdef)) {
          StringBuilder_append(builder, (const uint16_t *)__string_520_did_you_mean_if);
          kind = 78;
        }

        else if (string_op_equals(text, (const uint16_t *)__string_521_elsif) || string_op_equals(text, (const uint16_t *)__string_522_elseif)) {
          StringBuilder_append(builder, (const uint16_t *)__string_523_did_you_mean_elif);
          kind = 74;
        }

        else if (string_op_equals(text, (const uint16_t *)__string_524_end)) {
          StringBuilder_append(builder, (const uint16_t *)__string_525_did_you_mean_endif);
          kind = 76;
        }
      ...
      if (last != NULL && last->kind != 80) {
        ...
        if (j < end) {
          Log_error(log, createRange(source, start, i), StringBuilder_finish(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_526_Expected_newline_before), tokenToString(kind))));
        }
      }
    ...
    if (kind == 0) {
      Log_error(log, range, StringBuilder_finish(StringBuilder_appendChar(StringBuilder_appendSlice(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_527_Syntax_error), contents, start, start + 1), 39)));
...
static const uint16_t *library() {
  return (const uint16_t *)__string_528_if_WASM_These_will_be_fi;
}
...
static void Diagnostic_appendSourceName(struct Diagnostic *__this, struct StringBuilder *builder, struct LineColumn *location) {
  StringBuilder_append(StringBuilder_append(StringBuilder_appendChar(StringBuilder_append(StringBuilder_appendChar(StringBuilder_append(builder, __this->range->source->name), 58), int_toString(location->line + 1)), 58), int_toString(location->column + 1)), (const uint16_t *)__string_529);
}

static void Diagnostic_appendKind(struct Diagnostic *__this, struct StringBuilder *builder) {
  StringBuilder_append(builder, __this->kind == 0 ? (const uint16_t *)__string_530_error : (const uint16_t *)__string_531_warning);
}
...
static void printError(const uint16_t *text) {
  Terminal_setColor(2);
  Terminal_write((const uint16_t *)__string_532_error);
  Terminal_setColor(1);
  Terminal_write(text);
  Terminal_write((const uint16_t *)__string_533);
  Terminal_setColor(0);
}
...
static void printUsage() {
  Terminal_write((const uint16_t *)__string_534_Usage_thinc_FLAGS_INPUTS);
}
...
int32_t main_entry() {
  ...
  while (argument != NULL) {
    ...
    if (string_startsWith(text, (const uint16_t *)__string_535)) {
      if (string_op_equals(text, (const uint16_t *)__string_536_h) || string_op_equals(text, (const uint16_t *)__string_537_help) || string_op_equals(text, (const uint16_t *)__string_538_help) || string_op_equals(text, (const uint16_t *)__string_539)) {
        printUsage();

        return 0;
      }

      else if (string_op_equals(text, (const uint16_t *)__string_540_c)) {
        target = 1;
      }

      else if (string_op_equals(text, (const uint16_t *)__string_541_js)) {
        target = 2;
      }

      else if (string_op_equals(text, (const uint16_t *)__string_542_wasm)) {
        target = 3;
      }

      else if (string_op_equals(text, (const uint16_t *)__string_543_define) && argument->next != NULL) {
        argument = argument->next;
      }

      else if (string_op_equals(text, (const uint16_t *)__string_544_out) && argument->next != NULL) {
        argument = argument->next;
        output = argument->text;
      }

      else {
        printError(StringBuilder_finish(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_545_Invalid_flag), text)));
  ...
  if (inputCount == 0) {
    printError((const uint16_t *)__string_546_No_input_files);

    return 1;
  }

  if (string_op_equals(output, NULL)) {
    printError((const uint16_t *)__string_547_Missing_an_output_file_use_the);

    return 1;
  }

  if (target == 0) {
    if (string_endsWith(output, (const uint16_t *)__string_548_c)) {
      target = 1;
    }

    else if (string_endsWith(output, (const uint16_t *)__string_549_js)) {
      target = 2;
    }

    else if (string_endsWith(output, (const uint16_t *)__string_550_wasm)) {
      target = 3;
    }

    else {
      printError((const uint16_t *)__string_551_Missing_a_target_use_either_c);
  ...
  while (argument != NULL) {
    ...
    if (string_op_equals(text, (const uint16_t *)__string_552_define)) {
      argument = argument->next;
      Preprocessor_define(compiler->preprocessor, argument->text, 1);
    }

    else if (string_op_equals(text, (const uint16_t *)__string_553_out)) {
      argument = argument->next;
    }

    else if (!string_startsWith(text, (const uint16_t *)__string_554)) {
      const uint16_t *contents = IO_readTextFile(text);

      if (string_op_equals(contents, NULL)) {
        printError(StringBuilder_finish(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_555_Cannot_read_from), text)));
  ...
  if (!Log_hasErrors(compiler->log)) {
    if ((target == 1 && IO_writeTextFile(output, compiler->outputC) && IO_writeTextFile(replaceFileExtension(output, (const uint16_t *)__string_556_h), compiler->outputH)) || (target == 2 && IO_writeTextFile(output, compiler->outputJS)) || (target == 3 && IO_writeBinaryFile(output, compiler->outputWASM))) {
      return 0;
    }

    printError(StringBuilder_finish(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_557_Cannot_write_to), output)));
  }
...
static uint8_t Node_isNegativeInteger(struct Node *__this) {
  return __this->kind == 24 && __this->intValue < 0;
}
...
static uint8_t Node_isType(struct Node *__this) {
  return __this->kind == 32 || __this->kind == 38 || (__this->symbol != NULL && isType(__this->symbol->kind));
}

static uint8_t Node_isCallValue(struct Node *__this) {
  return __this->parent->kind == 19 && __this == Node_callValue(__this->parent);
}

static uint8_t Node_isAssignTarget(struct Node *__this) {
  return __this->parent->kind == 45 && __this == Node_binaryLeft(__this->parent);
}
...
static struct Node *Node_functionFirstArgumentIgnoringThis(struct Node *__this) {
  assert(__this->kind == 11);
  assert(Node_childCount(__this) >= 2);
  assert(__this->symbol != NULL);

  return __this->symbol->kind == 4 ? __this->firstChild->nextSibling : __this->firstChild;
}
...
static struct Node *Node_functionBody(struct Node *__this) {
  assert(__this->kind == 11);
  assert(Node_childCount(__this) >= 2);
  assert(__this->lastChild->kind == 3 || __this->lastChild->kind == 8);
...
static struct Node *Node_variableType(struct Node *__this) {
  assert(__this->kind == 2);
  assert(Node_childCount(__this) <= 2);
  assert(isExpression(__this->firstChild) || __this->firstChild->kind == 8);
...
static struct Node *Node_whileBody(struct Node *__this) {
  assert(__this->kind == 16);
  assert(Node_childCount(__this) == 2);
  assert(__this->lastChild->kind == 3);
...
static struct Node *Node_ifTrue(struct Node *__this) {
  assert(__this->kind == 12);
  assert(Node_childCount(__this) == 2 || Node_childCount(__this) == 3);
  assert(__this->firstChild->nextSibling->kind == 3);
...
static struct Node *Node_ifFalse(struct Node *__this) {
  assert(__this->kind == 12);
  assert(Node_childCount(__this) == 2 || Node_childCount(__this) == 3);
  assert(__this->firstChild->nextSibling->nextSibling == NULL || __this->firstChild->nextSibling->nextSibling->kind == 3);
...
static uint8_t Node_expandCallIntoOperatorTree(struct Node *__this) {
  ...
  if (value->kind == 21 && Node_isOperator(symbol->node) && Node_isDeclare(symbol->node)) {
    ...
    if (string_op_equals(symbol->name, (const uint16_t *)__string_558)) {
      binaryKind = 60;
    }

    else if (string_op_equals(symbol->name, (const uint16_t *)__string_559)) {
      binaryKind = 46;
    }

    else if (string_op_equals(symbol->name, (const uint16_t *)__string_560)) {
      binaryKind = 58;
    }

    else if (string_op_equals(symbol->name, (const uint16_t *)__string_561)) {
      binaryKind = 51;
    }

    else if (string_op_equals(symbol->name, (const uint16_t *)__string_562)) {
      binaryKind = 49;
    }
...
static void ParserContext_unexpectedToken(struct ParserContext *__this) {
  if (__this->lastError != __this->current) {
    ...
    Log_error(__this->log, __this->current->range, StringBuilder_finish(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_572_Unexpected), tokenToString(__this->current->kind))));
  }
}
  ...
  if (!ParserContext_peek(__this, kind)) {
    if (__this->lastError != __this->current) {
      ...
      if (kind != 2 && !Range_equals(previousLine, currentLine)) {
        Log_error(__this->log, Range_rangeAtEnd(previousLine), StringBuilder_finish(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_573_Expected), tokenToString(kind))));
      }

      else {
        Log_error(__this->log, __this->current->range, StringBuilder_finish(StringBuilder_append(StringBuilder_append(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_574_Expected), tokenToString(kind)), (const uint16_t *)__string_575_but_found), tokenToString(__this->current->kind))));
      }
    }
  ...
  while (end < limit) {
    ...
    if (c == 92) {
      ...
      if (c == 48) {
        ...
        Log_error(__this->log, escape, StringBuilder_finish(StringBuilder_appendChar(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_576_Invalid_escape_code), Range_toString(escape)), 39)));
...
static struct Node *ParserContext_parsePrefix(struct ParserContext *__this, int32_t mode) {
  ...
  if (ParserContext_peek(__this, 27)) {
    return ParserContext_parseUnaryPrefix(__this, mode == 1 ? 38 : 35, mode);
  }
  ...
  if (mode == 0) {
    ...
    if (ParserContext_peek(__this, 1)) {
      ...
      if (string_length(text) != 1) {
        Log_error(__this->log, token->range, (const uint16_t *)__string_577_Invalid_character_literal_strin);
    ...
    if (ParserContext_peek(__this, 6)) {
      return ParserContext_parseUnaryPrefix(__this, 33, 0);
    }

    if (ParserContext_peek(__this, 11)) {
      return ParserContext_parseUnaryPrefix(__this, 34, 0);
    }

    if (ParserContext_peek(__this, 25)) {
      return ParserContext_parseUnaryPrefix(__this, 36, 0);
    }
...
static struct Node *ParserContext_parseInfix(struct ParserContext *__this, int32_t precedence, struct Node *node, int32_t mode) {
  ...
  if (mode == 0) {
    if (ParserContext_peek(__this, 5)) {
      return ParserContext_parseBinary(__this, 45, node, precedence, 1);
    }

    if (ParserContext_peek(__this, 6)) {
      return ParserContext_parseBinary(__this, 46, node, precedence, 6);
    }

    if (ParserContext_peek(__this, 7)) {
      return ParserContext_parseBinary(__this, 47, node, precedence, 4);
    }

    if (ParserContext_peek(__this, 8)) {
      return ParserContext_parseBinary(__this, 48, node, precedence, 5);
    }

    if (ParserContext_peek(__this, 12)) {
      return ParserContext_parseBinary(__this, 49, node, precedence, 11);
    }

    if (ParserContext_peek(__this, 14)) {
      return ParserContext_parseBinary(__this, 50, node, precedence, 7);
    }

    if (ParserContext_peek(__this, 15)) {
      return ParserContext_parseBinary(__this, 51, node, precedence, 12);
    }

    if (ParserContext_peek(__this, 16)) {
      return ParserContext_parseBinary(__this, 52, node, precedence, 8);
    }

    if (ParserContext_peek(__this, 17)) {
      return ParserContext_parseBinary(__this, 53, node, precedence, 8);
    }

    if (ParserContext_peek(__this, 21)) {
      return ParserContext_parseBinary(__this, 54, node, precedence, 8);
    }

    if (ParserContext_peek(__this, 22)) {
      return ParserContext_parseBinary(__this, 55, node, precedence, 8);
    }

    if (ParserContext_peek(__this, 23)) {
      return ParserContext_parseBinary(__this, 56, node, precedence, 3);
    }

    if (ParserContext_peek(__this, 24)) {
      return ParserContext_parseBinary(__this, 57, node, precedence, 2);
    }

    if (ParserContext_peek(__this, 25)) {
      return ParserContext_parseBinary(__this, 63, node, precedence, 10);
    }

    if (ParserContext_peek(__this, 27)) {
      return ParserContext_parseBinary(__this, 58, node, precedence, 11);
    }

    if (ParserContext_peek(__this, 29)) {
      return ParserContext_parseBinary(__this, 59, node, precedence, 7);
    }

    if (ParserContext_peek(__this, 30)) {
      return ParserContext_parseBinary(__this, 44, node, precedence, 10);
    }

    if (ParserContext_peek(__this, 33)) {
      return ParserContext_parseBinary(__this, 60, node, precedence, 11);
    }

    if (ParserContext_peek(__this, 38)) {
      return ParserContext_parseBinary(__this, 61, node, precedence, 9);
    }

    if (ParserContext_peek(__this, 39)) {
      return ParserContext_parseBinary(__this, 62, node, precedence, 9);
    }

    if (ParserContext_peek(__this, 31)) {
      return ParserContext_parseUnaryPostfix(__this, 41, node, precedence);
    }

    if (ParserContext_peek(__this, 26)) {
      return ParserContext_parseUnaryPostfix(__this, 40, node, precedence);
    }
...
static struct Node *ParserContext_parseClass(struct ParserContext *__this, struct NodeFlag *firstFlag) {
  ...
  while (!ParserContext_peek(__this, 0) && !ParserContext_peek(__this, 34)) {
    ...
    if (string_op_equals(text, (const uint16_t *)__string_578_operator) && !ParserContext_peek(__this, 20) && !ParserContext_peek(__this, 2)) {
      childName->kind = 61;
      ...
      uint8_t isGet = string_op_equals(text, (const uint16_t *)__string_579_get);
      uint8_t isSet = string_op_equals(text, (const uint16_t *)__string_580_set);
      ...
      if (isGet || isSet) {
        ...
        Log_error(__this->log, childName->range, (const uint16_t *)__string_581_Instance_functions_don_t_need_th);
        childName = __this->current;
        ParserContext_advance(__this);
      }

      else if (oldKind == 44 || oldKind == 58 || oldKind == 71) {
        Log_error(__this->log, childName->range, StringBuilder_finish(StringBuilder_append(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_582_Instance_variables_don_t_need_th), Range_toString(childName->range)), (const uint16_t *)__string_583_keyword)));
        childName = __this->current;
        ParserContext_advance(__this);
      }
    }
  ...
  if (parent != NULL && ParserContext_eat(__this, 61)) {
    ...
    if (ParserContext_eat(__this, 19)) {
      ...
      if (ParserContext_peek(__this, 5)) {
        ...
        name = (const uint16_t *)__string_584;
        ParserContext_advance(__this);
      }

      else {
        nameRange = spanRanges(token->range, end->range);
        name = (const uint16_t *)__string_585;
      }
      ...
      nameRange = end->range;
      name = Range_toString(nameRange);
      Log_error(__this->log, nameRange, StringBuilder_finish(StringBuilder_append(StringBuilder_append(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_586_The_operator), name), (const uint16_t *)__string_587_cannot_be_implemented), end->kind == 29 ? (const uint16_t *)__string_588_it_is_automatically_derived_fr : end->kind == 22 ? (const uint16_t *)__string_589_it_is_automatically_derived_fr : end->kind == 17 ? (const uint16_t *)__string_590_it_is_automatically_derived_fr : (const uint16_t *)__string_591)));
    }
...
static struct Node *ParserContext_parseVariables(struct ParserContext *__this, struct NodeFlag *firstFlag, struct Node *parent) {
  ...
  while (1) {
    ...
    if (ParserContext_eat(__this, 5)) {
      ...
      if (parent != NULL) {
        Log_error(__this->log, value->range, (const uint16_t *)__string_592_Inline_initialization_of_instanc);
      }
    }
...
static struct Node *ParserContext_parseStatement(struct ParserContext *__this, int32_t mode) {
  ...
  if (ParserContext_peek(__this, 42)) {
    return ParserContext_parseLoopJump(__this, 4);
  }

  if (ParserContext_peek(__this, 45)) {
    return ParserContext_parseLoopJump(__this, 7);
  }
...
static uint8_t ParserContext_parseStatements(struct ParserContext *__this, struct Node *parent) {
  while (!ParserContext_peek(__this, 0) && !ParserContext_peek(__this, 34)) {
    struct Node *child = ParserContext_parseStatement(__this, parent->kind == 0 ? 1 : 0);
...
static uint8_t ParserContext_parseInt(struct ParserContext *__this, struct Range *range, struct Node *node) {
  ...
  if (string_op_get(contents, i) == 48 && i + 1 < limit) {
    ...
    if (c == 98 || c == 66) {
      ...
      Log_error(__this->log, range, (const uint16_t *)__string_593_Use_the_0o_prefix_for_octal_in);
  ...
  while (i < limit) {
    ...
    if (baseValue / base != value || baseValue > 4294967295 - digit) {
      Log_error(__this->log, range, (const uint16_t *)__string_594_Integer_literal_is_too_big_to_fi);
...
static void Preprocessor_unexpectedToken(struct Preprocessor *__this) {
  Log_error(__this->log, __this->current->range, StringBuilder_finish(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_595_Unexpected), tokenToString(__this->current->kind))));
}

static uint8_t Preprocessor_expect(struct Preprocessor *__this, int32_t kind) {
  if (!Preprocessor_peek(__this, kind)) {
    Log_error(__this->log, __this->current->range, StringBuilder_finish(StringBuilder_append(StringBuilder_append(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_596_Expected), tokenToString(kind)), (const uint16_t *)__string_597_but_found), tokenToString(__this->current->kind))));
...
static uint8_t Preprocessor_scan(struct Preprocessor *__this, uint8_t isParentLive) {
  while (!Preprocessor_peek(__this, 0) && !Preprocessor_peek(__this, 74) && !Preprocessor_peek(__this, 75) && !Preprocessor_peek(__this, 76)) {
    ...
    if (Preprocessor_eat(__this, 73) || Preprocessor_eat(__this, 81)) {
      ...
      if (Preprocessor_eat(__this, 52) || (Preprocessor_eat(__this, 3) && string_op_equals(Range_toString(__this->previous->range), (const uint16_t *)__string_598_0))) {
        Log_error(__this->log, __this->previous->range, (const uint16_t *)__string_599_Use_undef_to_turn_a_preproces);
      }
      ...
      if (!__this->isDefineAndUndefAllowed) {
        Log_error(__this->log, spanRanges(current->range, __this->previous->range), (const uint16_t *)__string_600_All_define_and_undef_direc);
      }
...
static int32_t Preprocessor_parsePrefix(struct Preprocessor *__this) {
  ...
  if (Preprocessor_eat(__this, 2)) {
    ...
    if (Preprocessor_peek(__this, 20) && string_op_equals(name, (const uint16_t *)__string_601_defined)) {
      isDefinedOperator = 1;
    }
  ...
  if (Preprocessor_eat(__this, 20)) {
    ...
    if (isDefinedOperator) {
      struct StringBuilder *builder = StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_602_There_is_no_defined_operator);

      if (first->kind == 2 && __this->previous == first->next) {
        StringBuilder_append(StringBuilder_append(StringBuilder_append(builder, (const uint16_t *)__string_603_just_use), Range_toString(first->range)), (const uint16_t *)__string_604_instead);
      }
  ...
  if (Preprocessor_eat(__this, 3)) {
    uint8_t isTrue = !string_op_equals(Range_toString(__this->previous->range), (const uint16_t *)__string_605_0);
    Log_error(__this->log, __this->previous->range, StringBuilder_finish(StringBuilder_append(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_606_Unexpected_integer_did_you_mean), isTrue ? (const uint16_t *)__string_607_true : (const uint16_t *)__string_608_false), (const uint16_t *)__string_609)));
...
static uint8_t Scope_define(struct Scope *__this, struct Log *log, struct Symbol *symbol, int32_t hint) {
  ...
  if (existing != NULL) {
    Log_error(log, symbol->range, StringBuilder_finish(StringBuilder_append(StringBuilder_append(StringBuilder_append(StringBuilder_new(), (const uint16_t *)__string_610_Duplicate_symbol), symbol->name), (const uint16_t *)__string_611)));
...
static void StringBuilder_appendQuoted(struct StringBuilder *sb, const uint16_t *text) {
  ...
  while (end < limit) {
    ...
    if (c == 34) {
      StringBuilder_append(StringBuilder_appendSlice(sb, text, start, end), (const uint16_t *)__string_612);
    }

    else if (c == 0) {
      StringBuilder_append(StringBuilder_appendSlice(sb, text, start, end), (const uint16_t *)__string_613_0);
    }

    else if (c == 9) {
      StringBuilder_append(StringBuilder_appendSlice(sb, text, start, end), (const uint16_t *)__string_614_t);
    }

    else if (c == 13) {
      StringBuilder_append(StringBuilder_appendSlice(sb, text, start, end), (const uint16_t *)__string_615_r);
    }

    else if (c == 10) {
      StringBuilder_append(StringBuilder_appendSlice(sb, text, start, end), (const uint16_t *)__string_616_n);
    }

    else if (c == 92) {
      StringBuilder_append(StringBuilder_appendSlice(sb, text, start, end), (const uint16_t *)__string_617);
    }
...
static uint8_t Symbol_isEnumValue(struct Symbol *__this) {
  return __this->node->parent->kind == 9;
}
...
static void WasmModule_emitSignatures(struct WasmModule *__this, struct ByteArray *array) {
  int32_t section = wasmStartSection(array, (const uint16_t *)__string_618_signatures);
...
static void WasmModule_emitImportTable(struct WasmModule *__this, struct ByteArray *array) {
  ...
  int32_t section = wasmStartSection(array, (const uint16_t *)__string_619_import_table);
...
static void WasmModule_emitFunctionSignatures(struct WasmModule *__this, struct ByteArray *array) {
  ...
  int32_t section = wasmStartSection(array, (const uint16_t *)__string_620_function_signatures);
...
static void WasmModule_emitMemory(struct WasmModule *__this, struct ByteArray *array) {
  int32_t section = wasmStartSection(array, (const uint16_t *)__string_621_memory);
...
static void WasmModule_emitExportTable(struct WasmModule *__this, struct ByteArray *array) {
  ...
  int32_t section = wasmStartSection(array, (const uint16_t *)__string_622_export_table);
...
static void WasmModule_emitFunctionBodies(struct WasmModule *__this, struct ByteArray *array) {
  ...
  int32_t section = wasmStartSection(array, (const uint16_t *)__string_623_function_bodies);
  wasmWriteVarUnsigned(array, __this->functionCount);
  struct WasmFunction *fn = __this->firstFunction;
...
static void WasmModule_emitDataSegments(struct WasmModule *__this, struct ByteArray *array) {
  ...
  int32_t section = wasmStartSection(array, (const uint16_t *)__string_624_data_segments);
  wasmWriteVarUnsigned(array, 1);
...
static void WasmModule_prepareToEmit(struct WasmModule *__this, struct Node *node) {
  if (node->kind == 30) {
    ...
    if (symbol->kind == 8) {
      ...
      if (string_op_equals(symbol->name, (const uint16_t *)__string_625_currentHeapPointer)) {
        assert(__this->currentHeapPointer == -1);
        __this->currentHeapPointer = symbol->offset;
      }

      else if (string_op_equals(symbol->name, (const uint16_t *)__string_626_originalHeapPointer)) {
    ...
    if (body == NULL) {
      const uint16_t *moduleName = symbol->kind == 4 ? Symbol_parent(symbol)->name : (const uint16_t *)__string_627_global;
    ...
    if (symbol->kind == 5 && string_op_equals(symbol->name, (const uint16_t *)__string_628_malloc)) {
